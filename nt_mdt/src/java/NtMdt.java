...
public class NtMdt extends KaitaiStruct {
    ...
    private void _read() {
        ...
        KaitaiStream _io_frames = this._io.substream(size());
        this.frames = new Framez(_io_frames, this, _root);
    }
    ...
    public static class Frame extends KaitaiStruct {
        ...
        private void _read() {
            this.size = this._io.readU4le();
            KaitaiStream _io_main = this._io.substream(size() - 4);
            this.main = new FrameMain(_io_main, this, _root);
        }
        ...
        public static class FdMetaData extends KaitaiStruct {
            ...
            public Image image() {
                ...
                KaitaiStream _io_image = this._io.substream(dataSize());
                this.image = new Image(_io_image, this, _root);
                this._io.seek(_pos);
                return this.image;
            }
        ...
        public static class FdScanned extends KaitaiStruct {
            ...
            private void _read() {
                KaitaiStream _io_vars = this._io.substream(_parent().varSize());
                this.vars = new Vars(_io_vars, this, _root);
                if (false) {
