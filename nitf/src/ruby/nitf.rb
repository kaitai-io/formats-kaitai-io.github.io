...
# @see https://web.archive.org/web/20181105050336/https://www.gwg.nga.mil/ntb/baseline/docs/2500c/2500C.pdf Source
class Nitf < Kaitai::Struct::Struct
  ...
  class DataExtensionSegment < Kaitai::Struct::Struct
    ...
    def _read
      _io_data_sub_header = @_io.substream(_parent.header.ldnfo[idx].length_data_extension_subheader.to_i)
      @data_sub_header = DataSubHeader.new(_io_data_sub_header, self, @_root)
  ...
  class ImageSegment < Kaitai::Struct::Struct
    ...
    def has_mask
      ...
      @has_mask = image_sub_header.img_compression[0...2] == "MM"
      @has_mask
    end
  ...
  class ReservedExtensionSegment < Kaitai::Struct::Struct
    ...
    def _read
      _io_reserved_sub_header = @_io.substream(_parent.header.lrnfo[idx].length_reserved_extension_subheader.to_i)
      @reserved_sub_header = ReservedSubHeader.new(_io_reserved_sub_header, self, @_root)
