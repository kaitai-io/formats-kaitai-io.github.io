...
class ReservedExtensionSegment extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $io = new \Kaitai\Struct\Stream($this->_m__raw_reservedSubHeader);
        $this->_m_reservedSubHeader = new \Nitf\ReservedSubHeader($io, $this, $this->_root);
...
class BandInfo extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_imgFilterCondition = $this->_io->ensureFixedContents("\x4E");
...
class GraphicSubHeader extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_filePartTypeSy = $this->_io->ensureFixedContents("\x53\x59");
        ...
        $this->_m_graphicType = $this->_io->ensureFixedContents("\x43");
...
class DataExtensionSegment extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $io = new \Kaitai\Struct\Stream($this->_m__raw_dataSubHeader);
        $this->_m_dataSubHeader = new \Nitf\DataSubHeader($io, $this, $this->_root);
...
class ImageSubHeader extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_filePartType = $this->_io->ensureFixedContents("\x49\x4D");
...
class ReservedSubHeader extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_filePartTypeRe = $this->_io->ensureFixedContents("\x52\x45");
...
class DataSubHeaderBase extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_filePartTypeDe = $this->_io->ensureFixedContents("\x44\x45");
...
class Header extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_fileProfileName = $this->_io->ensureFixedContents("\x4E\x49\x54\x46");
        $this->_m_fileVersion = $this->_io->ensureFixedContents("\x30\x32\x2E\x31\x30");
        $this->_m_complexityLevel = $this->_io->readBytes(2);
        $this->_m_standardType = $this->_io->ensureFixedContents("\x42\x46\x30\x31");
