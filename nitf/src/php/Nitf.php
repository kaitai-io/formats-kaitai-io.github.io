...
namespace Nitf {
    class BandInfo extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_imgFilterCondition == "\x4E")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x4E", $this->_m_imgFilterCondition, $this->_io, "/types/band_info/seq/2");
            }
...
namespace Nitf {
    class DataSubHeaderBase extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_filePartTypeDe == "\x44\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x44\x45", $this->_m_filePartTypeDe, $this->_io, "/types/data_sub_header_base/seq/0");
            }
...
namespace Nitf {
    class GraphicSubHeader extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_filePartTypeSy == "\x53\x59")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x53\x59", $this->_m_filePartTypeSy, $this->_io, "/types/graphic_sub_header/seq/0");
            }
            ...
            if (!($this->_m_graphicType == "\x43")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x43", $this->_m_graphicType, $this->_io, "/types/graphic_sub_header/seq/5");
            }
...
namespace Nitf {
    class Header extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_fileProfileName == "\x4E\x49\x54\x46")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x4E\x49\x54\x46", $this->_m_fileProfileName, $this->_io, "/types/header/seq/0");
            }
            $this->_m_fileVersion = $this->_io->readBytes(5);
            if (!($this->_m_fileVersion == "\x30\x32\x2E\x31\x30")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x30\x32\x2E\x31\x30", $this->_m_fileVersion, $this->_io, "/types/header/seq/1");
            }
            $this->_m_complexityLevel = $this->_io->readBytes(2);
            $this->_m_standardType = $this->_io->readBytes(4);
            if (!($this->_m_standardType == "\x42\x46\x30\x31")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x42\x46\x30\x31", $this->_m_standardType, $this->_io, "/types/header/seq/3");
            }
...
namespace Nitf {
    class ImageSubHeader extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_filePartType == "\x49\x4D")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x49\x4D", $this->_m_filePartType, $this->_io, "/types/image_sub_header/seq/0");
            }
...
namespace Nitf {
    class ReservedSubHeader extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_filePartTypeRe == "\x52\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x52\x45", $this->_m_filePartTypeRe, $this->_io, "/types/reserved_sub_header/seq/0");
            }
