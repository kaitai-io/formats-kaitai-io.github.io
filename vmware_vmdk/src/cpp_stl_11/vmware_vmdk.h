...
public:
    ...
    public:
        ...
        header_flags_t(kaitai::kstream* p__io, vmware_vmdk_t* p__parent = nullptr, vmware_vmdk_t* p__root = nullptr);
...
private:
    std::string m_magic;
    int32_t m_version;
    std::unique_ptr<header_flags_t> m_flags;
    int64_t m_size_max;
...
public:
    ...
    header_flags_t* flags() const { return m_flags.get(); }
