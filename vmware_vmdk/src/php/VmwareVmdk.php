...
class VmwareVmdk extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_magic = $this->_io->ensureFixedContents("\x4B\x44\x4D\x56");
...
class HeaderFlags extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_zeroedGrainTableEntry = $this->_io->readBitsInt(1) != 0;
        $this->_m_useSecondaryGrainDir = $this->_io->readBitsInt(1) != 0;
        $this->_m_validNewLineDetectionTest = $this->_io->readBitsInt(1) != 0;
        $this->_io->alignToByte();
        $this->_m_reserved2 = $this->_io->readU1();
        $this->_m_reserved3 = $this->_io->readBitsInt(6);
        $this->_m_hasMetadata = $this->_io->readBitsInt(1) != 0;
        $this->_m_hasCompressedGrain = $this->_io->readBitsInt(1) != 0;
        $this->_io->alignToByte();
