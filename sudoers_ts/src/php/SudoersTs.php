...
class TsFlag extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_reserved0 = $this->_io->readBitsInt(6);
        $this->_m_anyuid = $this->_io->readBitsInt(1) != 0;
        $this->_m_disabled = $this->_io->readBitsInt(1) != 0;
        $this->_m_reserved1 = $this->_io->readBitsInt(8);
    }
