...
public:
    ...
    compressed_resource_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, compressed_resource_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        header_t(kaitai::kstream* p__io, compressed_resource_t* p__parent = nullptr, compressed_resource_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            common_part_t(kaitai::kstream* p__io, compressed_resource_t::header_t* p__parent = nullptr, compressed_resource_t* p__root = nullptr);
        ...
        public:
            ...
            type_specific_part_type_8_t(kaitai::kstream* p__io, compressed_resource_t::header_t* p__parent = nullptr, compressed_resource_t* p__root = nullptr);
        ...
        public:
            ...
            type_specific_part_type_9_t(kaitai::kstream* p__io, compressed_resource_t::header_t* p__parent = nullptr, compressed_resource_t* p__root = nullptr);
        ...
        private:
            int16_t m_decompressor_id;
            std::unique_ptr<bytes_with_io_t> m_decompressor_specific_parameters_with_io;
            compressed_resource_t* m__root;
            compressed_resource_t::header_t* m__parent;
            std::string m__raw_decompressor_specific_parameters_with_io;
            std::unique_ptr<kaitai::kstream> m__io__raw_decompressor_specific_parameters_with_io;
        ...
        public:
             ...
             */
            bytes_with_io_t* decompressor_specific_parameters_with_io() const { return m_decompressor_specific_parameters_with_io.get(); }
            compressed_resource_t* _root() const { return m__root; }
            compressed_resource_t::header_t* _parent() const { return m__parent; }
            std::string _raw_decompressor_specific_parameters_with_io() const { return m__raw_decompressor_specific_parameters_with_io; }
            kaitai::kstream* _io__raw_decompressor_specific_parameters_with_io() const { return m__io__raw_decompressor_specific_parameters_with_io.get(); }
        };

    private:
        bool f_type_specific_part;
        std::unique_ptr<kaitai::kstruct> m_type_specific_part;
