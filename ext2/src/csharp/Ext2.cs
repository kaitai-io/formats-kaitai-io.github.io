    ...
    public partial class Ext2 : KaitaiStruct
    {
        ...
        public partial class SuperBlockStruct : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_magic, new byte[] { 83, 239 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 83, 239 }, _magic, m_io, "/types/super_block_struct/seq/15");
                }
