...
class Ext2 < Kaitai::Struct::Struct
  ...
  class BlockGroup < Kaitai::Struct::Struct
    ...
    def _read
      _io_super_block = @_io.substream(1024)
      @super_block = SuperBlockStruct.new(_io_super_block, self, @_root)
      @block_groups = []
  ...
  class BlockPtr < Kaitai::Struct::Struct
    ...
    def body
      ...
      _io_body = @_io.substream(_root.bg1.super_block.block_size)
      @body = RawBlock.new(_io_body, self, @_root)
      @_io.seek(_pos)
      @body
    end
    attr_reader :ptr
