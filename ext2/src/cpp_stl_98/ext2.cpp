...
std::set<ext2_t::dir_entry_t::file_type_enum_t> ext2_t::dir_entry_t::_build_values_file_type_enum_t() {
    std::set<ext2_t::dir_entry_t::file_type_enum_t> _t;
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_UNKNOWN);
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_REG_FILE);
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_DIR);
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_CHRDEV);
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_BLKDEV);
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_FIFO);
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_SOCK);
    _t.insert(ext2_t::dir_entry_t::FILE_TYPE_ENUM_SYMLINK);
    return _t;
}
const std::set<ext2_t::dir_entry_t::file_type_enum_t> ext2_t::dir_entry_t::_values_file_type_enum_t = ext2_t::dir_entry_t::_build_values_file_type_enum_t();
...
std::set<ext2_t::super_block_struct_t::errors_enum_t> ext2_t::super_block_struct_t::_build_values_errors_enum_t() {
    std::set<ext2_t::super_block_struct_t::errors_enum_t> _t;
    _t.insert(ext2_t::super_block_struct_t::ERRORS_ENUM_ACT_CONTINUE);
    _t.insert(ext2_t::super_block_struct_t::ERRORS_ENUM_ACT_RO);
    _t.insert(ext2_t::super_block_struct_t::ERRORS_ENUM_ACT_PANIC);
    return _t;
}
const std::set<ext2_t::super_block_struct_t::errors_enum_t> ext2_t::super_block_struct_t::_values_errors_enum_t = ext2_t::super_block_struct_t::_build_values_errors_enum_t();
...
std::set<ext2_t::super_block_struct_t::state_enum_t> ext2_t::super_block_struct_t::_build_values_state_enum_t() {
    std::set<ext2_t::super_block_struct_t::state_enum_t> _t;
    _t.insert(ext2_t::super_block_struct_t::STATE_ENUM_VALID_FS);
    _t.insert(ext2_t::super_block_struct_t::STATE_ENUM_ERROR_FS);
    return _t;
}
const std::set<ext2_t::super_block_struct_t::state_enum_t> ext2_t::super_block_struct_t::_values_state_enum_t = ext2_t::super_block_struct_t::_build_values_state_enum_t();
