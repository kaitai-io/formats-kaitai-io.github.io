...
public:
    ...
    private:
        ...
        static std::set<file_type_enum_t> _build_values_file_type_enum_t();
    ...
    private:
        ...
        static std::set<errors_enum_t> _build_values_errors_enum_t();
    ...
    private:
        ...
        static std::set<state_enum_t> _build_values_state_enum_t();
