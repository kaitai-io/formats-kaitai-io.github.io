...
private:
    ...
    static std::set<class_type_t> _build_values_class_type_t();
...
private:
    ...
    static std::set<type_type_t> _build_values_type_type_t();
...
public:
    ...
    private:
        ...
        domain_name_t* m_responsible_mailbox;
        uint32_t m_serial;
    ...
    public:
        ...
        domain_name_t* responsible_mailbox() const { return m_responsible_mailbox; }
