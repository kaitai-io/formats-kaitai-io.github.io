...
std::set<fallout_dat_t::compression_t> fallout_dat_t::_build_values_compression_t() {
    std::set<fallout_dat_t::compression_t> _t;
    _t.insert(fallout_dat_t::COMPRESSION_NONE);
    _t.insert(fallout_dat_t::COMPRESSION_LZSS);
    return _t;
}
const std::set<fallout_dat_t::compression_t> fallout_dat_t::_values_compression_t = fallout_dat_t::_build_values_compression_t();
