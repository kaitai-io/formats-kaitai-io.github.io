...
public:
    ...
    some_ip_sd_options_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        public:
            ...
            sd_config_string_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t::sd_config_strings_container_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
        ...
        private:
            uint8_t m_length;
            std::unique_ptr<sd_config_kv_pair_t> m_config;
            bool n_config;
        ...
        private:
            std::unique_ptr<kaitai::kstream> m__io__raw_config;

        public:
            uint8_t length() const { return m_length; }
            sd_config_kv_pair_t* config() const { return m_config.get(); }
            some_ip_sd_options_t* _root() const { return m__root; }
            ...
            kaitai::kstream* _io__raw_config() const { return m__io__raw_config.get(); }
        };
        ...
        public:
            ...
            sd_config_strings_container_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t::sd_configuration_option_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
        ...
        private:
            std::unique_ptr<std::vector<std::unique_ptr<sd_config_string_t>>> m_config_strings;
            some_ip_sd_options_t* m__root;
            some_ip_sd_options_t::sd_option_t::sd_configuration_option_t* m__parent;

        public:
            std::vector<std::unique_ptr<sd_config_string_t>>* config_strings() const { return m_config_strings.get(); }
            some_ip_sd_options_t* _root() const { return m__root; }
        ...
        public:
            ...
            sd_configuration_option_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
        ...
        private:
            uint8_t m_reserved;
            std::unique_ptr<sd_config_strings_container_t> m_configurations;
            some_ip_sd_options_t* m__root;
            some_ip_sd_options_t::sd_option_t* m__parent;
            std::string m__raw_configurations;
            std::unique_ptr<kaitai::kstream> m__io__raw_configurations;

        public:
            uint8_t reserved() const { return m_reserved; }
            sd_config_strings_container_t* configurations() const { return m_configurations.get(); }
            some_ip_sd_options_t* _root() const { return m__root; }
            some_ip_sd_options_t::sd_option_t* _parent() const { return m__parent; }
        ...
        public:
            ...
            sd_ipv4_multicast_option_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
        ...
        public:
            ...
            sd_ipv4_sd_endpoint_option_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
        ...
        public:
            ...
            sd_ipv6_multicast_option_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
        ...
        public:
            ...
            sd_ipv6_sd_endpoint_option_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
        ...
        public:
            ...
            sd_load_balancing_option_t(kaitai::kstream* p__io, some_ip_sd_options_t::sd_option_t* p__parent = nullptr, some_ip_sd_options_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<sd_option_header_t> m_header;
    ...
    public:
        sd_option_header_t* header() const { return m_header.get(); }
...
private:
    std::unique_ptr<std::vector<std::unique_ptr<sd_option_t>>> m_entries;
    some_ip_sd_options_t* m__root;
    kaitai::kstruct* m__parent;

public:
    std::vector<std::unique_ptr<sd_option_t>>* entries() const { return m_entries.get(); }
    some_ip_sd_options_t* _root() const { return m__root; }
