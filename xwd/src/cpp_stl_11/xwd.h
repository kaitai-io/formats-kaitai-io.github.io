...
public:
    ...
    public:
        ...
        header_t(kaitai::kstream* p__io, xwd_t* p__parent = nullptr, xwd_t* p__root = nullptr);
...
private:
    ...
    std::unique_ptr<std::vector<std::unique_ptr<color_map_entry_t>>> m_color_map;
    xwd_t* m__root;
    kaitai::kstruct* m__parent;
    std::string m__raw_hdr;
    std::unique_ptr<kaitai::kstream> m__io__raw_hdr;
    std::unique_ptr<std::vector<std::string>> m__raw_color_map;
    std::unique_ptr<std::vector<std::unique_ptr<kaitai::kstream>>> m__io__raw_color_map;
...
public:
    ...
    std::vector<std::unique_ptr<color_map_entry_t>>* color_map() const { return m_color_map.get(); }
    xwd_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
    std::string _raw_hdr() const { return m__raw_hdr; }
    kaitai::kstream* _io__raw_hdr() const { return m__io__raw_hdr.get(); }
    std::vector<std::string>* _raw_color_map() const { return m__raw_color_map.get(); }
    std::vector<std::unique_ptr<kaitai::kstream>>* _io__raw_color_map() const { return m__io__raw_color_map.get(); }
};
