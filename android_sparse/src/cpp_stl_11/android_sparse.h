...
public:
    ...
    android_sparse_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, android_sparse_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        file_header_prefix_t(kaitai::kstream* p__io, android_sparse_t* p__parent = nullptr, android_sparse_t* p__root = nullptr);
    ...
    public:
        ...
        file_header_t(kaitai::kstream* p__io, android_sparse_t* p__parent = nullptr, android_sparse_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<chunk_header_t> m_header;
        uint32_t m_body;
        bool n_body;
    ...
    public:
        chunk_header_t* header() const { return m_header.get(); }
    ...
    public:
        ...
        version_t(kaitai::kstream* p__io, android_sparse_t::file_header_prefix_t* p__parent = nullptr, android_sparse_t* p__root = nullptr);
