...
namespace AndroidDto {
    class DtTableHeader extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic == "\xD7\xB7\xAB\x1E")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\xD7\xB7\xAB\x1E", $this->_m_magic, $this->_io, "/types/dt_table_header/seq/0");
            }
