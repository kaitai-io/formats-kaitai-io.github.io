...
void android_dto_t::dt_table_header_t::_read() {
    ...
    if (!(m_magic == std::string("\xD7\xB7\xAB\x1E", 4))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\xD7\xB7\xAB\x1E", 4), m_magic, m__io, std::string("/types/dt_table_header/seq/0"));
    }
