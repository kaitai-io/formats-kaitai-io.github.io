...
our $HASH_ALGORITHMS_RESERVED_4 = 4;
our $HASH_ALGORITHMS_RESERVED_5 = 5;
our $HASH_ALGORITHMS_RESERVED_6 = 6;
our $HASH_ALGORITHMS_RESERVED_7 = 7;
...
our $SYMMETRIC_KEY_ALGORITHM_RESERVED_5 = 5;
our $SYMMETRIC_KEY_ALGORITHM_RESERVED_6 = 6;
...
our $SUBPACKET_TYPES_RESERVED = 0;
our $SUBPACKET_TYPES_RESERVED = 1;
...
our $SUBPACKET_TYPES_RESERVED = 8;
...
our $SUBPACKET_TYPES_RESERVED = 13;
our $SUBPACKET_TYPES_RESERVED = 14;
our $SUBPACKET_TYPES_RESERVED = 15;
our $SUBPACKET_TYPES_ISSUER = 16;
our $SUBPACKET_TYPES_RESERVED = 17;
our $SUBPACKET_TYPES_RESERVED = 18;
our $SUBPACKET_TYPES_RESERVED = 19;
...
sub _read {
    ...
    $self->{one} = $self->{_io}->read_bits_int(1);
    $self->{new_packet_format} = $self->{_io}->read_bits_int(1);
    if ($self->new_packet_format()) {
        $self->{packet_type_new} = $self->{_io}->read_bits_int(6);
    }
    if (!($self->new_packet_format())) {
        $self->{packet_type_old} = $self->{_io}->read_bits_int(4);
    }
    if (!($self->new_packet_format())) {
