  ...
  class Packet < Kaitai::Struct::Struct
    ...
    def _read
      ...
      if new_packet_format
        @packet_type_new = Kaitai::Struct::Stream::resolve_enum(OpenpgpMessage::PACKET_TAGS, @_io.read_bits_int(6))
      end
      if !(new_packet_format)
        @packet_type_old = Kaitai::Struct::Stream::resolve_enum(OpenpgpMessage::PACKET_TAGS, @_io.read_bits_int(4))
      end
      if !(new_packet_format)
