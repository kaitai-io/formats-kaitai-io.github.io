...
public class OpenpgpMessage extends KaitaiStruct {
            ...
            }
            {
                ...
                if (on != null) {
                    ...
                    case PUBLIC_KEY_PACKET: {
                        ...
                        this.body = new PublicKeyPacket(_io_body, this, _root);
                        break;
                    }
                    ...
                    case SECRET_KEY_PACKET: {
                        KaitaiStream _io_body = this._io.substream(len());
                        this.body = new SecretKeyPacket(_io_body, this, _root);
                        break;
                    }
                    ...
                    case SIGNATURE_PACKET: {
                        KaitaiStream _io_body = this._io.substream(len());
                        this.body = new SignaturePacket(_io_body, this, _root);
                        break;
                    }
                    case USER_ID_PACKET: {
                        KaitaiStream _io_body = this._io.substream(len());
                        this.body = new UserIdPacket(_io_body, this, _root);
                        break;
                    }
                    default: {
    ...
    public static class SignaturePacket extends KaitaiStruct {
        ...
        private void _read() {
            ...
            KaitaiStream _io_hashedSubpackets = this._io.substream(lenHashedSubpacket());
            this.hashedSubpackets = new Subpackets(_io_hashedSubpackets, this, _root);
            this.lenUnhashedSubpacket = this._io.readU2be();
            KaitaiStream _io_unhashedSubpackets = this._io.substream(lenUnhashedSubpacket());
            this.unhashedSubpackets = new Subpackets(_io_unhashedSubpackets, this, _root);
            ...
            this.subpacketType = OpenpgpMessage.SubpacketTypes.byId(this._io.readU1());
            {
                ...
                if (on != null) {
                    ...
                    case EMBEDDED_SIGNATURE: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new EmbeddedSignature(_io_content, this, _root);
                        break;
                    }
                    case EXPORTABLE_CERTIFICATION: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new ExportableCertification(_io_content, this, _root);
                        break;
                    }
                    case FEATURES: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new Features(_io_content, this, _root);
                        break;
                    }
                    case ISSUER: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new Issuer(_io_content, this, _root);
                        break;
                    }
                    case KEY_EXPIRATION_TIME: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new KeyExpirationTime(_io_content, this, _root);
                        break;
                    }
                    case KEY_FLAGS: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new KeyFlags(_io_content, this, _root);
                        break;
                    }
                    case KEY_SERVER_PREFERENCES: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new KeyServerPreferences(_io_content, this, _root);
                        break;
                    }
                    case NOTATION_DATA: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new NotationData(_io_content, this, _root);
                        break;
                    }
                    case POLICY_URI: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new PolicyUri(_io_content, this, _root);
                        break;
                    }
                    case PREFERRED_COMPRESSION_ALGORITHMS: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new PreferredCompressionAlgorithms(_io_content, this, _root);
                        break;
                    }
                    case PREFERRED_HASH_ALGORITHMS: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new PreferredHashAlgorithms(_io_content, this, _root);
                        break;
                    }
                    case PREFERRED_KEY_SERVER: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new PreferredKeyServer(_io_content, this, _root);
                        break;
                    }
                    case PRIMARY_USER_ID: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new PrimaryUserId(_io_content, this, _root);
                        break;
                    }
                    case REASON_FOR_REVOCATION: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new ReasonForRevocation(_io_content, this, _root);
                        break;
                    }
                    case REGULAR_EXPRESSION: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new RegularExpression(_io_content, this, _root);
                        break;
                    }
                    case REVOCABLE: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new Revocable(_io_content, this, _root);
                        break;
                    }
                    case REVOCATION_KEY: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new RevocationKey(_io_content, this, _root);
                        break;
                    }
                    case SIGNATURE_CREATION_TIME: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new SignatureCreationTime(_io_content, this, _root);
                        break;
                    }
                    case SIGNATURE_EXPIRATION_TIME: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new SignatureExpirationTime(_io_content, this, _root);
                        break;
                    }
                    case SIGNATURE_TARGET: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new SignatureTarget(_io_content, this, _root);
                        break;
                    }
                    case SIGNERS_USER_ID: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new SignersUserId(_io_content, this, _root);
                        break;
                    }
                    case TRUST_SIGNATURE: {
                        KaitaiStream _io_content = this._io.substream(len().len() - 1);
                        this.content = new TrustSignature(_io_content, this, _root);
                        break;
                    }
                    default: {
