...
private:
    ...
    static std::set<compression_algorithms_t> _build_values_compression_algorithms_t();
...
private:
    ...
    static std::set<hash_algorithms_t> _build_values_hash_algorithms_t();
...
private:
    ...
    static std::set<key_flags_t> _build_values_key_flags_t();
...
private:
    ...
    static std::set<packet_tags_t> _build_values_packet_tags_t();
...
private:
    ...
    static std::set<public_key_algorithms_t> _build_values_public_key_algorithms_t();
...
private:
    ...
    static std::set<revocation_codes_t> _build_values_revocation_codes_t();
...
private:
    ...
    static std::set<server_flags_t> _build_values_server_flags_t();
...
private:
    ...
    static std::set<subpacket_types_t> _build_values_subpacket_types_t();
...
private:
    ...
    static std::set<symmetric_key_algorithm_t> _build_values_symmetric_key_algorithm_t();
