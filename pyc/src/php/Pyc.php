...
class Pyc extends \Kaitai\Struct\Struct {
    public function __construct(\Kaitai\Struct\Stream $io, \Kaitai\Struct\Struct $parent = null, \Pyc $root = null) {
    ...
    private function _read() {
        ...
        $this->_m_body = new \Pyc\PyObject($this->_io, $this, $this->_root);
    }
...
class CodeObject extends \Kaitai\Struct\Struct {
    public function __construct(\Kaitai\Struct\Stream $io, \Pyc\PyObject $parent = null, \Pyc $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_read();
    }
    ...
    private function _read() {
        ...
        $this->_m_code = new \Pyc\Assembly($this->_io, $this, $this->_root);
        $this->_m_consts = new \Pyc\PyObject($this->_io, $this, $this->_root);
        $this->_m_names = new \Pyc\PyObject($this->_io, $this, $this->_root);
        $this->_m_varNames = new \Pyc\PyObject($this->_io, $this, $this->_root);
        $this->_m_freeVars = new \Pyc\PyObject($this->_io, $this, $this->_root);
        $this->_m_cellVars = new \Pyc\PyObject($this->_io, $this, $this->_root);
        $this->_m_filename = new \Pyc\PyObject($this->_io, $this, $this->_root);
        $this->_m_name = new \Pyc\PyObject($this->_io, $this, $this->_root);
        $this->_m_firstLineNo = $this->_io->readU4le();
        $this->_m_lnotab = new \Pyc\PyObject($this->_io, $this, $this->_root);
    }
...
class Assembly extends \Kaitai\Struct\Struct {
    public function __construct(\Kaitai\Struct\Stream $io, \Pyc\CodeObject $parent = null, \Pyc $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_read();
    }
    ...
    private function _read() {
        ...
        $this->_m_items = new \Pyc\OpArgs($io, $this, $this->_root);
    }
...
class OpArg extends \Kaitai\Struct\Struct {
    public function __construct(\Kaitai\Struct\Stream $io, \Pyc\OpArgs $parent = null, \Pyc $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_read();
    }
    ...
    private function _read() {
        ...
        if ($this->opCode() >= \Pyc\OpArg\OpCodeEnum::STORE_NAME) {
...
class PyObject extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        switch ($this->type()) {
            case \Pyc\PyObject\ObjectType::NONE:
                $this->_m_value = new \Pyc\PyObject\PyNone($this->_io, $this, $this->_root);
                break;
            case \Pyc\PyObject\ObjectType::CODE_OBJECT:
                $this->_m_value = new \Pyc\CodeObject($this->_io, $this, $this->_root);
                break;
            case \Pyc\PyObject\ObjectType::INT:
                $this->_m_value = $this->_io->readU4le();
                break;
            case \Pyc\PyObject\ObjectType::STRING_REF:
                $this->_m_value = new \Pyc\PyObject\StringRef($this->_io, $this, $this->_root);
                break;
            case \Pyc\PyObject\ObjectType::STRING:
                $this->_m_value = new \Pyc\PyObject\PyString($this->_io, $this, $this->_root);
                break;
            case \Pyc\PyObject\ObjectType::PY_FALSE:
                $this->_m_value = new \Pyc\PyObject\PyFalse($this->_io, $this, $this->_root);
                break;
            case \Pyc\PyObject\ObjectType::INTERNED:
                $this->_m_value = new \Pyc\PyObject\InternedString($this->_io, $this, $this->_root);
                break;
            case \Pyc\PyObject\ObjectType::TUPLE:
                $this->_m_value = new \Pyc\PyObject\Tuple($this->_io, $this, $this->_root);
                break;
            case \Pyc\PyObject\ObjectType::PY_TRUE:
                $this->_m_value = new \Pyc\PyObject\PyTrue($this->_io, $this, $this->_root);
                break;
        }
    }
    protected $_m_type;
...
class Tuple extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $n = $this->count();
        for ($i = 0; $i < $n; $i++) {
            $this->_m_items[] = new \Pyc\PyObject($this->_io, $this, $this->_root);
        }
    }
    protected $_m_count;
    protected $_m_items;
...
class OpArgs extends \Kaitai\Struct\Struct {
    public function __construct(\Kaitai\Struct\Stream $io, \Pyc\Assembly $parent = null, \Pyc $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_read();
    }
    ...
    private function _read() {
        ...
        while (!$this->_io->isEof()) {
            $this->_m_items[] = new \Pyc\OpArg($this->_io, $this, $this->_root);
        }
    }
    protected $_m_items;
    public function items() { return $this->_m_items; }
