...
class Page extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_syncCode = $this->_io->ensureFixedContents("\x4F\x67\x67\x53");
        $this->_m_version = $this->_io->ensureFixedContents("\x00");
        $this->_m_reserved1 = $this->_io->readBitsInt(5);
        $this->_m_isEndOfStream = $this->_io->readBitsInt(1) != 0;
        $this->_m_isBeginningOfStream = $this->_io->readBitsInt(1) != 0;
        $this->_m_isContinuation = $this->_io->readBitsInt(1) != 0;
