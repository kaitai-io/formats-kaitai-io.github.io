...
namespace {
    class S3m extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->magic1() == "\x1A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x1A", $this->magic1(), $this->_io(), "/seq/1");
            }
            ...
            if (!($this->magic2() == "\x53\x43\x52\x4D")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x53\x43\x52\x4D", $this->magic2(), $this->_io(), "/seq/10");
            }
...
namespace S3m {
    class Instrument extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->magic() == "\x53\x43\x52\x53")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x53\x43\x52\x53", $this->magic(), $this->_io(), "/types/instrument/seq/6");
            }
        }
        protected $_m_type;
...
namespace S3m\Instrument {
    class Adlib extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->reserved1() == "\x00\x00\x00")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x00\x00\x00", $this->reserved1(), $this->_io(), "/types/instrument/types/adlib/seq/0");
            }
