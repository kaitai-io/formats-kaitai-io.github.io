...
namespace {
    class S3m extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic1 == "\x1A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x1A", $this->_m_magic1, $this->_io, "/seq/1");
            }
            ...
            if (!($this->_m_magic2 == "\x53\x43\x52\x4D")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x53\x43\x52\x4D", $this->_m_magic2, $this->_io, "/seq/10");
            }
            $this->_m_globalVolume = $this->_io->readU1();
            $this->_m_initialSpeed = $this->_io->readU1();
            $this->_m_initialTempo = $this->_io->readU1();
            $this->_m_isStereo = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_masterVolume = $this->_io->readBitsIntBe(7);
...
namespace S3m {
    class Channel extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_isDisabled = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_chType = $this->_io->readBitsIntBe(7);
        }
...
namespace S3m {
    class ChannelPan extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            $this->_m_hasCustomPan = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_reserved2 = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_pan = $this->_io->readBitsIntBe(4);
        }
        protected $_m_reserved1;
        protected $_m_hasCustomPan;
        protected $_m_reserved2;
...
namespace S3m {
    class Instrument extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic == "\x53\x43\x52\x53")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x53\x43\x52\x53", $this->_m_magic, $this->_io, "/types/instrument/seq/6");
            }
        }
        protected $_m_type;
...
namespace S3m\Instrument {
    class Adlib extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_reserved1 == "\x00\x00\x00")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x00\x00\x00", $this->_m_reserved1, $this->_io, "/types/instrument/types/adlib/seq/0");
            }
...
namespace S3m {
    class PatternCell extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_hasFx = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_hasVolume = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_hasNoteAndInstrument = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_channelNum = $this->_io->readBitsIntBe(5);
            $this->_io->alignToByte();
