...
vlq_base128_be_t::vlq_base128_be_t(kaitai::kstream *p_io, kaitai::kstruct* p_parent, vlq_base128_be_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = this;
    f_last = false;
    f_value = false;
...
vlq_base128_be_t::group_t::group_t(kaitai::kstream *p_io, vlq_base128_be_t* p_parent, vlq_base128_be_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = p_root;
    f_has_next = false;
    f_value = false;
