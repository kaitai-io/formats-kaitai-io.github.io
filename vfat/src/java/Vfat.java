...
public class Vfat extends KaitaiStruct {
    ...
    public static class RootDirectoryRec extends KaitaiStruct {
        ...
        private void _read() {
            ...
            KaitaiStream _io_attrs = this._io.substream(1);
            this.attrs = new AttrFlags(_io_attrs, this, _root);
            this.reserved = this._io.readBytes(10);
            KaitaiStream _io_lastWriteTime = this._io.substream(4);
            this.lastWriteTime = new DosDatetime(_io_lastWriteTime);
    ...
    public RootDirectory rootDir() {
        ...
        KaitaiStream _io_rootDir = this._io.substream(bootSector().sizeRootDir());
        this.rootDir = new RootDirectory(_io_rootDir, this, _root);
        this._io.seek(_pos);
        return this.rootDir;
    }
