...
class Vfat < Kaitai::Struct::Struct
  ...
  class BootSector < Kaitai::Struct::Struct
    ...
    def _read
      ...
      @oem_name = (Kaitai::Struct::Stream::bytes_strip_right(@_io.read_bytes(8), 32)).force_encoding("ASCII").encode('UTF-8')
  ...
  class ExtBiosParamBlockFat16 < Kaitai::Struct::Struct
    ...
    def _read
      ...
      @partition_volume_label = (Kaitai::Struct::Stream::bytes_strip_right(@_io.read_bytes(11), 32)).force_encoding("ASCII").encode('UTF-8')
      @fs_type_str = (Kaitai::Struct::Stream::bytes_strip_right(@_io.read_bytes(8), 32)).force_encoding("ASCII").encode('UTF-8')
      self
    end
  ...
  class RootDirectoryRec < Kaitai::Struct::Struct
    ...
    def _read
      ...
      _io_attrs = @_io.substream(1)
      @attrs = AttrFlags.new(_io_attrs, self, @_root)
      @reserved = @_io.read_bytes(10)
      _io_last_write_time = @_io.substream(4)
      @last_write_time = DosDatetime.new(_io_last_write_time)
  ...
  def root_dir
    ...
    _io_root_dir = @_io.substream(boot_sector.size_root_dir)
    @root_dir = RootDirectory.new(_io_root_dir, self, @_root)
    @_io.seek(_pos)
    @root_dir
  end
