    ...
    public partial class Vfat : KaitaiStruct
    {
        ...
        public partial class ExtBiosParamBlockFat32 : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_reserved2, new byte[] { 0 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 0 }, _reserved2, m_io, "/types/ext_bios_param_block_fat32/seq/4");
                }
