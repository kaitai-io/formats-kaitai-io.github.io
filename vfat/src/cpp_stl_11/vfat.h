...
public:
    ...
    vfat_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, vfat_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        bios_param_block_t(kaitai::kstream* p__io, vfat_t::boot_sector_t* p__parent = nullptr, vfat_t* p__root = nullptr);
    ...
    public:
        ...
        boot_sector_t(kaitai::kstream* p__io, vfat_t* p__parent = nullptr, vfat_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<bios_param_block_t> m_bpb;
        std::unique_ptr<ext_bios_param_block_fat16_t> m_ebpb_fat16;
        bool n_ebpb_fat16;
    ...
    private:
        std::unique_ptr<ext_bios_param_block_fat32_t> m_ebpb_fat32;
        bool n_ebpb_fat32;
    ...
    public:
         ...
         */
        bios_param_block_t* bpb() const { return m_bpb.get(); }

        /**
         * FAT12/16-specific extended BIOS parameter block
         */
        ext_bios_param_block_fat16_t* ebpb_fat16() const { return m_ebpb_fat16.get(); }

        /**
         * FAT32-specific extended BIOS parameter block
         */
        ext_bios_param_block_fat32_t* ebpb_fat32() const { return m_ebpb_fat32.get(); }
        vfat_t* _root() const { return m__root; }
    ...
    public:
        ...
        ext_bios_param_block_fat16_t(kaitai::kstream* p__io, vfat_t::boot_sector_t* p__parent = nullptr, vfat_t* p__root = nullptr);
    ...
    public:
        ...
        ext_bios_param_block_fat32_t(kaitai::kstream* p__io, vfat_t::boot_sector_t* p__parent = nullptr, vfat_t* p__root = nullptr);
    ...
    public:
        ...
        root_directory_t(kaitai::kstream* p__io, vfat_t* p__parent = nullptr, vfat_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<std::vector<std::unique_ptr<root_directory_rec_t>>> m_records;
        vfat_t* m__root;
        vfat_t* m__parent;

    public:
        std::vector<std::unique_ptr<root_directory_rec_t>>* records() const { return m_records.get(); }
        vfat_t* _root() const { return m__root; }
        vfat_t* _parent() const { return m__parent; }
    };
...
private:
    bool f_fats;
    std::unique_ptr<std::vector<std::string>> m_fats;
...
private:
    bool f_root_dir;
    std::unique_ptr<root_directory_t> m_root_dir;

public:
    root_directory_t* root_dir();

private:
    std::unique_ptr<boot_sector_t> m_boot_sector;
    vfat_t* m__root;
...
public:
    boot_sector_t* boot_sector() const { return m_boot_sector.get(); }
    vfat_t* _root() const { return m__root; }
