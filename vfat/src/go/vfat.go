...
func (this Vfat) IO_() *kaitai.Stream {
	return this._io
}

func (this *Vfat) Read(io *kaitai.Stream, parent kaitai.Struct, root *Vfat) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
...
func (this Vfat_BiosParamBlock) IO_() *kaitai.Stream {
	return this._io
}
...
func (this *Vfat_BiosParamBlock) Read(io *kaitai.Stream, parent *Vfat_BootSector, root *Vfat) (err error) {
	...
	this.BytesPerLs = uint16(tmp9)
	tmp10, err := this._io.ReadU1()
	if err != nil {
		return err
	}
	this.LsPerClus = tmp10
	tmp11, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.NumReservedLs = uint16(tmp11)
	...
	this.MaxRootDirRec = uint16(tmp13)
	tmp14, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.TotalLs2 = uint16(tmp14)
	tmp15, err := this._io.ReadU1()
	if err != nil {
		return err
	}
	this.MediaCode = tmp15
	tmp16, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.LsPerFat = uint16(tmp16)
	tmp17, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.PsPerTrack = uint16(tmp17)
	tmp18, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.NumHeads = uint16(tmp18)
	tmp19, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.NumHiddenSectors = uint32(tmp19)
	tmp20, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.TotalLs4 = uint32(tmp20)
	return err
}
...
func (this Vfat_BootSector) IO_() *kaitai.Stream {
	return this._io
}
...
func (this *Vfat_BootSector) Read(io *kaitai.Stream, parent *Vfat, root *Vfat) (err error) {
	...
	tmp21, err := this._io.ReadBytes(int(3))
	if err != nil {
		return err
	}
	tmp21 = tmp21
	this.JmpInstruction = tmp21
	tmp22, err := this._io.ReadBytes(int(8))
	if err != nil {
		return err
	}
	tmp22 = kaitai.BytesStripRight(tmp22, 32)
	this.OemName = string(tmp22)
	tmp23 := NewVfat_BiosParamBlock()
	err = tmp23.Read(this._io, this, this._root)
	if err != nil {
		return err
	}
	this.Bpb = tmp23
	tmp24, err := this.IsFat32()
	if err != nil {
		return err
	}
	if (!(tmp24)) {
		tmp25 := NewVfat_ExtBiosParamBlockFat16()
		err = tmp25.Read(this._io, this, this._root)
		if err != nil {
			return err
		}
		this.EbpbFat16 = tmp25
	}
	tmp26, err := this.IsFat32()
	if err != nil {
		return err
	}
	if (tmp26) {
		tmp27 := NewVfat_ExtBiosParamBlockFat32()
		err = tmp27.Read(this._io, this, this._root)
		if err != nil {
			return err
		}
		this.EbpbFat32 = tmp27
	}
	return err
}
...
func (this *Vfat_BootSector) LsPerFat() (v uint32, err error) {
	...
	var tmp28 uint32;
	tmp29, err := this.IsFat32()
	if err != nil {
		return 0, err
	}
	if (tmp29) {
		tmp28 = this.EbpbFat32.LsPerFat
	} else {
		tmp28 = this.Bpb.LsPerFat
	}
	this.lsPerFat = uint32(tmp28)
	return this.lsPerFat, nil
}
...
func (this *Vfat_BootSector) PosRootDir() (v int, err error) {
	...
	tmp30, err := this.LsPerFat()
	if err != nil {
		return 0, err
	}
	this.posRootDir = int(this.Bpb.BytesPerLs * (this.Bpb.NumReservedLs + tmp30 * this.Bpb.NumFats))
	return this.posRootDir, nil
}
...
func (this *Vfat_BootSector) SizeFat() (v int, err error) {
	...
	tmp31, err := this.LsPerFat()
	if err != nil {
		return 0, err
	}
	this.sizeFat = int(this.Bpb.BytesPerLs * tmp31)
	return this.sizeFat, nil
}
...
func (this *Vfat_BootSector) SizeRootDir() (v int, err error) {
	...
	tmp32, err := this.LsPerRootDir()
	if err != nil {
		return 0, err
	}
	this.sizeRootDir = int(tmp32 * this.Bpb.BytesPerLs)
	return this.sizeRootDir, nil
}
...
func (this Vfat_ExtBiosParamBlockFat16) IO_() *kaitai.Stream {
	return this._io
}
...
func (this *Vfat_ExtBiosParamBlockFat16) Read(io *kaitai.Stream, parent *Vfat_BootSector, root *Vfat) (err error) {
	...
	tmp36 = tmp36
	this.VolumeId = tmp36
	tmp37, err := this._io.ReadBytes(int(11))
	if err != nil {
		return err
	}
	tmp37 = kaitai.BytesStripRight(tmp37, 32)
	this.PartitionVolumeLabel = string(tmp37)
	tmp38, err := this._io.ReadBytes(int(8))
	if err != nil {
		return err
	}
	tmp38 = kaitai.BytesStripRight(tmp38, 32)
	this.FsTypeStr = string(tmp38)
	return err
}
...
func (this Vfat_ExtBiosParamBlockFat32) IO_() *kaitai.Stream {
	return this._io
}
...
func (this *Vfat_ExtBiosParamBlockFat32) Read(io *kaitai.Stream, parent *Vfat_BootSector, root *Vfat) (err error) {
	...
	this.LsPerFat = uint32(tmp39)
	tmp40, err := this._io.ReadBitsIntLe(1)
	if err != nil {
		return err
	}
	this.HasActiveFat = tmp40 != 0
	tmp41, err := this._io.ReadBitsIntLe(3)
	if err != nil {
		return err
	}
	this.Reserved1 = tmp41
	tmp42, err := this._io.ReadBitsIntLe(4)
	if err != nil {
		return err
	}
	this.ActiveFatId = tmp42
	...
	this.FatVersion = uint16(tmp44)
	tmp45, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.RootDirStartClus = uint32(tmp45)
	tmp46, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.LsFsInfo = uint16(tmp46)
	tmp47, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.BootSectorsCopyStartLs = uint16(tmp47)
	tmp48, err := this._io.ReadBytes(int(12))
	if err != nil {
		return err
	}
	tmp48 = tmp48
	this.Reserved3 = tmp48
	tmp49, err := this._io.ReadU1()
	if err != nil {
		return err
	}
	this.PhysDriveNum = tmp49
	tmp50, err := this._io.ReadU1()
	if err != nil {
		return err
	}
	this.Reserved4 = tmp50
	tmp51, err := this._io.ReadU1()
	if err != nil {
		return err
	}
	this.ExtBootSign = tmp51
	...
	tmp52 = tmp52
	this.VolumeId = tmp52
	tmp53, err := this._io.ReadBytes(int(11))
	if err != nil {
		return err
	}
	tmp53 = kaitai.BytesStripRight(tmp53, 32)
	this.PartitionVolumeLabel = string(tmp53)
	tmp54, err := this._io.ReadBytes(int(8))
	if err != nil {
		return err
	}
	tmp54 = kaitai.BytesStripRight(tmp54, 32)
	this.FsTypeStr = string(tmp54)
	return err
}
...
func (this Vfat_RootDirectory) IO_() *kaitai.Stream {
	return this._io
}
...
func (this *Vfat_RootDirectory) Read(io *kaitai.Stream, parent *Vfat, root *Vfat) (err error) {
	...
	for i := 0; i < int(this._root.BootSector.Bpb.MaxRootDirRec); i++ {
		_ = i
		tmp55 := NewVfat_RootDirectoryRec()
		err = tmp55.Read(this._io, this, this._root)
		if err != nil {
			return err
		}
		this.Records = append(this.Records, tmp55)
	}
	return err
}
...
func (this Vfat_RootDirectoryRec) IO_() *kaitai.Stream {
	return this._io
}
...
func (this *Vfat_RootDirectoryRec) Read(io *kaitai.Stream, parent *Vfat_RootDirectory, root *Vfat) (err error) {
	...
	tmp56, err := this._io.ReadBytes(int(11))
	if err != nil {
		return err
	}
	tmp56 = tmp56
	this.FileName = tmp56
	tmp57, err := this._io.ReadBytes(int(1))
	if err != nil {
		return err
	}
	tmp57 = tmp57
	this._raw_Attrs = tmp57
	_io__raw_Attrs := kaitai.NewStream(bytes.NewReader(this._raw_Attrs))
	tmp58 := NewVfat_RootDirectoryRec_AttrFlags()
	err = tmp58.Read(_io__raw_Attrs, this, this._root)
	if err != nil {
		return err
	}
	this.Attrs = tmp58
	tmp59, err := this._io.ReadBytes(int(10))
	if err != nil {
		return err
	}
	tmp59 = tmp59
	...
	tmp60 = tmp60
	this._raw_LastWriteTime = tmp60
	_io__raw_LastWriteTime := kaitai.NewStream(bytes.NewReader(this._raw_LastWriteTime))
	tmp61 := NewDosDatetime()
	err = tmp61.Read(_io__raw_LastWriteTime, nil, nil)
	if err != nil {
		return err
	}
	this.LastWriteTime = tmp61
	tmp62, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.StartClus = uint16(tmp62)
	tmp63, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.FileSize = uint32(tmp63)
	return err
}
...
func (this Vfat_RootDirectoryRec_AttrFlags) IO_() *kaitai.Stream {
	return this._io
}
...
func (this *Vfat_RootDirectoryRec_AttrFlags) Read(io *kaitai.Stream, parent *Vfat_RootDirectoryRec, root *Vfat) (err error) {
	...
	this.VolumeId = tmp67 != 0
	tmp68, err := this._io.ReadBitsIntLe(1)
	if err != nil {
		return err
	}
	this.IsDirectory = tmp68 != 0
	tmp69, err := this._io.ReadBitsIntLe(1)
	if err != nil {
		return err
	}
	this.Archive = tmp69 != 0
	tmp70, err := this._io.ReadBitsIntLe(2)
	if err != nil {
		return err
	}
	this.Reserved = tmp70
