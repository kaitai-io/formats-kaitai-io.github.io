...
public class Regf extends KaitaiStruct {
    ...
    private void _read() {
        ...
        this.hiveBins = new ArrayList<HiveBin>();
        {
            ...
            while (!this._io.isEof()) {
                KaitaiStream _io_hiveBins = this._io.substream(4096);
                this.hiveBins.add(new HiveBin(_io_hiveBins, this, _root));
                i++;
            }
        }
    }
    ...
    public static class HiveBinCell extends KaitaiStruct {
        ...
        private void _read() {
            ...
            switch (identifier()) {
            case "lf": {
                KaitaiStream _io_data = this._io.substream((cellSize() - 2) - 4);
                this.data = new SubKeyListLhLf(_io_data, this, _root);
                break;
            }
            case "lh": {
                KaitaiStream _io_data = this._io.substream((cellSize() - 2) - 4);
            ...
            case "li": {
                KaitaiStream _io_data = this._io.substream((cellSize() - 2) - 4);
                this.data = new SubKeyListLi(_io_data, this, _root);
                break;
            }
            case "nk": {
                KaitaiStream _io_data = this._io.substream((cellSize() - 2) - 4);
                this.data = new NamedKey(_io_data, this, _root);
                break;
            }
            case "ri": {
                KaitaiStream _io_data = this._io.substream((cellSize() - 2) - 4);
                this.data = new SubKeyListRi(_io_data, this, _root);
                break;
            }
            case "sk": {
                KaitaiStream _io_data = this._io.substream((cellSize() - 2) - 4);
                this.data = new SubKeyListSk(_io_data, this, _root);
                break;
            }
            case "vk": {
                KaitaiStream _io_data = this._io.substream((cellSize() - 2) - 4);
                this.data = new SubKeyListVk(_io_data, this, _root);
                break;
            }
            default: {
