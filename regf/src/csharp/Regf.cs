    ...
    public partial class Regf : KaitaiStruct
    {
        ...
        public partial class FileHeader : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_signature, new byte[] { 114, 101, 103, 102 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 114, 101, 103, 102 }, _signature, m_io, "/types/file_header/seq/0");
                }
        ...
        public partial class HiveBinHeader : KaitaiStruct
        {
            ...
            {
                _signature = m_io.ReadBytes(4);
                if (!((KaitaiStream.ByteArrayCompare(_signature, new byte[] { 104, 98, 105, 110 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 104, 98, 105, 110 }, _signature, m_io, "/types/hive_bin_header/seq/0");
                }
