...
public:
    ...
    public:
        ...
        static bool _is_defined_file_format_t(file_format_t v);

    private:
        static const std::set<file_format_t> _values_file_format_t;
        static std::set<file_format_t> _build_values_file_format_t();
    ...
    public:
        ...
        public:
            ...
            static bool _is_defined_nk_flags_t(nk_flags_t v);

        private:
            static const std::set<nk_flags_t> _values_nk_flags_t;
            static std::set<nk_flags_t> _build_values_nk_flags_t();
        ...
        public:
            ...
            static bool _is_defined_data_type_enum_t(data_type_enum_t v);

        private:
            static const std::set<data_type_enum_t> _values_data_type_enum_t;
            static std::set<data_type_enum_t> _build_values_data_type_enum_t();
        ...
        public:
            ...
            static bool _is_defined_vk_flags_t(vk_flags_t v);

        private:
            static const std::set<vk_flags_t> _values_vk_flags_t;
            static std::set<vk_flags_t> _build_values_vk_flags_t();
