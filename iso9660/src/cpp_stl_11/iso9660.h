...
public:
    ...
    iso9660_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, iso9660_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        vol_desc_primary_t(kaitai::kstream* p__io, iso9660_t::vol_desc_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    private:
        bool f_path_table;
        std::unique_ptr<path_table_le_t> m_path_table;
    ...
    private:
        ...
        std::unique_ptr<u4bi_t> m_vol_space_size;
        std::string m_unused3;
        std::unique_ptr<u2bi_t> m_vol_set_size;
        std::unique_ptr<u2bi_t> m_vol_seq_num;
        std::unique_ptr<u2bi_t> m_logical_block_size;
        std::unique_ptr<u4bi_t> m_path_table_size;
        uint32_t m_lba_path_table_le;
        uint32_t m_lba_opt_path_table_le;
        uint32_t m_lba_path_table_be;
        uint32_t m_lba_opt_path_table_be;
        std::unique_ptr<dir_entry_t> m_root_dir;
        ...
        std::unique_ptr<dec_datetime_t> m_vol_create_datetime;
        std::unique_ptr<dec_datetime_t> m_vol_mod_datetime;
        std::unique_ptr<dec_datetime_t> m_vol_expire_datetime;
        std::unique_ptr<dec_datetime_t> m_vol_effective_datetime;
        ...
        std::unique_ptr<kaitai::kstream> m__io__raw_root_dir;
        std::string m__raw_path_table;
        std::unique_ptr<kaitai::kstream> m__io__raw_path_table;
    ...
    public:
        ...
        u4bi_t* vol_space_size() const { return m_vol_space_size.get(); }
        std::string unused3() const { return m_unused3; }
        u2bi_t* vol_set_size() const { return m_vol_set_size.get(); }
        u2bi_t* vol_seq_num() const { return m_vol_seq_num.get(); }
        u2bi_t* logical_block_size() const { return m_logical_block_size.get(); }
        u4bi_t* path_table_size() const { return m_path_table_size.get(); }
        ...
        dir_entry_t* root_dir() const { return m_root_dir.get(); }
        ...
        dec_datetime_t* vol_create_datetime() const { return m_vol_create_datetime.get(); }
        dec_datetime_t* vol_mod_datetime() const { return m_vol_mod_datetime.get(); }
        dec_datetime_t* vol_expire_datetime() const { return m_vol_expire_datetime.get(); }
        dec_datetime_t* vol_effective_datetime() const { return m_vol_effective_datetime.get(); }
        ...
        kaitai::kstream* _io__raw_root_dir() const { return m__io__raw_root_dir.get(); }
        std::string _raw_path_table() const { return m__raw_path_table; }
        kaitai::kstream* _io__raw_path_table() const { return m__io__raw_path_table.get(); }
    };
    ...
    public:
        ...
        vol_desc_boot_record_t(kaitai::kstream* p__io, iso9660_t::vol_desc_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    public:
        ...
        datetime_t(kaitai::kstream* p__io, iso9660_t::dir_entry_body_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    public:
        ...
        dir_entry_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    private:
        uint8_t m_len;
        std::unique_ptr<dir_entry_body_t> m_body;
        bool n_body;
    ...
    public:
        ...
        dir_entry_body_t* body() const { return m_body.get(); }
        iso9660_t* _root() const { return m__root; }
    ...
    public:
        ...
        vol_desc_t(kaitai::kstream* p__io, iso9660_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    private:
        ...
        std::string m_magic;
        uint8_t m_version;
        std::unique_ptr<vol_desc_boot_record_t> m_vol_desc_boot_record;
    ...
    private:
        std::unique_ptr<vol_desc_primary_t> m_vol_desc_primary;
    ...
    public:
        ...
        vol_desc_boot_record_t* vol_desc_boot_record() const { return m_vol_desc_boot_record.get(); }
        vol_desc_primary_t* vol_desc_primary() const { return m_vol_desc_primary.get(); }
        iso9660_t* _root() const { return m__root; }
    ...
    public:
        ...
        path_table_entry_le_t(kaitai::kstream* p__io, iso9660_t::path_table_le_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    public:
        ...
        dir_entries_t(kaitai::kstream* p__io, iso9660_t::dir_entry_body_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    public:
        ...
        u4bi_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    public:
        ...
        u2bi_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    public:
        ...
        path_table_le_t(kaitai::kstream* p__io, iso9660_t::vol_desc_primary_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<std::vector<std::unique_ptr<path_table_entry_le_t>>> m_entries;
        iso9660_t* m__root;
        iso9660_t::vol_desc_primary_t* m__parent;

    public:
        std::vector<std::unique_ptr<path_table_entry_le_t>>* entries() const { return m_entries.get(); }
        iso9660_t* _root() const { return m__root; }
    ...
    public:
        ...
        dec_datetime_t(kaitai::kstream* p__io, iso9660_t::vol_desc_primary_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    public:
        ...
        dir_entry_body_t(kaitai::kstream* p__io, iso9660_t::dir_entry_t* p__parent = nullptr, iso9660_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<dir_entries_t> m_extent_as_dir;
    ...
    private:
        uint8_t m_len_ext_attr_rec;
        std::unique_ptr<u4bi_t> m_lba_extent;
        std::unique_ptr<u4bi_t> m_size_extent;
        std::unique_ptr<datetime_t> m_datetime;
    ...
    private:
        std::unique_ptr<kaitai::kstream> m__io__raw_extent_as_dir;

    public:
        uint8_t len_ext_attr_rec() const { return m_len_ext_attr_rec; }
        u4bi_t* lba_extent() const { return m_lba_extent.get(); }
        u4bi_t* size_extent() const { return m_size_extent.get(); }
        datetime_t* datetime() const { return m_datetime.get(); }
        ...
        kaitai::kstream* _io__raw_extent_as_dir() const { return m__io__raw_extent_as_dir.get(); }
    };
...
private:
    ...
    std::unique_ptr<vol_desc_t> m_primary_vol_desc;
