...
namespace Iso9660 {
    class VolDesc extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic == "\x43\x44\x30\x30\x31")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x43\x44\x30\x30\x31", $this->_m_magic, $this->_io, "/types/vol_desc/seq/1");
            }
...
namespace Iso9660 {
    class VolDescPrimary extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_unused1 == "\x00")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x00", $this->_m_unused1, $this->_io, "/types/vol_desc_primary/seq/0");
            }
            ...
            if (!($this->_m_unused2 == "\x00\x00\x00\x00\x00\x00\x00\x00")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x00\x00\x00\x00\x00\x00\x00\x00", $this->_m_unused2, $this->_io, "/types/vol_desc_primary/seq/3");
            }
            $this->_m_volSpaceSize = new \Iso9660\U4bi($this->_io, $this, $this->_root);
            $this->_m_unused3 = $this->_io->readBytes(32);
            if (!($this->_m_unused3 == "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", $this->_m_unused3, $this->_io, "/types/vol_desc_primary/seq/5");
            }
