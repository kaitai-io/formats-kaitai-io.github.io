...
public:
    ...
    utf8_string_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, utf8_string_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        utf8_codepoint_t(uint64_t p_ofs, kaitai::kstream* p__io, utf8_string_t* p__parent = nullptr, utf8_string_t* p__root = nullptr);
...
public:
    std::vector<std::unique_ptr<utf8_codepoint_t>>* codepoints() const { return m_codepoints.get(); }
    utf8_string_t* _root() const { return m__root; }
