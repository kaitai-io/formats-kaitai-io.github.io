 ...
 * \sa https://msdn.microsoft.com/en-us/library/ms680378(VS.85).aspx Source
 */
...
public:
    ...
    enum stream_types_t {
        ...
        STREAM_TYPES_PROCESS_VM_VOUNTERS = 22,
...
public:
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680515(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680383(v=vs.85).aspx Source
     */
     ...
     * \sa https://msdn.microsoft.com/en-us/library/ms680395(v=vs.85).aspx Source
     */
     ...
     * \sa https://msdn.microsoft.com/en-us/library/ms680396(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680367(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680389(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680365(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680517(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680387(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680384(v=vs.85).aspx Source
     */
    ...
    /**
     * \sa https://msdn.microsoft.com/en-us/library/ms680368(v=vs.85).aspx Source
     */
