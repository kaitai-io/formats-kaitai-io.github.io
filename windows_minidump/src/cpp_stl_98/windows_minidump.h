...
private:
    ...
    static std::set<stream_types_t> _build_values_stream_types_t();
...
public:
    ...
    public:
        ...
        memory_64_list_t(kaitai::kstream* p__io, windows_minidump_t::dir_t* p__parent = 0, windows_minidump_t* p__root = 0);
    ...
    private:
        ...
        uint64_t m_ofs_base;
        std::vector<memory_descriptor_64_t*>* m_mem_ranges;
        windows_minidump_t* m__root;
        windows_minidump_t::dir_t* m__parent;
    ...
    public:
        ...
        std::vector<memory_descriptor_64_t*>* mem_ranges() const { return m_mem_ranges; }
        windows_minidump_t* _root() const { return m__root; }
        windows_minidump_t::dir_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        memory_descriptor_64_t(kaitai::kstream* p__io, windows_minidump_t::memory_64_list_t* p__parent = 0, windows_minidump_t* p__root = 0);
    ...
    private:
        ...
        static std::set<cpu_archs_t> _build_values_cpu_archs_t();
