...
our $STREAM_TYPES_PROCESS_VM_VOUNTERS = 22;
...
sub _read {
    ...
    $self->{magic1} = $self->{_io}->ensure_fixed_contents(pack('C*', (77, 68, 77, 80)));
    $self->{magic2} = $self->{_io}->ensure_fixed_contents(pack('C*', (147, 167)));
