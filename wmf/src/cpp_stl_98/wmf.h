...
private:
    ...
    static std::set<bin_raster_op_t> _build_values_bin_raster_op_t();
...
private:
    ...
    static std::set<func_t> _build_values_func_t();
...
private:
    ...
    static std::set<mix_mode_t> _build_values_mix_mode_t();
...
private:
    ...
    static std::set<poly_fill_mode_t> _build_values_poly_fill_mode_t();
...
public:
    ...
    private:
        ...
        static std::set<metafile_type_t> _build_values_metafile_type_t();
