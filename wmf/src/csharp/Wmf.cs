    ...
    public partial class Wmf : KaitaiStruct
    {
        ...
        public partial class SpecialHeader : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_magic, new byte[] { 215, 205, 198, 154 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 215, 205, 198, 154 }, _magic, m_io, "/types/special_header/seq/0");
                }
                _handle = m_io.ReadBytes(2);
                if (!((KaitaiStream.ByteArrayCompare(_handle, new byte[] { 0, 0 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 0, 0 }, _handle, m_io, "/types/special_header/seq/1");
                }
                _left = m_io.ReadS2le();
                _top = m_io.ReadS2le();
                ...
                {
                    throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/special_header/seq/7");
                }
