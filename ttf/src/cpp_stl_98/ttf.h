...
public:
    ...
    public:
        ...
        private:
            ...
            static std::set<subtable_format_t> _build_values_subtable_format_t();
    ...
    private:
        ...
        static std::set<flags_t> _build_values_flags_t();
    ...
    private:
        ...
        static std::set<font_direction_hint_t> _build_values_font_direction_hint_t();
    ...
    private:
        ...
        static std::set<names_t> _build_values_names_t();
    ...
    private:
        ...
        static std::set<platforms_t> _build_values_platforms_t();
    ...
    private:
        ...
        static std::set<fs_selection_t> _build_values_fs_selection_t();
    ...
    private:
        ...
        static std::set<fs_type_t> _build_values_fs_type_t();
    ...
    private:
        ...
        static std::set<weight_class_t> _build_values_weight_class_t();
    ...
    private:
        ...
        static std::set<width_class_t> _build_values_width_class_t();
    ...
    public:
        ...
        private:
            ...
            static std::set<arm_style_t> _build_values_arm_style_t();
        ...
        private:
            ...
            static std::set<contrast_t> _build_values_contrast_t();
        ...
        private:
            ...
            static std::set<family_kind_t> _build_values_family_kind_t();
        ...
        private:
            ...
            static std::set<letter_form_t> _build_values_letter_form_t();
        ...
        private:
            ...
            static std::set<midline_t> _build_values_midline_t();
        ...
        private:
            ...
            static std::set<proportion_t> _build_values_proportion_t();
        ...
        private:
            ...
            static std::set<serif_style_t> _build_values_serif_style_t();
        ...
        private:
            ...
            static std::set<stroke_variation_t> _build_values_stroke_variation_t();
        ...
        private:
            ...
            static std::set<weight_t> _build_values_weight_t();
        ...
        private:
            ...
            static std::set<x_height_t> _build_values_x_height_t();
