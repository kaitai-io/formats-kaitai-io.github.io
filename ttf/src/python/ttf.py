...
class Ttf(KaitaiStruct):
    ...
    class Name(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.name_records = [None] * (self.name_record_count)
            for i in range(self.name_record_count):
        ...
        class NameRecord(KaitaiStruct):
            ...
            def ascii_value(self):
                ...
                self._m_ascii_value = (io.read_bytes(self.string_length)).decode(u"ascii")
                io.seek(_pos)
                return self._m_ascii_value if hasattr(self, '_m_ascii_value') else None
            ...
            def unicode_value(self):
                ...
                _pos = io.pos()
                io.seek((self._parent.string_storage_offset + self.string_offset))
                self._m_unicode_value = (io.read_bytes(self.string_length)).decode(u"utf-16be")
                io.seek(_pos)
                return self._m_unicode_value if hasattr(self, '_m_unicode_value') else None
