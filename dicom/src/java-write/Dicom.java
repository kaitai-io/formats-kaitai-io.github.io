 ...
 */
public class Dicom extends KaitaiStruct.ReadWrite {
    ...
    public Dicom(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
        this(_io, _parent, null);
    }

    public Dicom(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, Dicom _root) {
        super(_io);
    ...
    public void _read() {
        ...
        this.elements = new ArrayList<TDataElementImplicit>();
        {
            ...
            while (!this._io.isEof()) {
                TDataElementImplicit _t_elements = new TDataElementImplicit(this._io, this, _root);
                try {
                    _t_elements._read();
                } finally {
    ...
    public static class SeqItem extends KaitaiStruct.ReadWrite {
        ...
        public SeqItem(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
            this(_io, _parent, null);
        }

        public SeqItem(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, Dicom _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
        }
        public void _read() {
            ...
            if (valueLen() == 4294967295L) {
                this.items = new ArrayList<TDataElementExplicit>();
                {
                    ...
                    int i = 0;
                    do {
                        TDataElementExplicit _t_items = new TDataElementExplicit(this._io, this, _root);
                        try {
                            _t_items._read();
                        } finally {
                            _it = _t_items;
        ...
        public void _write_Seq() {
            _assertNotDirty();
            this._io.writeBytes(this.tagGroup);
            this._io.writeU2le(this.tagElem);
            this._io.writeU4le(this.valueLen);
            if (valueLen() != 4294967295L) {
        ...
        public void _check() {
            if (this.tagGroup.length != 2)
                throw new ConsistencyError("tag_group", 2, this.tagGroup.length);
            if (!(Arrays.equals(this.tagGroup, new byte[] { -2, -1 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { -2, -1 }, this.tagGroup, null, "/types/seq_item/seq/0");
            }
            if (valueLen() != 4294967295L) {
                if (this.value.length != valueLen())
                    throw new ConsistencyError("value", valueLen(), this.value.length);
            }
            if (valueLen() == 4294967295L) {
                ...
                for (int i = 0; i < this.items.size(); i++) {
                    ...
                    {
                        TDataElementExplicit _it = this.items.get(((Number) (i)).intValue());
                        if ( ((_it.tagGroup() == 65534) && (_it.tagElem() == 57357))  != (i == this.items.size() - 1))
                            throw new ConsistencyError("items", i == this.items.size() - 1,  ((_it.tagGroup() == 65534) && (_it.tagElem() == 57357)) );
                    }
                }
            }
            _dirty = false;
        ...
        public void setTagGroup(byte[] _v) { _dirty = true; tagGroup = _v; }
        public int tagElem() { return tagElem; }
        public void setTagElem(int _v) { _dirty = true; tagElem = _v; }
        public long valueLen() { return valueLen; }
        public void setValueLen(long _v) { _dirty = true; valueLen = _v; }
        public byte[] value() { return value; }
        public void setValue(byte[] _v) { _dirty = true; value = _v; }
        public List<TDataElementExplicit> items() { return items; }
        public void setItems(List<TDataElementExplicit> _v) { _dirty = true; items = _v; }
        public Dicom _root() { return _root; }
        public void set_root(Dicom _v) { _dirty = true; _root = _v; }
     ...
     */
    public static class TDataElementExplicit extends KaitaiStruct.ReadWrite {
        ...
        public TDataElementExplicit(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
            this(_io, _parent, null);
        }

        public TDataElementExplicit(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, Dicom _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
        }
        public void _read() {
            ...
            if ( ((vr().equals("SQ")) && (valueLen() == 4294967295L)) ) {
                this.items = new ArrayList<SeqItem>();
                {
                    ...
                    int i = 0;
                    do {
                        SeqItem _t_items = new SeqItem(this._io, this, _root);
                        try {
                            _t_items._read();
                        } finally {
                            _it = _t_items;
            ...
            if (isTransferSyntaxChangeImplicit()) {
                this.elementsImplicit = new ArrayList<TDataElementImplicit>();
                {
                    int i = 0;
                    while (!this._io.isEof()) {
                        TDataElementImplicit _t_elementsImplicit = new TDataElementImplicit(this._io, this, _root);
                        try {
                            _t_elementsImplicit._read();
                        } finally {
                            this.elementsImplicit.add(_t_elementsImplicit);
                        }
                        i++;
                    }
                }
        ...
        public void _write_Seq() {
            _assertNotDirty();
            this._io.writeU2le(this.tagGroup);
            this._io.writeU2le(this.tagElem);
            if (!(isForcedImplicit())) {
                this._io.writeBytes((this.vr).getBytes(Charset.forName("ASCII")));
            }
            if ( ((isLongLen()) && (!(isForcedImplicit()))) ) {
            ...
            }
            {
                boolean on = isLongLen();
                if (on == false) {
                    this._io.writeU2le(((Number) (this.valueLen)).intValue());
                }
                else if (on == true) {
                    this._io.writeU4le(this.valueLen);
                }
            ...
            if (isTransferSyntaxChangeImplicit()) {
                for (int i = 0; i < this.elementsImplicit.size(); i++) {
                    if (this._io.isEof())
                        throw new ConsistencyError("elements_implicit", 0, this._io.size() - this._io.pos());
                    this.elementsImplicit.get(((Number) (i)).intValue())._write_Seq(this._io);
                }
                if (!(this._io.isEof()))
                    throw new ConsistencyError("elements_implicit", 0, this._io.size() - this._io.pos());
            }
        ...
        public void _check() {
            if (!(isForcedImplicit())) {
                if ((this.vr).getBytes(Charset.forName("ASCII")).length != 2)
                    throw new ConsistencyError("vr", 2, (this.vr).getBytes(Charset.forName("ASCII")).length);
            }
            if ( ((isLongLen()) && (!(isForcedImplicit()))) ) {
            }
            {
            ...
            if ( ((vr().equals("SQ")) && (valueLen() == 4294967295L)) ) {
                ...
                for (int i = 0; i < this.items.size(); i++) {
                    ...
                    if (!Objects.equals(this.items.get(((Number) (i)).intValue())._parent(), this))
                        throw new ConsistencyError("items", this, this.items.get(((Number) (i)).intValue())._parent());
                    {
                        SeqItem _it = this.items.get(((Number) (i)).intValue());
                        if ((_it.tagElem() == 57565) != (i == this.items.size() - 1))
                            throw new ConsistencyError("items", i == this.items.size() - 1, _it.tagElem() == 57565);
                    }
                }
            }
            if (isTransferSyntaxChangeImplicit()) {
                for (int i = 0; i < this.elementsImplicit.size(); i++) {
                    if (!Objects.equals(this.elementsImplicit.get(((Number) (i)).intValue())._root(), _root()))
                        throw new ConsistencyError("elements_implicit", _root(), this.elementsImplicit.get(((Number) (i)).intValue())._root());
                    if (!Objects.equals(this.elementsImplicit.get(((Number) (i)).intValue())._parent(), this))
                        throw new ConsistencyError("elements_implicit", this, this.elementsImplicit.get(((Number) (i)).intValue())._parent());
                }
            }
            _dirty = false;
        }
        ...
        public void _invalidateIsForcedImplicit() { this.isForcedImplicit = null; }
        ...
        public void _invalidateIsLongLen() { this.isLongLen = null; }
        ...
        public void _invalidateIsTransferSyntaxChangeImplicit() { this.isTransferSyntaxChangeImplicit = null; }
        private Tags tag;
        public Tags tag() {
            if (this.tag != null)
                return this.tag;
        ...
        public void setTagGroup(int _v) { _dirty = true; tagGroup = _v; }
        public int tagElem() { return tagElem; }
        public void setTagElem(int _v) { _dirty = true; tagElem = _v; }
        public String vr() { return vr; }
        public void setVr(String _v) { _dirty = true; vr = _v; }
        ...
        public void setItems(List<SeqItem> _v) { _dirty = true; items = _v; }
        public List<TDataElementImplicit> elementsImplicit() { return elementsImplicit; }
        public void setElementsImplicit(List<TDataElementImplicit> _v) { _dirty = true; elementsImplicit = _v; }
        public Dicom _root() { return _root; }
        public void set_root(Dicom _v) { _dirty = true; _root = _v; }
        public KaitaiStruct.ReadWrite _parent() { return _parent; }
        public void set_parent(KaitaiStruct.ReadWrite _v) { _dirty = true; _parent = _v; }
     ...
     * @see <a href="https://dicom.nema.org/medical/dicom/current/output/html/part05.html#sect_7.1.2">Source</a>
     */
    public static class TDataElementImplicit extends KaitaiStruct.ReadWrite {
        ...
        public TDataElementImplicit(KaitaiStream _io, KaitaiStruct.ReadWrite _parent) {
            this(_io, _parent, null);
        }

        public TDataElementImplicit(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, Dicom _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
        }
        public void _read() {
            ...
            if (isTransferSyntaxChangeExplicit()) {
                this.elements = new ArrayList<TDataElementExplicit>();
                {
                    int i = 0;
                    while (!this._io.isEof()) {
                        TDataElementExplicit _t_elements = new TDataElementExplicit(this._io, this, _root);
                        try {
                            _t_elements._read();
                        } finally {
                            this.elements.add(_t_elements);
        ...
        public void _invalidateIsForcedExplicit() { this.isForcedExplicit = null; }
        private Boolean isLongLen;
        public Boolean isLongLen() {
            if (this.isLongLen != null)
                return this.isLongLen;
        ...
        public void _invalidateIsTransferSyntaxChangeExplicit() { this.isTransferSyntaxChangeExplicit = null; }
        ...
        public void _invalidatePIsTransferSyntaxChangeExplicit() { this.pIsTransferSyntaxChangeExplicit = null; }
        private Tags tag;
        public Tags tag() {
            if (this.tag != null)
                return this.tag;
        ...
        public void setElements(List<TDataElementExplicit> _v) { _dirty = true; elements = _v; }
        public Dicom _root() { return _root; }
        public void set_root(Dicom _v) { _dirty = true; _root = _v; }
        public KaitaiStruct.ReadWrite _parent() { return _parent; }
        public void set_parent(KaitaiStruct.ReadWrite _v) { _dirty = true; _parent = _v; }
    }
    public static class TFileHeader extends KaitaiStruct.ReadWrite {
        ...
        public void _write_Seq() {
            _assertNotDirty();
            this._io.writeBytes(this.preamble);
            this._io.writeBytes(this.magic);
        }

        public void _check() {
            if (this.preamble.length != 128)
                throw new ConsistencyError("preamble", 128, this.preamble.length);
            if (this.magic.length != 4)
                throw new ConsistencyError("magic", 4, this.magic.length);
            if (!(Arrays.equals(this.magic, new byte[] { 68, 73, 67, 77 }))) {
                throw new KaitaiStream.ValidationNotEqualError(new byte[] { 68, 73, 67, 77 }, this.magic, null, "/types/t_file_header/seq/1");
            }
            _dirty = false;
        }
        ...
        public void setPreamble(byte[] _v) { _dirty = true; preamble = _v; }
        public byte[] magic() { return magic; }
        public void setMagic(byte[] _v) { _dirty = true; magic = _v; }
        public Dicom _root() { return _root; }
        public void set_root(Dicom _v) { _dirty = true; _root = _v; }
        public Dicom _parent() { return _parent; }
        public void set_parent(Dicom _v) { _dirty = true; _parent = _v; }
    }
    ...
    public void setFileHeader(TFileHeader _v) { _dirty = true; fileHeader = _v; }
    public List<TDataElementImplicit> elements() { return elements; }
    public void setElements(List<TDataElementImplicit> _v) { _dirty = true; elements = _v; }
    public Dicom _root() { return _root; }
    public void set_root(Dicom _v) { _dirty = true; _root = _v; }
    public KaitaiStruct.ReadWrite _parent() { return _parent; }
    public void set_parent(KaitaiStruct.ReadWrite _v) { _dirty = true; _parent = _v; }
