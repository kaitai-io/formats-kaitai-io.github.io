...
void doom_wad_t::pnames_t::_read() {
    ...
    for (int i = 0; i < l_names; i++) {
        m_names->push_back(std::move(kaitai::kstream::bytes_to_str(kaitai::kstream::bytes_strip_right(m__io->read_bytes(8), 0), "ASCII")));
    }
}
...
const std::set<doom_wad_t::sector_t::special_sector_t> doom_wad_t::sector_t::_values_special_sector_t{
    doom_wad_t::sector_t::SPECIAL_SECTOR_NORMAL,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_FLICKER,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_FAST,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_SLOW,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_HURT,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_HELLSLIME,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_NUKAGE,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_GLOW,
    doom_wad_t::sector_t::SPECIAL_SECTOR_SECRET,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_SECTOR_DOOR_CLOSE_IN_30,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_END,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_SLOW_SYNC,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_FAST_SYNC,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_SECTOR_DOOR_RAISE_IN_5_MINS,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_FRICTION_LOW,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_SUPER_HELLSLIME,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_FIRE_FLICKER,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_LAVA_WIMPY,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_LAVA_HEFTY,
    doom_wad_t::sector_t::SPECIAL_SECTOR_D_SCROLL_EAST_LAVA_DAMAGE,
    doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_PHASED,
    doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_SEQUENCE_START,
    doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_SEQUENCE_SPECIAL1,
    doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_SEQUENCE_SPECIAL2,
};
