...
public:
    ...
    public:
        ...
        static bool _is_defined_special_sector_t(special_sector_t v);

    private:
        static const std::set<special_sector_t> _values_special_sector_t;
        static std::set<special_sector_t> _build_values_special_sector_t();
