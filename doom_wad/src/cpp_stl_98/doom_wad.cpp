...
void doom_wad_t::index_entry_t::_read() {
    ...
    m_name = kaitai::kstream::bytes_to_str(kaitai::kstream::bytes_strip_right(m__io->read_bytes(8), 0), "ASCII");
}
...
void doom_wad_t::pnames_t::_read() {
    ...
    for (int i = 0; i < l_names; i++) {
        m_names->push_back(kaitai::kstream::bytes_to_str(kaitai::kstream::bytes_strip_right(m__io->read_bytes(8), 0), "ASCII"));
    }
}
...
std::set<doom_wad_t::sector_t::special_sector_t> doom_wad_t::sector_t::_build_values_special_sector_t() {
    std::set<doom_wad_t::sector_t::special_sector_t> _t;
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_NORMAL);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_FLICKER);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_FAST);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_SLOW);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_HURT);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_HELLSLIME);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_NUKAGE);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_GLOW);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_SECRET);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_SECTOR_DOOR_CLOSE_IN_30);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_END);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_SLOW_SYNC);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_STROBE_FAST_SYNC);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_SECTOR_DOOR_RAISE_IN_5_MINS);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_FRICTION_LOW);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_SUPER_HELLSLIME);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_LIGHT_FIRE_FLICKER);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_LAVA_WIMPY);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_DAMAGE_LAVA_HEFTY);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_D_SCROLL_EAST_LAVA_DAMAGE);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_PHASED);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_SEQUENCE_START);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_SEQUENCE_SPECIAL1);
    _t.insert(doom_wad_t::sector_t::SPECIAL_SECTOR_LIGHT_SEQUENCE_SPECIAL2);
    return _t;
}
const std::set<doom_wad_t::sector_t::special_sector_t> doom_wad_t::sector_t::_values_special_sector_t = doom_wad_t::sector_t::_build_values_special_sector_t();
bool doom_wad_t::sector_t::_is_defined_special_sector_t(doom_wad_t::sector_t::special_sector_t v) {
    return doom_wad_t::sector_t::_values_special_sector_t.find(v) != doom_wad_t::sector_t::_values_special_sector_t.end();
}
...
void doom_wad_t::sector_t::_read() {
    ...
    m_floor_flat = kaitai::kstream::bytes_to_str(m__io->read_bytes(8), "ASCII");
    m_ceil_flat = kaitai::kstream::bytes_to_str(m__io->read_bytes(8), "ASCII");
...
void doom_wad_t::sidedef_t::_read() {
    ...
    m_upper_texture_name = kaitai::kstream::bytes_to_str(m__io->read_bytes(8), "ASCII");
    m_lower_texture_name = kaitai::kstream::bytes_to_str(m__io->read_bytes(8), "ASCII");
    m_normal_texture_name = kaitai::kstream::bytes_to_str(m__io->read_bytes(8), "ASCII");
