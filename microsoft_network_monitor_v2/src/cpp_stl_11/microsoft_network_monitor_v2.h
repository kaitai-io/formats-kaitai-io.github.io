...
public:
    ...
    public:
        ...
        frame_index_t(kaitai::kstream* p__io, microsoft_network_monitor_v2_t* p__parent = nullptr, microsoft_network_monitor_v2_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<std::vector<std::unique_ptr<frame_index_entry_t>>> m_entries;
        microsoft_network_monitor_v2_t* m__root;
        microsoft_network_monitor_v2_t* m__parent;

    public:
        std::vector<std::unique_ptr<frame_index_entry_t>>* entries() const { return m_entries.get(); }
    ...
    public:
        ...
        frame_index_entry_t(kaitai::kstream* p__io, microsoft_network_monitor_v2_t::frame_index_t* p__parent = nullptr, microsoft_network_monitor_v2_t* p__root = nullptr);
...
private:
    bool f_frame_table;
    std::unique_ptr<frame_index_t> m_frame_table;
...
private:
    ...
    std::unique_ptr<windows_systemtime_t> m_time_capture_start;
    ...
    std::unique_ptr<kaitai::kstream> m__io__raw_frame_table;
...
public:
     ...
     */
    windows_systemtime_t* time_capture_start() const { return m_time_capture_start.get(); }
    ...
    kaitai::kstream* _io__raw_frame_table() const { return m__io__raw_frame_table.get(); }
};
