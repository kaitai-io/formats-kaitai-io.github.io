...
class Gzip extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_magic = $this->_io->ensureFixedContents("\x1F\x8B");
...
class Flags extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_reserved1 = $this->_io->readBitsInt(3);
        $this->_m_hasComment = $this->_io->readBitsInt(1) != 0;
        $this->_m_hasName = $this->_io->readBitsInt(1) != 0;
        $this->_m_hasExtra = $this->_io->readBitsInt(1) != 0;
        $this->_m_hasHeaderCrc = $this->_io->readBitsInt(1) != 0;
        $this->_m_isText = $this->_io->readBitsInt(1) != 0;
    }
