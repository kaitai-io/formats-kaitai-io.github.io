...
private:
    ...
    static std::set<color_space_t> _build_values_color_space_t();
...
private:
    ...
    static std::set<header_type_t> _build_values_header_type_t();
...
private:
    ...
    static std::set<os2_compressions_t> _build_values_os2_compressions_t();
...
private:
    ...
    static std::set<os2_rendering_t> _build_values_os2_rendering_t();
