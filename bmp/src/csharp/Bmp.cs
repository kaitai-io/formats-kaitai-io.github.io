    ...
    public partial class Bmp : KaitaiStruct
    {
        ...
        public partial class BitmapHeader : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (IsColorMaskHere) {
                    _colorMask = new ColorMask(LenHeader != ((int) Bmp.HeaderType.BitmapV2InfoHeader), m_io, this, m_root);
                }
            ...
            public bool ExtendsBitmapInfo
            {
                get
                {
                    ...
                    _extendsBitmapInfo = (bool) (LenHeader >= ((int) Bmp.HeaderType.BitmapInfoHeader));
                    return _extendsBitmapInfo;
                }
            }
            ...
            public bool ExtendsBitmapV4
            {
                get
                {
                    ...
                    _extendsBitmapV4 = (bool) (LenHeader >= ((int) Bmp.HeaderType.BitmapV4Header));
                    return _extendsBitmapV4;
                }
            }
            ...
            public bool ExtendsBitmapV5
            {
                get
                {
                    ...
                    _extendsBitmapV5 = (bool) (LenHeader >= ((int) Bmp.HeaderType.BitmapV5Header));
                    return _extendsBitmapV5;
                }
            }
            ...
            public bool ExtendsOs22xBitmap
            {
                get
                {
                    ...
                    _extendsOs22xBitmap = (bool) (LenHeader == ((int) Bmp.HeaderType.Os22xBitmapHeader));
                    return _extendsOs22xBitmap;
                }
            }
            ...
            public bool IsColorMaskHere
            {
                get
                {
                    ...
                    _isColorMaskHere = (bool) ( ((LenHeader == ((int) Bmp.HeaderType.BitmapV2InfoHeader)) || (LenHeader == ((int) Bmp.HeaderType.BitmapV3InfoHeader)) || (ExtendsBitmapV4)) );
                    return _isColorMaskHere;
                }
            }
            ...
            public bool IsCoreHeader
            {
                get
                {
                    ...
                    f_isCoreHeader = true;
                    _isCoreHeader = (bool) (LenHeader == ((int) Bmp.HeaderType.BitmapCoreHeader));
                    return _isCoreHeader;
                }
            }
            ...
            public bool IsColorMaskHere
            {
                get
                {
                    if (f_isColorMaskHere)
                        return _isColorMaskHere;
                    f_isColorMaskHere = true;
                    _isColorMaskHere = (bool) ( ((!(M_Io.IsEof)) && (Header.LenHeader == ((int) Bmp.HeaderType.BitmapInfoHeader)) && ( ((Header.BitmapInfoExt.Compression == Bmp.Compressions.Bitfields) || (Header.BitmapInfoExt.Compression == Bmp.Compressions.AlphaBitfields)) )) );
                    return _isColorMaskHere;
                }
            }
            private uint _lenHeader;
        ...
        public partial class FileHeader : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_fileType, new byte[] { 66, 77 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 66, 77 }, _fileType, m_io, "/types/file_header/seq/0");
                }
