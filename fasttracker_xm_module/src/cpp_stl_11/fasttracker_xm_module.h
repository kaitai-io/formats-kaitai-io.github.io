...
public:
    ...
    fasttracker_xm_module_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        flags_t(kaitai::kstream* p__io, fasttracker_xm_module_t::header_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
    ...
    public:
        ...
        header_t(kaitai::kstream* p__io, fasttracker_xm_module_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<std::vector<uint8_t>> m_pattern_order_table;
        fasttracker_xm_module_t* m__root;
    ...
    public:
         ...
         * max 256
         */
        std::vector<uint8_t>* pattern_order_table() const { return m_pattern_order_table.get(); }
        fasttracker_xm_module_t* _root() const { return m__root; }
    ...
    public:
        ...
        instrument_t(kaitai::kstream* p__io, fasttracker_xm_module_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            extra_header_t(kaitai::kstream* p__io, fasttracker_xm_module_t::instrument_t::header_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
        ...
        public:
            ...
            public:
                ...
                envelope_point_t(kaitai::kstream* p__io, fasttracker_xm_module_t::instrument_t::extra_header_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
        ...
        private:
            ...
            std::unique_ptr<std::vector<uint8_t>> m_idx_sample_per_note;
            std::unique_ptr<std::vector<std::unique_ptr<envelope_point_t>>> m_volume_points;
            std::unique_ptr<std::vector<std::unique_ptr<envelope_point_t>>> m_panning_points;
        ...
        public:
             ...
             */
            std::vector<uint8_t>* idx_sample_per_note() const { return m_idx_sample_per_note.get(); }

            /**
             * Points for volume envelope. Only `num_volume_points` will be actually used.
             */
            std::vector<std::unique_ptr<envelope_point_t>>* volume_points() const { return m_volume_points.get(); }

            /**
             * Points for panning envelope. Only `num_panning_points` will be actually used.
             */
            std::vector<std::unique_ptr<envelope_point_t>>* panning_points() const { return m_panning_points.get(); }
        ...
        public:
            ...
            header_t(kaitai::kstream* p__io, fasttracker_xm_module_t::instrument_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
        ...
        private:
            ...
            std::unique_ptr<extra_header_t> m_extra_header;
            bool n_extra_header;
        ...
        public:
            ...
            extra_header_t* extra_header() const { return m_extra_header.get(); }
            fasttracker_xm_module_t* _root() const { return m__root; }
        ...
        public:
            ...
            sample_header_t(kaitai::kstream* p__io, fasttracker_xm_module_t::instrument_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
        ...
        public:
            ...
            public:
                ...
                loop_type_t(kaitai::kstream* p__io, fasttracker_xm_module_t::instrument_t::sample_header_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
        ...
        private:
            ...
            uint8_t m_volume;
            int8_t m_fine_tune;
            std::unique_ptr<loop_type_t> m_type;
            uint8_t m_panning;
        ...
        public:
            ...
            loop_type_t* type() const { return m_type.get(); }
        ...
        public:
            ...
            samples_data_t(sample_header_t* p_header, kaitai::kstream* p__io, fasttracker_xm_module_t::instrument_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<std::vector<std::unique_ptr<sample_header_t>>> m_samples_headers;
        std::unique_ptr<std::vector<std::unique_ptr<samples_data_t>>> m_samples;
        fasttracker_xm_module_t* m__root;
        fasttracker_xm_module_t* m__parent;
    ...
    public:
        ...
        std::vector<std::unique_ptr<sample_header_t>>* samples_headers() const { return m_samples_headers.get(); }
        std::vector<std::unique_ptr<samples_data_t>>* samples() const { return m_samples.get(); }
        fasttracker_xm_module_t* _root() const { return m__root; }
        fasttracker_xm_module_t* _parent() const { return m__parent; }
    ...
    public:
        ...
        pattern_t(kaitai::kstream* p__io, fasttracker_xm_module_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            header_t(kaitai::kstream* p__io, fasttracker_xm_module_t::pattern_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
        ...
        public:
            ...
            public:
                ...
                header_main_t(kaitai::kstream* p__io, fasttracker_xm_module_t::pattern_t::header_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
        ...
        private:
            ...
            std::unique_ptr<header_main_t> m_main;
            fasttracker_xm_module_t* m__root;
        ...
        public:
            ...
            header_main_t* main() const { return m_main.get(); }
            fasttracker_xm_module_t* _root() const { return m__root; }
    ...
    public:
        ...
        preheader_t(kaitai::kstream* p__io, fasttracker_xm_module_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            version_t(kaitai::kstream* p__io, fasttracker_xm_module_t::preheader_t* p__parent = nullptr, fasttracker_xm_module_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<version_t> m_version_number;
        uint32_t m_header_size;
        fasttracker_xm_module_t* m__root;
        fasttracker_xm_module_t* m__parent;
    ...
    public:
         ...
         */
        version_t* version_number() const { return m_version_number.get(); }
...
private:
    std::unique_ptr<preheader_t> m_preheader;
    std::unique_ptr<header_t> m_header;
    std::unique_ptr<std::vector<std::unique_ptr<pattern_t>>> m_patterns;
...
public:
    preheader_t* preheader() const { return m_preheader.get(); }
    header_t* header() const { return m_header.get(); }
    std::vector<std::unique_ptr<pattern_t>>* patterns() const { return m_patterns.get(); }
