...
const std::set<fasttracker_xm_module_t::instrument_t::extra_header_t::type_t> fasttracker_xm_module_t::instrument_t::extra_header_t::_values_type_t{
    fasttracker_xm_module_t::instrument_t::extra_header_t::TYPE_TRUE,
    fasttracker_xm_module_t::instrument_t::extra_header_t::TYPE_SUSTAIN,
    fasttracker_xm_module_t::instrument_t::extra_header_t::TYPE_LOOP,
};
...
const std::set<fasttracker_xm_module_t::instrument_t::sample_header_t::loop_type_t::loop_type_t> fasttracker_xm_module_t::instrument_t::sample_header_t::loop_type_t::_values_loop_type_t{
    fasttracker_xm_module_t::instrument_t::sample_header_t::loop_type_t::LOOP_TYPE_NONE,
    fasttracker_xm_module_t::instrument_t::sample_header_t::loop_type_t::LOOP_TYPE_FORWARD,
    fasttracker_xm_module_t::instrument_t::sample_header_t::loop_type_t::LOOP_TYPE_PING_PONG,
};
