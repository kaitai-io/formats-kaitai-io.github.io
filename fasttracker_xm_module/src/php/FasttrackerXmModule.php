...
class FasttrackerXmModule extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_header = new \FasttrackerXmModule\Header($io, $this, $this->_root);
        $this->_m_patterns = [];
...
class Header extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_main = new \FasttrackerXmModule\Pattern\Header\HeaderMain($io, $this, $this->_root);
    }
...
class Instrument extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $io = new \Kaitai\Struct\Stream($this->_m__raw_header);
        $this->_m_header = new \FasttrackerXmModule\Instrument\Header($io, $this, $this->_root);
        ...
        $n = $this->header()->numSamples();
        for ($i = 0; $i < $n; $i++) {
            $this->_m_samples[] = new \FasttrackerXmModule\Instrument\SamplesData($i, $this->_io, $this, $this->_root);
        }
    }
    protected $_m_headerSize;
    protected $_m_header;
...
class SamplesData extends \Kaitai\Struct\Struct {
    public function __construct(int $index, \Kaitai\Struct\Stream $_io, \FasttrackerXmModule\Instrument $_parent = null, \FasttrackerXmModule $_root = null) {
        parent::__construct($_io, $_parent, $_root);
        $this->_m_index = $index;
        $this->_read();
    }
