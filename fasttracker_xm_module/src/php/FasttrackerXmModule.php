...
namespace FasttrackerXmModule {
    class Flags extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            $this->_m_freqTableType = $this->_io->readBitsIntBe(1) != 0;
        }
...
namespace FasttrackerXmModule\Instrument\SampleHeader {
    class LoopType extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_reserved0 = $this->_io->readBitsIntBe(3);
            $this->_m_isSampleData16Bit = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_reserved1 = $this->_io->readBitsIntBe(2);
            $this->_m_loopType = $this->_io->readBitsIntBe(2);
        }
