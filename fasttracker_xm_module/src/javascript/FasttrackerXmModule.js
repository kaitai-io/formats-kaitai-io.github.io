...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.FasttrackerXmModule || (root.FasttrackerXmModule = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (FasttrackerXmModule_, KaitaiStream) {
/**
...
var FasttrackerXmModule = (function() {
  ...
  var Preheader = FasttrackerXmModule.Preheader = (function() {
    ...
    Preheader.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.signature0, new Uint8Array([69, 120, 116, 101, 110, 100, 101, 100, 32, 77, 111, 100, 117, 108, 101, 58, 32])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([69, 120, 116, 101, 110, 100, 101, 100, 32, 77, 111, 100, 117, 108, 101, 58, 32]), this.signature0, this._io, "/types/preheader/seq/0");
      }
      ...
      if (!((KaitaiStream.byteArrayCompare(this.signature1, new Uint8Array([26])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([26]), this.signature1, this._io, "/types/preheader/seq/2");
      }
...
FasttrackerXmModule_.FasttrackerXmModule = FasttrackerXmModule;
});
