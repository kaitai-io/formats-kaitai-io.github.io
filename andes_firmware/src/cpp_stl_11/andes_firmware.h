...
public:
    ...
    andes_firmware_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, andes_firmware_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        image_header_t(kaitai::kstream* p__io, andes_firmware_t* p__parent = nullptr, andes_firmware_t* p__root = nullptr);
...
private:
    std::unique_ptr<image_header_t> m_image_header;
    std::string m_ilm;
    std::string m_dlm;
    andes_firmware_t* m__root;
...
public:
    image_header_t* image_header() const { return m_image_header.get(); }
