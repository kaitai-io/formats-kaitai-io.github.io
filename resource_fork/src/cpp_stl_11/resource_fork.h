...
public:
    ...
    resource_fork_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, resource_fork_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        file_header_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, resource_fork_t* p__root = nullptr);
    ...
    public:
        ...
        data_block_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t::type_list_and_reference_lists_t::reference_list_t::reference_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
    ...
    public:
        ...
        resource_map_t(kaitai::kstream* p__io, resource_fork_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            file_attributes_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
        ...
        public:
             ...
             * \sa https://www.fenestrated.net/mirrors/Apple%20Technotes%20(As%20of%202002)/pr/pr_510.html Apple Technical Note PR510 - Printer Driver Q&As, section '"Printer driver is MultiFinder compatible" bit'
             */
        ...
        public:
            ...
            type_list_and_reference_lists_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
        ...
        public:
            ...
            public:
                ...
                type_list_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t::type_list_and_reference_lists_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    type_list_entry_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t::type_list_and_reference_lists_t::type_list_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
                ...
                private:
                    ...
                    std::unique_ptr<reference_list_t> m_reference_list;
            ...
            private:
                ...
                std::unique_ptr<std::vector<std::unique_ptr<type_list_entry_t>>> m_entries;
                resource_fork_t* m__root;
            ...
            public:
                 ...
                 */
                std::vector<std::unique_ptr<type_list_entry_t>>* entries() const { return m_entries.get(); }
                resource_fork_t* _root() const { return m__root; }
            ...
            public:
                ...
                reference_list_t(uint16_t p_num_references, kaitai::kstream* p__io, resource_fork_t::resource_map_t::type_list_and_reference_lists_t::type_list_t::type_list_entry_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    reference_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t::type_list_and_reference_lists_t::reference_list_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
                ...
                public:
                    ...
                    public:
                        ...
                        attributes_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t::type_list_and_reference_lists_t::reference_list_t::reference_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
                ...
                private:
                    bool f_data_block;
                    std::unique_ptr<data_block_t> m_data_block;
                ...
                private:
                    int16_t m_id;
                    uint16_t m_ofs_name;
                    std::unique_ptr<attributes_t> m_attributes;
                    ...
                    std::unique_ptr<kaitai::kstream> m__io__raw_attributes;
                ...
                public:
                     ...
                     */
                    attributes_t* attributes() const { return m_attributes.get(); }
                    ...
                    kaitai::kstream* _io__raw_attributes() const { return m__io__raw_attributes.get(); }
                };

            private:
                std::unique_ptr<std::vector<std::unique_ptr<reference_t>>> m_references;
            ...
            public:
                 ...
                 */
                std::vector<std::unique_ptr<reference_t>>* references() const { return m_references.get(); }
        ...
        private:
            std::unique_ptr<type_list_t> m_type_list;
        ...
        public:
             ...
             */
            type_list_t* type_list() const { return m_type_list.get(); }
        ...
        public:
            ...
            name_t(kaitai::kstream* p__io, resource_fork_t::resource_map_t::type_list_and_reference_lists_t::reference_list_t::reference_t* p__parent = nullptr, resource_fork_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<type_list_and_reference_lists_t> m_type_list_and_reference_lists;
    ...
    private:
        ...
        std::unique_ptr<bytes_with_io_t> m_names_with_io;
    ...
    private:
        std::unique_ptr<file_header_t> m_reserved_file_header_copy;
        uint32_t m_reserved_next_resource_map_handle;
        uint16_t m_reserved_file_reference_number;
        std::unique_ptr<file_attributes_t> m_file_attributes;
        uint16_t m_ofs_type_list;
        uint16_t m_ofs_names;
        resource_fork_t* m__root;
        resource_fork_t* m__parent;
        std::string m__raw_file_attributes;
        std::unique_ptr<kaitai::kstream> m__io__raw_file_attributes;
        std::string m__raw_type_list_and_reference_lists;
        std::unique_ptr<kaitai::kstream> m__io__raw_type_list_and_reference_lists;
        std::string m__raw_names_with_io;
        std::unique_ptr<kaitai::kstream> m__io__raw_names_with_io;
    ...
    public:
         ...
         */
        file_header_t* reserved_file_header_copy() const { return m_reserved_file_header_copy.get(); }
         ...
         */
        file_attributes_t* file_attributes() const { return m_file_attributes.get(); }
        ...
        kaitai::kstream* _io__raw_file_attributes() const { return m__io__raw_file_attributes.get(); }
        std::string _raw_type_list_and_reference_lists() const { return m__raw_type_list_and_reference_lists; }
        kaitai::kstream* _io__raw_type_list_and_reference_lists() const { return m__io__raw_type_list_and_reference_lists.get(); }
        std::string _raw_names_with_io() const { return m__raw_names_with_io; }
        kaitai::kstream* _io__raw_names_with_io() const { return m__io__raw_names_with_io.get(); }
    };

private:
    bool f_data_blocks_with_io;
    std::unique_ptr<bytes_with_io_t> m_data_blocks_with_io;
...
private:
    bool f_resource_map;
    std::unique_ptr<resource_map_t> m_resource_map;
...
private:
    ...
    std::unique_ptr<kaitai::kstream> m__io__raw_data_blocks_with_io;
    std::string m__raw_resource_map;
    std::unique_ptr<kaitai::kstream> m__io__raw_resource_map;
...
public:
    ...
    kaitai::kstream* _io__raw_data_blocks_with_io() const { return m__io__raw_data_blocks_with_io.get(); }
    std::string _raw_resource_map() const { return m__raw_resource_map; }
    kaitai::kstream* _io__raw_resource_map() const { return m__io__raw_resource_map.get(); }
};
