...
namespace Kaitai
{
    public partial class Swf : KaitaiStruct
    {
        ...
        public Swf(KaitaiStream io, KaitaiStruct parent = null, Swf root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class SwfBody : KaitaiStruct
        {
            ...
            public SwfBody(KaitaiStream io, Swf parent = null, Swf root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Rect : KaitaiStruct
        {
            ...
            public Rect(KaitaiStream io, Swf.SwfBody parent = null, Swf root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_numBits = false;
        ...
        public partial class Tag : KaitaiStruct
        {
            ...
            public Tag(KaitaiStream io, Swf.SwfBody parent = null, Swf root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class AbcTagBody : KaitaiStruct
        {
            ...
            public AbcTagBody(KaitaiStream io, Swf.Tag parent = null, Swf root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class RecordHeader : KaitaiStruct
        {
            ...
            public RecordHeader(KaitaiStream io, Swf.Tag parent = null, Swf root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_tagType = false;
