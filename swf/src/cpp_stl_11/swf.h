...
public:
    ...
    swf_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, swf_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        define_sound_body_t(kaitai::kstream* p__io, swf_t::tag_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    public:
        ...
        do_abc_body_t(kaitai::kstream* p__io, swf_t::tag_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    public:
        ...
        record_header_t(kaitai::kstream* p__io, swf_t::tag_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    public:
        ...
        rect_t(kaitai::kstream* p__io, swf_t::swf_body_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    public:
        ...
        rgb_t(kaitai::kstream* p__io, swf_t::tag_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    public:
        ...
        script_limits_body_t(kaitai::kstream* p__io, swf_t::tag_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    public:
        ...
        swf_body_t(kaitai::kstream* p__io, swf_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<rect_t> m_rect;
        uint16_t m_frame_rate;
        uint16_t m_frame_count;
        std::unique_ptr<tag_t> m_file_attributes_tag;
    ...
    public:
        rect_t* rect() const { return m_rect.get(); }
        uint16_t frame_rate() const { return m_frame_rate; }
        uint16_t frame_count() const { return m_frame_count; }
        tag_t* file_attributes_tag() const { return m_file_attributes_tag.get(); }
    ...
    public:
        ...
        symbol_class_body_t(kaitai::kstream* p__io, swf_t::tag_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            symbol_t(kaitai::kstream* p__io, swf_t::symbol_class_body_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<std::vector<std::unique_ptr<symbol_t>>> m_symbols;
        swf_t* m__root;
        swf_t::tag_t* m__parent;

    public:
        uint16_t num_symbols() const { return m_num_symbols; }
        std::vector<std::unique_ptr<symbol_t>>* symbols() const { return m_symbols.get(); }
        swf_t* _root() const { return m__root; }
        swf_t::tag_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        tag_t(kaitai::kstream* p__io, swf_t::swf_body_t* p__parent = nullptr, swf_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<record_header_t> m_record_header;
        std::unique_ptr<kaitai::kstruct> m_tag_body;
        bool n_tag_body;
    ...
    private:
        ...
        std::unique_ptr<kaitai::kstream> m__io__raw_tag_body;

    public:
        record_header_t* record_header() const { return m_record_header.get(); }
        kaitai::kstruct* tag_body() const { return m_tag_body.get(); }
        swf_t* _root() const { return m__root; }
        swf_t::swf_body_t* _parent() const { return m__parent; }
        std::string _raw_tag_body() const { return m__raw_tag_body; }
        kaitai::kstream* _io__raw_tag_body() const { return m__io__raw_tag_body.get(); }
    };
...
private:
    ...
    uint8_t m_version;
    uint32_t m_len_file;
    std::unique_ptr<swf_body_t> m_plain_body;
    bool n_plain_body;
...
private:
    std::unique_ptr<swf_body_t> m_zlib_body;
    bool n_zlib_body;
...
private:
    std::unique_ptr<kaitai::kstream> m__io__raw_plain_body;
...
private:
    std::unique_ptr<kaitai::kstream> m__io__raw_zlib_body;
...
public:
    ...
    swf_body_t* plain_body() const { return m_plain_body.get(); }
    swf_body_t* zlib_body() const { return m_zlib_body.get(); }
    swf_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
    std::string _raw_plain_body() const { return m__raw_plain_body; }
    kaitai::kstream* _io__raw_plain_body() const { return m__io__raw_plain_body.get(); }
    std::string _raw_zlib_body() const { return m__raw_zlib_body; }
    kaitai::kstream* _io__raw_zlib_body() const { return m__io__raw_zlib_body.get(); }
