...
const std::set<swf_t::compressions_t> swf_t::_values_compressions_t{
    swf_t::COMPRESSIONS_ZLIB,
    swf_t::COMPRESSIONS_NONE,
    swf_t::COMPRESSIONS_LZMA,
};
...
const std::set<swf_t::tag_type_t> swf_t::_values_tag_type_t{
    swf_t::TAG_TYPE_END_OF_FILE,
    swf_t::TAG_TYPE_PLACE_OBJECT,
    swf_t::TAG_TYPE_REMOVE_OBJECT,
    swf_t::TAG_TYPE_SET_BACKGROUND_COLOR,
    swf_t::TAG_TYPE_DEFINE_SOUND,
    swf_t::TAG_TYPE_PLACE_OBJECT2,
    swf_t::TAG_TYPE_REMOVE_OBJECT2,
    swf_t::TAG_TYPE_FRAME_LABEL,
    swf_t::TAG_TYPE_EXPORT_ASSETS,
    swf_t::TAG_TYPE_SCRIPT_LIMITS,
    swf_t::TAG_TYPE_FILE_ATTRIBUTES,
    swf_t::TAG_TYPE_PLACE_OBJECT3,
    swf_t::TAG_TYPE_SYMBOL_CLASS,
    swf_t::TAG_TYPE_METADATA,
    swf_t::TAG_TYPE_DEFINE_SCALING_GRID,
    swf_t::TAG_TYPE_DO_ABC,
    swf_t::TAG_TYPE_DEFINE_SCENE_AND_FRAME_LABEL_DATA,
};
...
const std::set<swf_t::define_sound_body_t::bps_t> swf_t::define_sound_body_t::_values_bps_t{
    swf_t::define_sound_body_t::BPS_SOUND_8_BIT,
    swf_t::define_sound_body_t::BPS_SOUND_16_BIT,
};
...
const std::set<swf_t::define_sound_body_t::channels_t> swf_t::define_sound_body_t::_values_channels_t{
    swf_t::define_sound_body_t::CHANNELS_MONO,
    swf_t::define_sound_body_t::CHANNELS_STEREO,
};
...
const std::set<swf_t::define_sound_body_t::sampling_rates_t> swf_t::define_sound_body_t::_values_sampling_rates_t{
    swf_t::define_sound_body_t::SAMPLING_RATES_RATE_5_5_KHZ,
    swf_t::define_sound_body_t::SAMPLING_RATES_RATE_11_KHZ,
    swf_t::define_sound_body_t::SAMPLING_RATES_RATE_22_KHZ,
    swf_t::define_sound_body_t::SAMPLING_RATES_RATE_44_KHZ,
};
