...
namespace {
    class Swf extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_signature == "\x57\x53")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x57\x53", $this->_m_signature, $this->_io, "/seq/1");
            }
...
namespace Swf {
    class Compressions {
        ...
        private const _VALUES = [67 => true, 70 => true, 90 => true];
...
namespace Swf {
    class TagType {
        ...
        private const _VALUES = [0 => true, 4 => true, 5 => true, 9 => true, 14 => true, 26 => true, 28 => true, 43 => true, 56 => true, 65 => true, 69 => true, 70 => true, 76 => true, 77 => true, 78 => true, 82 => true, 86 => true];
