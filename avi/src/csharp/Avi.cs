...
namespace Kaitai
{
    ...
    public partial class Avi : KaitaiStruct
    {
        ...
        public Avi(KaitaiStream io, KaitaiStruct parent = null, Avi root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class ListBody : KaitaiStruct
        {
            ...
            public ListBody(KaitaiStream io, Avi.Block parent = null, Avi root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Rect : KaitaiStruct
        {
            ...
            public Rect(KaitaiStream io, Avi.StrhBody parent = null, Avi root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Blocks : KaitaiStruct
        {
            ...
            public Blocks(KaitaiStream io, KaitaiStruct parent = null, Avi root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class AvihBody : KaitaiStruct
        {
            ...
            public AvihBody(KaitaiStream io, Avi.Block parent = null, Avi root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Block : KaitaiStruct
        {
            ...
            public Block(KaitaiStream io, Avi.Blocks parent = null, Avi root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class StrhBody : KaitaiStruct
        {
            ...
            public StrhBody(KaitaiStream io, Avi.Block parent = null, Avi root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class StrfBody : KaitaiStruct
        {
            ...
            public StrfBody(KaitaiStream io, KaitaiStruct parent = null, Avi root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
