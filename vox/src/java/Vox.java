 ...
 */
public class Vox extends KaitaiStruct {
    public static Vox fromFile(String fileName) throws IOException {
        return new Vox(new ByteBufferKaitaiStream(fileName));
    }
    ...
    public Vox(KaitaiStream _io) {
        this(_io, null, null);
    }

    public Vox(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public Vox(KaitaiStream _io, KaitaiStruct _parent, Vox _root) {
        super(_io);
    ...
    private void _read() {
        this.magic = this._io.ensureFixedContents(new byte[] { 86, 79, 88, 32 });
    ...
    public static class Chunk extends KaitaiStruct {
        ...
        public Chunk(KaitaiStream _io, KaitaiStruct _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            this.chunkId = Vox.ChunkType.byId(this._io.readU4be());
    ...
    public static class Size extends KaitaiStruct {
        ...
        public Size(KaitaiStream _io, Vox.Chunk _parent) {
            this(_io, _parent, null);
        }

        public Size(KaitaiStream _io, Vox.Chunk _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Rgba extends KaitaiStruct {
        ...
        public Rgba(KaitaiStream _io, Vox.Chunk _parent) {
            this(_io, _parent, null);
        }

        public Rgba(KaitaiStream _io, Vox.Chunk _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Pack extends KaitaiStruct {
        ...
        public Pack(KaitaiStream _io, Vox.Chunk _parent) {
            this(_io, _parent, null);
        }

        public Pack(KaitaiStream _io, Vox.Chunk _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Matt extends KaitaiStruct {
        ...
        public Matt(KaitaiStream _io, Vox.Chunk _parent) {
            this(_io, _parent, null);
        }

        public Matt(KaitaiStream _io, Vox.Chunk _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            ...
            this.materialType = Vox.MaterialType.byId(this._io.readU4le());
    ...
    public static class Xyzi extends KaitaiStruct {
        ...
        public Xyzi(KaitaiStream _io, Vox.Chunk _parent) {
            this(_io, _parent, null);
        }

        public Xyzi(KaitaiStream _io, Vox.Chunk _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Color extends KaitaiStruct {
        ...
        public Color(KaitaiStream _io, Vox.Rgba _parent) {
            this(_io, _parent, null);
        }

        public Color(KaitaiStream _io, Vox.Rgba _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private int a;
        private Vox _root;
        private Vox.Rgba _parent;
        public int r() { return r; }
        public int g() { return g; }
        public int b() { return b; }
        public int a() { return a; }
        public Vox _root() { return _root; }
        public Vox.Rgba _parent() { return _parent; }
    }
    public static class Voxel extends KaitaiStruct {
        ...
        public Voxel(KaitaiStream _io, Vox.Xyzi _parent) {
            this(_io, _parent, null);
        }

        public Voxel(KaitaiStream _io, Vox.Xyzi _parent, Vox _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private Vox _root;
        private Vox.Xyzi _parent;
        public int x() { return x; }
        public int y() { return y; }
        public int z() { return z; }
        public int colorIndex() { return colorIndex; }
        public Vox _root() { return _root; }
        public Vox.Xyzi _parent() { return _parent; }
    }
    private byte[] magic;
