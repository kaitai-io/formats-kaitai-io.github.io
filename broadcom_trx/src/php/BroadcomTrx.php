...
namespace {
    class BroadcomTrx extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\Kaitai\Struct\Struct $_parent = null, ?\BroadcomTrx $_root = null) {
        ...
        public function header() {
            ...
            $_pos = $this->_io->pos();
            $this->_io->seek(0);
            $this->_m_header = new \BroadcomTrx\Header($this->_io, $this, $this->_root);
            $this->_io->seek($_pos);
            return $this->_m_header;
        }
        protected $_m_tail;
        public function tail() {
            ...
            $this->_m_tail = new \BroadcomTrx\Tail($this->_io, $this, $this->_root);
            $this->_io->seek($_pos);
            return $this->_m_tail;
        }
    }
...
namespace BroadcomTrx {
    class Header extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\BroadcomTrx $_parent = null, ?\BroadcomTrx $_root = null) {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic == "\x48\x44\x52\x30")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x48\x44\x52\x30", $this->_m_magic, $this->_io, "/types/header/seq/0");
            }
            $this->_m_len = $this->_io->readU4le();
            $this->_m_crc32 = $this->_io->readU4le();
            $this->_m_version = $this->_io->readU2le();
            $this->_m_flags = new \BroadcomTrx\Header\Flags($this->_io, $this, $this->_root);
            $this->_m_partitions = [];
            $i = 0;
            do {
                $_ = new \BroadcomTrx\Header\Partition($i, $this->_io, $this, $this->_root);
...
namespace BroadcomTrx\Header {
    class Flags extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\BroadcomTrx\Header $_parent = null, ?\BroadcomTrx $_root = null) {
            parent::__construct($_io, $_parent, $_root);
            $this->_read();
        }
...
namespace BroadcomTrx\Header {
    class Partition extends \Kaitai\Struct\Struct {
        public function __construct(int $idx, \Kaitai\Struct\Stream $_io, ?\BroadcomTrx\Header $_parent = null, ?\BroadcomTrx $_root = null) {
            parent::__construct($_io, $_parent, $_root);
            $this->_m_idx = $idx;
            $this->_read();
        }
...
namespace BroadcomTrx {
    class Revision extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\BroadcomTrx\Tail\HwCompInfo $_parent = null, ?\BroadcomTrx $_root = null) {
            parent::__construct($_io, $_parent, $_root);
            $this->_read();
        }
...
namespace BroadcomTrx {
    class Tail extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_version = new \BroadcomTrx\Version($this->_io, $this, $this->_root);
            ...
            $n = 4;
            for ($i = 0; $i < $n; $i++) {
                $this->_m_compHw[] = new \BroadcomTrx\Tail\HwCompInfo($this->_io, $this, $this->_root);
            }
...
namespace BroadcomTrx\Tail {
    class HwCompInfo extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, ?\BroadcomTrx\Tail $_parent = null, ?\BroadcomTrx $_root = null) {
            parent::__construct($_io, $_parent, $_root);
            $this->_read();
        }

        private function _read() {
            $this->_m_min = new \BroadcomTrx\Revision($this->_io, $this, $this->_root);
            $this->_m_max = new \BroadcomTrx\Revision($this->_io, $this, $this->_root);
        }
        protected $_m_min;
        protected $_m_max;
