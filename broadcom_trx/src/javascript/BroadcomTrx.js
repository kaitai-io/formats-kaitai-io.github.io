...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.BroadcomTrx || (root.BroadcomTrx = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (BroadcomTrx_, KaitaiStream) {
/**
 ...
 * @see {@link https://github.com/openwrt/firmware-utils/blob/a2c80c5/src/trx.c|Source}
...
var BroadcomTrx = (function() {
  ...
  var Header = BroadcomTrx.Header = (function() {
    ...
    Header.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.magic, new Uint8Array([72, 68, 82, 48])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([72, 68, 82, 48]), this.magic, this._io, "/types/header/seq/0");
      }
...
BroadcomTrx_.BroadcomTrx = BroadcomTrx;
});
