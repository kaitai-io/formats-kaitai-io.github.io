...
namespace BlenderBlend {
    class Dna1Body extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->id() == "\x53\x44\x4E\x41")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x53\x44\x4E\x41", $this->id(), $this->_io(), "/types/dna1_body/seq/0");
            }
            $this->_m_nameMagic = $this->_io->readBytes(4);
            if (!($this->nameMagic() == "\x4E\x41\x4D\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x4E\x41\x4D\x45", $this->nameMagic(), $this->_io(), "/types/dna1_body/seq/1");
            }
            ...
            if (!($this->typeMagic() == "\x54\x59\x50\x45")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x54\x59\x50\x45", $this->typeMagic(), $this->_io(), "/types/dna1_body/seq/5");
            }
            ...
            if (!($this->tlenMagic() == "\x54\x4C\x45\x4E")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x54\x4C\x45\x4E", $this->tlenMagic(), $this->_io(), "/types/dna1_body/seq/9");
            }
            $this->_m_lengths = [];
            $n = $this->numTypes();
            for ($i = 0; $i < $n; $i++) {
            ...
            if (!($this->strcMagic() == "\x53\x54\x52\x43")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x53\x54\x52\x43", $this->strcMagic(), $this->_io(), "/types/dna1_body/seq/12");
            }
...
namespace BlenderBlend {
    class Header extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->magic() == "\x42\x4C\x45\x4E\x44\x45\x52")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x42\x4C\x45\x4E\x44\x45\x52", $this->magic(), $this->_io(), "/types/header/seq/0");
            }
