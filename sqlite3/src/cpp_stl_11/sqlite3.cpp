...
const std::set<sqlite3_t::encodings_t> sqlite3_t::_values_encodings_t{
    sqlite3_t::ENCODINGS_UTF_8,
    sqlite3_t::ENCODINGS_UTF_16LE,
    sqlite3_t::ENCODINGS_UTF_16BE,
};
...
const std::set<sqlite3_t::versions_t> sqlite3_t::_values_versions_t{
    sqlite3_t::VERSIONS_LEGACY,
    sqlite3_t::VERSIONS_WAL,
};
