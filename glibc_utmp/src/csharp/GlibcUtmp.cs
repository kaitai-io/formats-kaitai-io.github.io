...
namespace Kaitai
{
    public partial class GlibcUtmp : KaitaiStruct
    {
        ...
        public GlibcUtmp(KaitaiStream io, KaitaiStruct parent = null, GlibcUtmp root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class Record : KaitaiStruct
        {
            ...
            public Record(KaitaiStream io, GlibcUtmp parent = null, GlibcUtmp root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Timeval : KaitaiStruct
        {
            ...
            public Timeval(KaitaiStream io, GlibcUtmp.Record parent = null, GlibcUtmp root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
