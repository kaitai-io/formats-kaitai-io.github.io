...
The string must conform to the syntax for MemberName, defined above.
  ...
  let nameIdxExpr = VlqBase128Le.read(this.io, nil, nil)
...
proc read*(_: typedesc[Dex_ClassDataItem], io: KaitaiStream, root: KaitaiStruct, parent: Dex_ClassDefItem): Dex_ClassDataItem =
  ...
  let staticFieldsSizeExpr = VlqBase128Le.read(this.io, nil, nil)
  ...
  let instanceFieldsSizeExpr = VlqBase128Le.read(this.io, nil, nil)
  ...
  let directMethodsSizeExpr = VlqBase128Le.read(this.io, nil, nil)
  ...
  let virtualMethodsSizeExpr = VlqBase128Le.read(this.io, nil, nil)
...
This must be a class (not array or primitive) type.
  ...
  let typeIdxExpr = VlqBase128Le.read(this.io, nil, nil)
  ...
  let sizeExpr = VlqBase128Le.read(this.io, nil, nil)
  this.size = sizeExpr
...
The index of the first element in a list is represented directly.
  ...
  let fieldIdxDiffExpr = VlqBase128Le.read(this.io, nil, nil)
...
See "access_flags Definitions" for details.
  ...
  let accessFlagsExpr = VlqBase128Le.read(this.io, nil, nil)
  this.accessFlags = accessFlagsExpr
...
The index of the first element in a list is represented directly.
  ...
  let methodIdxDiffExpr = VlqBase128Le.read(this.io, nil, nil)
...
The format of the data is specified by "code_item" below.
  ...
  let codeOffExpr = VlqBase128Le.read(this.io, nil, nil)
...
proc read*(_: typedesc[Dex_StringIdItem_StringDataItem], io: KaitaiStream, root: KaitaiStruct, parent: Dex_StringIdItem): Dex_StringIdItem_StringDataItem =
  ...
  let utf16SizeExpr = VlqBase128Le.read(this.io, nil, nil)
