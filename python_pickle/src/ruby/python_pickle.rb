...
class PythonPickle < Kaitai::Struct::Struct
  ...
  class DecimalnlLong < Kaitai::Struct::Struct
    ...
    def _read
      @val = (@_io.read_bytes_term(10, false, true, true)).force_encoding("ASCII").encode('UTF-8')
      self
    end
    attr_reader :val
  end
  ...
  class Op < Kaitai::Struct::Struct
    ...
    def _read
      @code = Kaitai::Struct::Stream::resolve_enum(PythonPickle::OPCODE, @_io.read_u1)
      case code
  ...
  class Unicodestring1 < Kaitai::Struct::Struct
    ...
    def _read
      @len = @_io.read_u1
      @val = (@_io.read_bytes(len)).force_encoding("UTF-8")
      self
    end
    attr_reader :len
    attr_reader :val
