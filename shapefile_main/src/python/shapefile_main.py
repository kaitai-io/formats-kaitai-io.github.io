...
class ShapefileMain(KaitaiStruct):
    ...
    class FileHeader(KaitaiStruct):
        ...
        def _read(self):
            self.file_code = self._io.ensure_fixed_contents(struct.pack('4b', 0, 0, 39, 10))
            self.unused_field_1 = self._io.ensure_fixed_contents(struct.pack('4b', 0, 0, 0, 0))
            self.unused_field_2 = self._io.ensure_fixed_contents(struct.pack('4b', 0, 0, 0, 0))
            self.unused_field_3 = self._io.ensure_fixed_contents(struct.pack('4b', 0, 0, 0, 0))
            self.unused_field_4 = self._io.ensure_fixed_contents(struct.pack('4b', 0, 0, 0, 0))
            self.unused_field_5 = self._io.ensure_fixed_contents(struct.pack('4b', 0, 0, 0, 0))
            self.file_length = self._io.read_s4be()
            self.version = self._io.ensure_fixed_contents(struct.pack('4b', -24, 3, 0, 0))
