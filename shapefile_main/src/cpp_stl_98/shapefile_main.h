...
public:
    ...
    static bool _is_defined_part_type_t(part_type_t v);

private:
    static const std::set<part_type_t> _values_part_type_t;
    static std::set<part_type_t> _build_values_part_type_t();
...
private:
    ...
    static std::set<shape_type_t> _build_values_shape_type_t();
