#ifndef ANDROID_ASUS_BOOTLDR_H_
#define ANDROID_ASUS_BOOTLDR_H_
...
class android_asus_bootldr_t : public kaitai::kstruct {

public:
    class image_t;

    android_asus_bootldr_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, android_asus_bootldr_t* p__root = 0);
...
public:
    ~android_asus_bootldr_t();

    class image_t : public kaitai::kstruct {

    public:

        image_t(kaitai::kstream* p__io, android_asus_bootldr_t* p__parent = 0, android_asus_bootldr_t* p__root = 0);
    ...
    private:
        ...
        uint8_t m_reserved3;
        std::string m_body;
        android_asus_bootldr_t* m__root;
        android_asus_bootldr_t* m__parent;
    ...
    public:
        ...
        android_asus_bootldr_t* _root() const { return m__root; }
        android_asus_bootldr_t* _parent() const { return m__parent; }
    };
