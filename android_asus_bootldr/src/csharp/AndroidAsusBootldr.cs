...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class AndroidAsusBootldr : KaitaiStruct
    {
        public static AndroidAsusBootldr FromFile(string fileName)
        {
            return new AndroidAsusBootldr(new KaitaiStream(fileName));
        }

        public AndroidAsusBootldr(KaitaiStream p__io, KaitaiStruct p__parent = null, AndroidAsusBootldr p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Image : KaitaiStruct
        {
            ...
            public Image(KaitaiStream p__io, AndroidAsusBootldr p__parent = null, AndroidAsusBootldr p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                f_fileName = false;
            ...
            private byte[] _body;
            private AndroidAsusBootldr m_root;
            private AndroidAsusBootldr m_parent;
            ...
            public AndroidAsusBootldr M_Root { get { return m_root; } }
            public AndroidAsusBootldr M_Parent { get { return m_parent; } }
        }
        private byte[] _magic;
