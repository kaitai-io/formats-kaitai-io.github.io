...
namespace {
    class AndroidAsusBootldr extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, \Kaitai\Struct\Struct $_parent = null, \AndroidAsusBootldr $_root = null) {
        ...
        private function _read() {
            ...
            $n = 3;
            for ($i = 0; $i < $n; $i++) {
                $this->_m_images[] = new \AndroidAsusBootldr\Image($this->_io, $this, $this->_root);
            }
        }
        protected $_m_magic;
...
namespace AndroidAsusBootldr {
    class Image extends \Kaitai\Struct\Struct {
        public function __construct(\Kaitai\Struct\Stream $_io, \AndroidAsusBootldr $_parent = null, \AndroidAsusBootldr $_root = null) {
            parent::__construct($_io, $_parent, $_root);
            $this->_read();
        }
