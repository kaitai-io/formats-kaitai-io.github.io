...
public:
    ...
    cramfs_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, cramfs_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        super_block_struct_t(kaitai::kstream* p__io, cramfs_t* p__parent = nullptr, cramfs_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<info_t> m_fsid;
        std::string m_name;
        std::unique_ptr<inode_t> m_root;
        cramfs_t* m__root;
        cramfs_t* m__parent;
    ...
    public:
        ...
        info_t* fsid() const { return m_fsid.get(); }
        std::string name() const { return m_name; }
        inode_t* root() const { return m_root.get(); }
    ...
    public:
        ...
        chunked_data_inode_t(kaitai::kstream* p__io, cramfs_t::inode_t* p__parent = nullptr, cramfs_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<std::vector<uint32_t>> m_block_end_index;
        std::string m_raw_blocks;
        cramfs_t* m__root;
        cramfs_t::inode_t* m__parent;

    public:
        std::vector<uint32_t>* block_end_index() const { return m_block_end_index.get(); }
    ...
    public:
        ...
        inode_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, cramfs_t* p__root = nullptr);
    ...
    private:
        bool f_as_reg_file;
        std::unique_ptr<chunked_data_inode_t> m_as_reg_file;
    ...
    private:
        bool f_as_symlink;
        std::unique_ptr<chunked_data_inode_t> m_as_symlink;
    ...
    private:
        bool f_as_dir;
        std::unique_ptr<dir_inode_t> m_as_dir;
    ...
    private:
        ...
        std::unique_ptr<kaitai::kstream> m__io__raw_as_dir;
    ...
    public:
        ...
        kaitai::kstream* _io__raw_as_dir() const { return m__io__raw_as_dir.get(); }
    };
    ...
    public:
        ...
        dir_inode_t(kaitai::kstream* p__io, cramfs_t::inode_t* p__parent = nullptr, cramfs_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<std::vector<std::unique_ptr<inode_t>>> m_children;
        bool n_children;
    ...
    public:
        std::vector<std::unique_ptr<inode_t>>* children() const { return m_children.get(); }
        cramfs_t* _root() const { return m__root; }
        cramfs_t::inode_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        info_t(kaitai::kstream* p__io, cramfs_t::super_block_struct_t* p__parent = nullptr, cramfs_t* p__root = nullptr);
