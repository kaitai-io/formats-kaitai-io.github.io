...
std::set<cramfs_t::inode_t::file_type_t> cramfs_t::inode_t::_build_values_file_type_t() {
    std::set<cramfs_t::inode_t::file_type_t> _t;
    _t.insert(cramfs_t::inode_t::FILE_TYPE_FIFO);
    _t.insert(cramfs_t::inode_t::FILE_TYPE_CHRDEV);
    _t.insert(cramfs_t::inode_t::FILE_TYPE_DIR);
    _t.insert(cramfs_t::inode_t::FILE_TYPE_BLKDEV);
    _t.insert(cramfs_t::inode_t::FILE_TYPE_REG_FILE);
    _t.insert(cramfs_t::inode_t::FILE_TYPE_SYMLINK);
    _t.insert(cramfs_t::inode_t::FILE_TYPE_SOCKET);
    return _t;
}
const std::set<cramfs_t::inode_t::file_type_t> cramfs_t::inode_t::_values_file_type_t = cramfs_t::inode_t::_build_values_file_type_t();
