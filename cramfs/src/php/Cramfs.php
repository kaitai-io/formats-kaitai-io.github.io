...
namespace Cramfs {
    class SuperBlockStruct extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->magic() == "\x45\x3D\xCD\x28")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x45\x3D\xCD\x28", $this->magic(), $this->_io(), "/types/super_block_struct/seq/0");
            }
            ...
            if (!($this->signature() == "\x43\x6F\x6D\x70\x72\x65\x73\x73\x65\x64\x20\x52\x4F\x4D\x46\x53")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x43\x6F\x6D\x70\x72\x65\x73\x73\x65\x64\x20\x52\x4F\x4D\x46\x53", $this->signature(), $this->_io(), "/types/super_block_struct/seq/4");
            }
