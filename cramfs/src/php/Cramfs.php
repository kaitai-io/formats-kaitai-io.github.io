...
namespace Cramfs\Inode {
    class FileType {
        ...
        private const _VALUES = [1 => true, 2 => true, 4 => true, 6 => true, 8 => true, 10 => true, 12 => true];
...
namespace Cramfs {
    class SuperBlockStruct extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic == "\x45\x3D\xCD\x28")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x45\x3D\xCD\x28", $this->_m_magic, $this->_io, "/types/super_block_struct/seq/0");
            }
            ...
            if (!($this->_m_signature == "\x43\x6F\x6D\x70\x72\x65\x73\x73\x65\x64\x20\x52\x4F\x4D\x46\x53")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x43\x6F\x6D\x70\x72\x65\x73\x73\x65\x64\x20\x52\x4F\x4D\x46\x53", $this->_m_signature, $this->_io, "/types/super_block_struct/seq/4");
            }
