...
std::set<mozilla_mar_t::block_identifiers_t> mozilla_mar_t::_build_values_block_identifiers_t() {
    std::set<mozilla_mar_t::block_identifiers_t> _t;
    _t.insert(mozilla_mar_t::BLOCK_IDENTIFIERS_PRODUCT_INFORMATION);
    return _t;
}
const std::set<mozilla_mar_t::block_identifiers_t> mozilla_mar_t::_values_block_identifiers_t = mozilla_mar_t::_build_values_block_identifiers_t();
...
std::set<mozilla_mar_t::signature_algorithms_t> mozilla_mar_t::_build_values_signature_algorithms_t() {
    std::set<mozilla_mar_t::signature_algorithms_t> _t;
    _t.insert(mozilla_mar_t::SIGNATURE_ALGORITHMS_RSA_PKCS1_SHA1);
    _t.insert(mozilla_mar_t::SIGNATURE_ALGORITHMS_RSA_PKCS1_SHA384);
    return _t;
}
const std::set<mozilla_mar_t::signature_algorithms_t> mozilla_mar_t::_values_signature_algorithms_t = mozilla_mar_t::_build_values_signature_algorithms_t();
