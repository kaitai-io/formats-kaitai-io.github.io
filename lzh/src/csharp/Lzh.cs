...
namespace Kaitai
{
    ...
    public partial class Lzh : KaitaiStruct
    {
        ...
        public Lzh(KaitaiStream io, KaitaiStruct parent = null, Lzh root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class Record : KaitaiStruct
        {
            ...
            public Record(KaitaiStream io, Lzh parent = null, Lzh root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class FileRecord : KaitaiStruct
        {
            ...
            public FileRecord(KaitaiStream io, Lzh.Record parent = null, Lzh root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream io, Lzh.FileRecord parent = null, Lzh root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Header1 : KaitaiStruct
        {
            ...
            public Header1(KaitaiStream io, Lzh.Header parent = null, Lzh root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
