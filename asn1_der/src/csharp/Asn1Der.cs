...
namespace Kaitai
{
    public partial class Asn1Der : KaitaiStruct
    {
        ...
        public Asn1Der(KaitaiStream io, KaitaiStruct parent = null, Asn1Der root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class LenEncoded : KaitaiStruct
        {
            ...
            public LenEncoded(KaitaiStream io, Asn1Der parent = null, Asn1Der root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_result = false;
        ...
        public partial class BodySequence : KaitaiStruct
        {
            ...
            public BodySequence(KaitaiStream io, Asn1Der parent = null, Asn1Der root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class BodyUtf8string : KaitaiStruct
        {
            ...
            public BodyUtf8string(KaitaiStream io, Asn1Der parent = null, Asn1Der root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class BodyPrintableString : KaitaiStruct
        {
            ...
            public BodyPrintableString(KaitaiStream io, Asn1Der parent = null, Asn1Der root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
