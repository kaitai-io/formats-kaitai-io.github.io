...
public:
    ...
    public:
        ...
        no_next_header_t(kaitai::kstream* p__io, protocol_body_t* p__parent = nullptr, protocol_body_t* p__root = nullptr);
    ...
    public:
        ...
        option_hop_by_hop_t(kaitai::kstream* p__io, protocol_body_t* p__parent = nullptr, protocol_body_t* p__root = nullptr);
