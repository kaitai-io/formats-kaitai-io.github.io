    ...
    public partial class GltfBinary : KaitaiStruct
    {
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_magic, new byte[] { 103, 108, 84, 70 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 103, 108, 84, 70 }, _magic, m_io, "/types/header/seq/0");
                }
