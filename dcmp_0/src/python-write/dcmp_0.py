...
class Dcmp0(ReadWriteKaitaiStruct):
    ...
    def _write__seq(self, io=None):
        super(Dcmp0, self)._write__seq(io)
        for i in range(len(self.chunks)):
            pass
    ...
    class Chunk(ReadWriteKaitaiStruct):
        ...
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Dcmp0.Chunk, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _read(self):
            ...
            if _on == Dcmp0.Chunk.TagKind.backreference:
                pass
                ...
                self.body._read()
            elif _on == Dcmp0.Chunk.TagKind.extended:
                pass
        ...
        def _write__seq(self, io=None):
            super(Dcmp0.Chunk, self)._write__seq(io)
        ...
        class BackreferenceBody(ReadWriteKaitaiStruct):
            ...
            def __init__(self, tag, _io=None, _parent=None, _root=None):
                super(Dcmp0.Chunk.BackreferenceBody, self).__init__(_io)
                self._parent = _parent
                self._root = _root
                self.tag = tag
            ...
            def _write__seq(self, io=None):
                super(Dcmp0.Chunk.BackreferenceBody, self)._write__seq(io)
                if self.is_index_separate:
                    pass
                    _on = self.tag
                    if _on == 32:
                        ...
                        pass
                        self._io.write_u2be(self.index_separate_minus)
        ...
        class EndBody(ReadWriteKaitaiStruct):
            ...
            """
            def __init__(self, _io=None, _parent=None, _root=None):
                super(Dcmp0.Chunk.EndBody, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(Dcmp0.Chunk.EndBody, self)._write__seq(io)
        ...
        class ExtendedBody(ReadWriteKaitaiStruct):
            ...
            """
            def __init__(self, _io=None, _parent=None, _root=None):
                super(Dcmp0.Chunk.ExtendedBody, self).__init__(_io)
                self._parent = _parent
                self._root = _root
            ...
            def _write__seq(self, io=None):
                super(Dcmp0.Chunk.ExtendedBody, self)._write__seq(io)
                self._io.write_u1(self.tag)
                _on = self.tag
                if _on == 0:
                    pass
            ...
            class DeltaEncoding16BitBody(ReadWriteKaitaiStruct):
                ...
                """
                def __init__(self, _io=None, _parent=None, _root=None):
                    super(Dcmp0.Chunk.ExtendedBody.DeltaEncoding16BitBody, self).__init__(_io)
                    self._parent = _parent
                    self._root = _root
                ...
                def _fetch_instances(self):
                    pass
                    self.first_value_raw._fetch_instances()
                    self.num_deltas_raw._fetch_instances()
                ...
                def _write__seq(self, io=None):
                    super(Dcmp0.Chunk.ExtendedBody.DeltaEncoding16BitBody, self)._write__seq(io)
                    self.first_value_raw._write__seq(self._io)
                    self.num_deltas_raw._write__seq(self._io)
                    for i in range(len(self.deltas)):
                        pass
                        self._io.write_s1(self.deltas[i])



                def _check(self):
                    if len(self.deltas) != self.num_deltas:
                        raise kaitaistruct.ConsistencyError(u"deltas", self.num_deltas, len(self.deltas))
                    for i in range(len(self.deltas)):
                        pass
                ...
                def _invalidate_first_value(self):
                    del self._m_first_value
                @property
                def num_deltas(self):
                ...
                def _invalidate_num_deltas(self):
                    del self._m_num_deltas

            class DeltaEncoding32BitBody(ReadWriteKaitaiStruct):
                ...
                """
                def __init__(self, _io=None, _parent=None, _root=None):
                    super(Dcmp0.Chunk.ExtendedBody.DeltaEncoding32BitBody, self).__init__(_io)
                    self._parent = _parent
                    self._root = _root
                ...
                def _fetch_instances(self):
                    ...
                    self.first_value_raw._fetch_instances()
                    self.num_deltas_raw._fetch_instances()
                    for i in range(len(self.deltas_raw)):
                        pass
                        self.deltas_raw[i]._fetch_instances()



                def _write__seq(self, io=None):
                    super(Dcmp0.Chunk.ExtendedBody.DeltaEncoding32BitBody, self)._write__seq(io)
                    self.first_value_raw._write__seq(self._io)
                    self.num_deltas_raw._write__seq(self._io)
                    for i in range(len(self.deltas_raw)):
                        pass
                        self.deltas_raw[i]._write__seq(self._io)



                def _check(self):
                    if len(self.deltas_raw) != self.num_deltas:
                        raise kaitaistruct.ConsistencyError(u"deltas_raw", self.num_deltas, len(self.deltas_raw))
                    for i in range(len(self.deltas_raw)):
                        pass
            ...
            class JumpTableBody(ReadWriteKaitaiStruct):
                ...
                * For each address:
                ...
                """
                def __init__(self, _io=None, _parent=None, _root=None):
                    super(Dcmp0.Chunk.ExtendedBody.JumpTableBody, self).__init__(_io)
                    self._parent = _parent
                    self._root = _root
                ...
                def _fetch_instances(self):
                    pass
                    self.segment_number_raw._fetch_instances()
                    self.num_addresses_raw._fetch_instances()
                    for i in range(len(self.addresses_raw)):
                        pass
                        self.addresses_raw[i]._fetch_instances()



                def _write__seq(self, io=None):
                    super(Dcmp0.Chunk.ExtendedBody.JumpTableBody, self)._write__seq(io)
                    self.segment_number_raw._write__seq(self._io)
                    self.num_addresses_raw._write__seq(self._io)
                    for i in range(len(self.addresses_raw)):
                        pass
                        self.addresses_raw[i]._write__seq(self._io)



                def _check(self):
                    if len(self.addresses_raw) != self.num_addresses:
                        raise kaitaistruct.ConsistencyError(u"addresses_raw", self.num_addresses, len(self.addresses_raw))
                    for i in range(len(self.addresses_raw)):
                        pass
                ...
                def _invalidate_num_addresses(self):
                    del self._m_num_addresses
                @property
                ...
                def _invalidate_segment_number(self):
                    del self._m_segment_number
            ...
            class RepeatBody(ReadWriteKaitaiStruct):
                ...
                """
                def __init__(self, tag, _io=None, _parent=None, _root=None):
                    super(Dcmp0.Chunk.ExtendedBody.RepeatBody, self).__init__(_io)
                    self._parent = _parent
                    self._root = _root
                    self.tag = tag
                ...
                def _write__seq(self, io=None):
                    super(Dcmp0.Chunk.ExtendedBody.RepeatBody, self)._write__seq(io)
                ...
                def _invalidate_byte_count(self):
                    del self._m_byte_count
                @property
        ...
        class LiteralBody(ReadWriteKaitaiStruct):
            ...
            """
            def __init__(self, tag, _io=None, _parent=None, _root=None):
                super(Dcmp0.Chunk.LiteralBody, self).__init__(_io)
                self._parent = _parent
                self._root = _root
                self.tag = tag
            ...
            def _write__seq(self, io=None):
                super(Dcmp0.Chunk.LiteralBody, self)._write__seq(io)
                if self.is_len_literal_div2_separate:
                    pass
                    self._io.write_u1(self.len_literal_div2_separate)
            ...
            def _invalidate_is_len_literal_div2_separate(self):
                del self._m_is_len_literal_div2_separate
            @property
            ...
            def _invalidate_len_literal_div2(self):
                del self._m_len_literal_div2
            @property
            ...
            def _invalidate_len_literal_div2_in_tag(self):
                del self._m_len_literal_div2_in_tag
        ...
        class TableLookupBody(ReadWriteKaitaiStruct):
            ...
            """
            def __init__(self, tag, _io=None, _parent=None, _root=None):
                super(Dcmp0.Chunk.TableLookupBody, self).__init__(_io)
                self._parent = _parent
                self._root = _root
                self.tag = tag
            ...
            def _write__seq(self, io=None):
                super(Dcmp0.Chunk.TableLookupBody, self)._write__seq(io)
