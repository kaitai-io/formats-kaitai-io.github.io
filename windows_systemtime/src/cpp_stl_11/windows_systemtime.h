 ...
 * \sa https://docs.microsoft.com/en-us/windows/win32/api/minwinbase/ns-minwinbase-systemtime Source
 */
...
public:
    ...
    windows_systemtime_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, windows_systemtime_t* p__root = nullptr);
