...
public class Dtb extends KaitaiStruct {
    ...
    public MemoryBlock memoryReservationBlock() {
        ...
        KaitaiStream _io_memoryReservationBlock = this._io.substream(ofsStructureBlock() - ofsMemoryReservationBlock());
        this.memoryReservationBlock = new MemoryBlock(_io_memoryReservationBlock, this, _root);
        this._io.seek(_pos);
        return this.memoryReservationBlock;
    }
    ...
    public Strings stringsBlock() {
        ...
        KaitaiStream _io_stringsBlock = this._io.substream(lenStringsBlock());
        this.stringsBlock = new Strings(_io_stringsBlock, this, _root);
        this._io.seek(_pos);
        return this.stringsBlock;
    }
    ...
    public FdtBlock structureBlock() {
        ...
        KaitaiStream _io_structureBlock = this._io.substream(lenStructureBlock());
        this.structureBlock = new FdtBlock(_io_structureBlock, this, _root);
        this._io.seek(_pos);
        return this.structureBlock;
    }
    private byte[] magic;
