...
class PhpSerializedValue < Kaitai::Struct::Struct
  ...
  class CountPrefixedMapping < Kaitai::Struct::Struct
    ...
    def _read
      ...
      @opening_brace = @_io.ensure_fixed_contents([123].pack('C*'))
      @entries = Array.new(num_entries)
      (num_entries).times { |i|
        @entries[i] = MappingEntry.new(@_io, self, @_root)
      }
      @closing_brace = @_io.ensure_fixed_contents([125].pack('C*'))
      self
    end
  ...
  class FloatContents < Kaitai::Struct::Struct
    ...
    def _read
      @colon = @_io.ensure_fixed_contents([58].pack('C*'))
      @value_dec = (@_io.read_bytes_term(59, false, true, true)).force_encoding("ASCII")
      self
    end
    attr_reader :colon
  ...
  class LengthPrefixedQuotedString < Kaitai::Struct::Struct
    ...
    def _read
      @len_data_dec = (@_io.read_bytes_term(58, false, true, true)).force_encoding("ASCII")
      @opening_quote = @_io.ensure_fixed_contents([34].pack('C*'))
      @data = @_io.read_bytes(len_data)
      @closing_quote = @_io.ensure_fixed_contents([34].pack('C*'))
      self
    end
  ...
  class ObjectContents < Kaitai::Struct::Struct
    ...
    def _read
      @colon1 = @_io.ensure_fixed_contents([58].pack('C*'))
      @class_name = LengthPrefixedQuotedString.new(@_io, self, @_root)
      @colon2 = @_io.ensure_fixed_contents([58].pack('C*'))
  ...
  class CustomSerializedObjectContents < Kaitai::Struct::Struct
    ...
    def _read
      ...
      @opening_brace = @_io.ensure_fixed_contents([123].pack('C*'))
      @data = @_io.read_bytes(len_data)
      @closing_quote = @_io.ensure_fixed_contents([125].pack('C*'))
      self
    end
  ...
  class NullContents < Kaitai::Struct::Struct
    ...
    def _read
      @semicolon = @_io.ensure_fixed_contents([59].pack('C*'))
      self
    end
  ...
  class MappingEntry < Kaitai::Struct::Struct
    ...
    def _read
      @key = PhpSerializedValue.new(@_io)
      @value = PhpSerializedValue.new(@_io)
      self
    end
