...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.PhpSerializedValue || (root.PhpSerializedValue = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (PhpSerializedValue_, KaitaiStream) {
/**
...
var PhpSerializedValue = (function() {
  ...
  var ArrayContents = PhpSerializedValue.ArrayContents = (function() {
    ...
    ArrayContents.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.colon, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon, this._io, "/types/array_contents/seq/0");
      }
  ...
  var BoolContents = PhpSerializedValue.BoolContents = (function() {
    ...
    BoolContents.prototype._read = function() {
      this.colon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon, this._io, "/types/bool_contents/seq/0");
      }
      this.valueDec = this._io.readU1();
      this.semicolon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.semicolon, new Uint8Array([59])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([59]), this.semicolon, this._io, "/types/bool_contents/seq/2");
      }
    }
  ...
  var CountPrefixedMapping = PhpSerializedValue.CountPrefixedMapping = (function() {
    ...
    CountPrefixedMapping.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.openingBrace, new Uint8Array([123])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([123]), this.openingBrace, this._io, "/types/count_prefixed_mapping/seq/1");
      }
      this.entries = [];
      ...
      if (!((KaitaiStream.byteArrayCompare(this.closingBrace, new Uint8Array([125])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([125]), this.closingBrace, this._io, "/types/count_prefixed_mapping/seq/3");
      }
    }
  ...
  var CustomSerializedObjectContents = PhpSerializedValue.CustomSerializedObjectContents = (function() {
    ...
    CustomSerializedObjectContents.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.colon1, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon1, this._io, "/types/custom_serialized_object_contents/seq/0");
      }
      this.className = new LengthPrefixedQuotedString(this._io, this, this._root);
      this.colon2 = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon2, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon2, this._io, "/types/custom_serialized_object_contents/seq/2");
      }
      this.lenDataDec = KaitaiStream.bytesToStr(this._io.readBytesTerm(58, false, true, true), "ASCII");
      this.openingBrace = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.openingBrace, new Uint8Array([123])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([123]), this.openingBrace, this._io, "/types/custom_serialized_object_contents/seq/4");
      }
      this.data = this._io.readBytes(this.lenData);
      this.closingQuote = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.closingQuote, new Uint8Array([125])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([125]), this.closingQuote, this._io, "/types/custom_serialized_object_contents/seq/6");
      }
    }
  ...
  var FloatContents = PhpSerializedValue.FloatContents = (function() {
    ...
    FloatContents.prototype._read = function() {
      this.colon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon, this._io, "/types/float_contents/seq/0");
      }
  ...
  var IntContents = PhpSerializedValue.IntContents = (function() {
    ...
    IntContents.prototype._read = function() {
      this.colon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon, this._io, "/types/int_contents/seq/0");
      }
      this.valueDec = KaitaiStream.bytesToStr(this._io.readBytesTerm(59, false, true, true), "ASCII");
    }
  ...
  var LengthPrefixedQuotedString = PhpSerializedValue.LengthPrefixedQuotedString = (function() {
    ...
    LengthPrefixedQuotedString.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.openingQuote, new Uint8Array([34])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([34]), this.openingQuote, this._io, "/types/length_prefixed_quoted_string/seq/1");
      }
      this.data = this._io.readBytes(this.lenData);
      this.closingQuote = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.closingQuote, new Uint8Array([34])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([34]), this.closingQuote, this._io, "/types/length_prefixed_quoted_string/seq/3");
      }
    }
  ...
  var MappingEntry = PhpSerializedValue.MappingEntry = (function() {
    ...
    MappingEntry.prototype._read = function() {
      this.key = new PhpSerializedValue(this._io, this, this._root);
      this.value = new PhpSerializedValue(this._io, this, this._root);
    }
  ...
  var NullContents = PhpSerializedValue.NullContents = (function() {
    ...
    NullContents.prototype._read = function() {
      this.semicolon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.semicolon, new Uint8Array([59])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([59]), this.semicolon, this._io, "/types/null_contents/seq/0");
      }
    }
  ...
  var ObjectContents = PhpSerializedValue.ObjectContents = (function() {
    ...
    ObjectContents.prototype._read = function() {
      this.colon1 = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon1, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon1, this._io, "/types/object_contents/seq/0");
      }
      this.className = new LengthPrefixedQuotedString(this._io, this, this._root);
      this.colon2 = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon2, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon2, this._io, "/types/object_contents/seq/2");
      }
  ...
  var Php3ObjectContents = PhpSerializedValue.Php3ObjectContents = (function() {
    ...
    Php3ObjectContents.prototype._read = function() {
      this.colon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon, this._io, "/types/php_3_object_contents/seq/0");
      }
      this.properties = new CountPrefixedMapping(this._io, this, this._root);
    }
  ...
  var StringContents = PhpSerializedValue.StringContents = (function() {
    ...
    StringContents.prototype._read = function() {
      this.colon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.colon, new Uint8Array([58])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([58]), this.colon, this._io, "/types/string_contents/seq/0");
      }
      this.string = new LengthPrefixedQuotedString(this._io, this, this._root);
      this.semicolon = this._io.readBytes(1);
      if (!((KaitaiStream.byteArrayCompare(this.semicolon, new Uint8Array([59])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([59]), this.semicolon, this._io, "/types/string_contents/seq/2");
      }
    }
...
PhpSerializedValue_.PhpSerializedValue = PhpSerializedValue;
});
