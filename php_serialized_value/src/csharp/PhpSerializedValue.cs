    ...
    public partial class PhpSerializedValue : KaitaiStruct
    {
        ...
        public partial class CountPrefixedMapping : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                _openingBrace = m_io.EnsureFixedContents(new byte[] { 123 });
                _entries = new List<MappingEntry>((int) (NumEntries));
                for (var i = 0; i < NumEntries; i++)
                {
                    _entries.Add(new MappingEntry(m_io, this, m_root));
                }
                _closingBrace = m_io.EnsureFixedContents(new byte[] { 125 });
            }
        ...
        public partial class FloatContents : KaitaiStruct
        {
            ...
            private void _read()
            {
                _colon = m_io.EnsureFixedContents(new byte[] { 58 });
        ...
        public partial class LengthPrefixedQuotedString : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                _openingQuote = m_io.EnsureFixedContents(new byte[] { 34 });
                _data = m_io.ReadBytes(LenData);
                _closingQuote = m_io.EnsureFixedContents(new byte[] { 34 });
            }
        ...
        public partial class ObjectContents : KaitaiStruct
        {
            ...
            private void _read()
            {
                _colon1 = m_io.EnsureFixedContents(new byte[] { 58 });
                _className = new LengthPrefixedQuotedString(m_io, this, m_root);
                _colon2 = m_io.EnsureFixedContents(new byte[] { 58 });
        ...
        public partial class CustomSerializedObjectContents : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                _openingBrace = m_io.EnsureFixedContents(new byte[] { 123 });
                _data = m_io.ReadBytes(LenData);
                _closingQuote = m_io.EnsureFixedContents(new byte[] { 125 });
            }
            private bool f_lenData;
            private int _lenData;
        ...
        public partial class NullContents : KaitaiStruct
        {
            ...
            private void _read()
            {
                _semicolon = m_io.EnsureFixedContents(new byte[] { 59 });
            }
