    ...
    public partial class PhpSerializedValue : KaitaiStruct
    {
        ...
        public partial class CountPrefixedMapping : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(ClosingBrace, new byte[] { 125 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 125 }, ClosingBrace, M_Io, "/types/count_prefixed_mapping/seq/3");
                }
            }
        ...
        public partial class FloatContents : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                {
                    throw new ValidationNotEqualError(new byte[] { 58 }, Colon, M_Io, "/types/float_contents/seq/0");
                }
        ...
        public partial class LengthPrefixedQuotedString : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(OpeningQuote, new byte[] { 34 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 34 }, OpeningQuote, M_Io, "/types/length_prefixed_quoted_string/seq/1");
                }
                _data = m_io.ReadBytes(LenData);
                _closingQuote = m_io.ReadBytes(1);
                if (!((KaitaiStream.ByteArrayCompare(ClosingQuote, new byte[] { 34 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 34 }, ClosingQuote, M_Io, "/types/length_prefixed_quoted_string/seq/3");
                }
            }
        ...
        public partial class ArrayContents : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(Colon, new byte[] { 58 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 58 }, Colon, M_Io, "/types/array_contents/seq/0");
                }
        ...
        public partial class BoolContents : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(Colon, new byte[] { 58 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 58 }, Colon, M_Io, "/types/bool_contents/seq/0");
                }
                _valueDec = ((PhpSerializedValue.BoolValue) m_io.ReadU1());
                _semicolon = m_io.ReadBytes(1);
                if (!((KaitaiStream.ByteArrayCompare(Semicolon, new byte[] { 59 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 59 }, Semicolon, M_Io, "/types/bool_contents/seq/2");
                }
            }
