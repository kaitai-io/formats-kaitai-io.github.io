...
namespace PhpSerializedValue {
    class ArrayContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_colon == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon, $this->_io, "/types/array_contents/seq/0");
            }
...
namespace PhpSerializedValue {
    class BoolContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_colon = $this->_io->readBytes(1);
            if (!($this->_m_colon == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon, $this->_io, "/types/bool_contents/seq/0");
            }
            $this->_m_valueDec = $this->_io->readU1();
            $this->_m_semicolon = $this->_io->readBytes(1);
            if (!($this->_m_semicolon == "\x3B")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3B", $this->_m_semicolon, $this->_io, "/types/bool_contents/seq/2");
            }
        }
        protected $_m_value;
...
namespace PhpSerializedValue {
    class CountPrefixedMapping extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_openingBrace == "\x7B")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x7B", $this->_m_openingBrace, $this->_io, "/types/count_prefixed_mapping/seq/1");
            }
            $this->_m_entries = [];
            $n = $this->numEntries();
            for ($i = 0; $i < $n; $i++) {
            ...
            if (!($this->_m_closingBrace == "\x7D")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x7D", $this->_m_closingBrace, $this->_io, "/types/count_prefixed_mapping/seq/3");
            }
        }
...
namespace PhpSerializedValue {
    class CustomSerializedObjectContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_colon1 == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon1, $this->_io, "/types/custom_serialized_object_contents/seq/0");
            }
            ...
            if (!($this->_m_colon2 == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon2, $this->_io, "/types/custom_serialized_object_contents/seq/2");
            }
            $this->_m_lenDataDec = \Kaitai\Struct\Stream::bytesToStr($this->_io->readBytesTerm(58, false, true, true), "ASCII");
            $this->_m_openingBrace = $this->_io->readBytes(1);
            if (!($this->_m_openingBrace == "\x7B")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x7B", $this->_m_openingBrace, $this->_io, "/types/custom_serialized_object_contents/seq/4");
            }
            $this->_m_data = $this->_io->readBytes($this->lenData());
            $this->_m_closingQuote = $this->_io->readBytes(1);
            if (!($this->_m_closingQuote == "\x7D")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x7D", $this->_m_closingQuote, $this->_io, "/types/custom_serialized_object_contents/seq/6");
            }
        }
...
namespace PhpSerializedValue {
    class FloatContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_colon = $this->_io->readBytes(1);
            if (!($this->_m_colon == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon, $this->_io, "/types/float_contents/seq/0");
            }
...
namespace PhpSerializedValue {
    class IntContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_colon = $this->_io->readBytes(1);
            if (!($this->_m_colon == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon, $this->_io, "/types/int_contents/seq/0");
            }
            $this->_m_valueDec = \Kaitai\Struct\Stream::bytesToStr($this->_io->readBytesTerm(59, false, true, true), "ASCII");
        }
        protected $_m_value;
...
namespace PhpSerializedValue {
    class LengthPrefixedQuotedString extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_openingQuote == "\x22")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x22", $this->_m_openingQuote, $this->_io, "/types/length_prefixed_quoted_string/seq/1");
            }
            $this->_m_data = $this->_io->readBytes($this->lenData());
            $this->_m_closingQuote = $this->_io->readBytes(1);
            if (!($this->_m_closingQuote == "\x22")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x22", $this->_m_closingQuote, $this->_io, "/types/length_prefixed_quoted_string/seq/3");
            }
        }
        protected $_m_lenData;
...
namespace PhpSerializedValue {
    class MappingEntry extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_key = new \PhpSerializedValue($this->_io, $this, $this->_root);
            $this->_m_value = new \PhpSerializedValue($this->_io, $this, $this->_root);
        }
        protected $_m_key;
        protected $_m_value;
...
namespace PhpSerializedValue {
    class NullContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_semicolon = $this->_io->readBytes(1);
            if (!($this->_m_semicolon == "\x3B")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3B", $this->_m_semicolon, $this->_io, "/types/null_contents/seq/0");
            }
        }
        protected $_m_semicolon;
        public function semicolon() { return $this->_m_semicolon; }
...
namespace PhpSerializedValue {
    class ObjectContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_colon1 = $this->_io->readBytes(1);
            if (!($this->_m_colon1 == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon1, $this->_io, "/types/object_contents/seq/0");
            }
            $this->_m_className = new \PhpSerializedValue\LengthPrefixedQuotedString($this->_io, $this, $this->_root);
            $this->_m_colon2 = $this->_io->readBytes(1);
            if (!($this->_m_colon2 == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon2, $this->_io, "/types/object_contents/seq/2");
            }
...
namespace PhpSerializedValue {
    class Php3ObjectContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_colon = $this->_io->readBytes(1);
            if (!($this->_m_colon == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon, $this->_io, "/types/php_3_object_contents/seq/0");
            }
            $this->_m_properties = new \PhpSerializedValue\CountPrefixedMapping($this->_io, $this, $this->_root);
        }
        protected $_m_colon;
...
namespace PhpSerializedValue {
    class StringContents extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_colon = $this->_io->readBytes(1);
            if (!($this->_m_colon == "\x3A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3A", $this->_m_colon, $this->_io, "/types/string_contents/seq/0");
            }
            $this->_m_string = new \PhpSerializedValue\LengthPrefixedQuotedString($this->_io, $this, $this->_root);
            $this->_m_semicolon = $this->_io->readBytes(1);
            if (!($this->_m_semicolon == "\x3B")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x3B", $this->_m_semicolon, $this->_io, "/types/string_contents/seq/2");
            }
        }
        protected $_m_value;
...
namespace PhpSerializedValue {
    class BoolValue {
        ...
        private const _VALUES = [48 => true, 49 => true];
...
namespace PhpSerializedValue {
    class ValueType {
        ...
        private const _VALUES = [67 => true, 78 => true, 79 => true, 82 => true, 83 => true, 97 => true, 98 => true, 100 => true, 105 => true, 111 => true, 114 => true, 115 => true];
