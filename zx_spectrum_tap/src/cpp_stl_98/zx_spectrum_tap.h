...
public:
    ...
    static bool _is_defined_flag_enum_t(flag_enum_t v);

private:
    static const std::set<flag_enum_t> _values_flag_enum_t;
    static std::set<flag_enum_t> _build_values_flag_enum_t();
...
public:
    ...
    static bool _is_defined_header_type_enum_t(header_type_enum_t v);

private:
    static const std::set<header_type_enum_t> _values_header_type_enum_t;
    static std::set<header_type_enum_t> _build_values_header_type_enum_t();
