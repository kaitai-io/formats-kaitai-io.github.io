...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.ZxSpectrumTap || (root.ZxSpectrumTap = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (ZxSpectrumTap_, KaitaiStream) {
/**
...
var ZxSpectrumTap = (function() {
  ...
  var ArrayParams = ZxSpectrumTap.ArrayParams = (function() {
    ...
    ArrayParams.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.reserved1, new Uint8Array([0, 128])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([0, 128]), this.reserved1, this._io, "/types/array_params/seq/2");
      }
    }
...
ZxSpectrumTap_.ZxSpectrumTap = ZxSpectrumTap;
});
