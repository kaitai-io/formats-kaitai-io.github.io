...
const std::set<mac_os_resource_snd_t::cmd_type_t> mac_os_resource_snd_t::_values_cmd_type_t{
    mac_os_resource_snd_t::CMD_TYPE_NULL_CMD,
    mac_os_resource_snd_t::CMD_TYPE_QUIET_CMD,
    mac_os_resource_snd_t::CMD_TYPE_FLUSH_CMD,
    mac_os_resource_snd_t::CMD_TYPE_RE_INIT_CMD,
    mac_os_resource_snd_t::CMD_TYPE_WAIT_CMD,
    mac_os_resource_snd_t::CMD_TYPE_PAUSE_CMD,
    mac_os_resource_snd_t::CMD_TYPE_RESUME_CMD,
    mac_os_resource_snd_t::CMD_TYPE_CALL_BACK_CMD,
    mac_os_resource_snd_t::CMD_TYPE_SYNC_CMD,
    mac_os_resource_snd_t::CMD_TYPE_EMPTY_CMD,
    mac_os_resource_snd_t::CMD_TYPE_AVAILABLE_CMD,
    mac_os_resource_snd_t::CMD_TYPE_VERSION_CMD,
    mac_os_resource_snd_t::CMD_TYPE_TOTAL_LOAD_CMD,
    mac_os_resource_snd_t::CMD_TYPE_LOAD_CMD,
    mac_os_resource_snd_t::CMD_TYPE_FREQ_DURATION_CMD,
    mac_os_resource_snd_t::CMD_TYPE_REST_CMD,
    mac_os_resource_snd_t::CMD_TYPE_FREQ_CMD,
    mac_os_resource_snd_t::CMD_TYPE_AMP_CMD,
    mac_os_resource_snd_t::CMD_TYPE_TIMBRE_CMD,
    mac_os_resource_snd_t::CMD_TYPE_GET_AMP_CMD,
    mac_os_resource_snd_t::CMD_TYPE_VOLUME_CMD,
    mac_os_resource_snd_t::CMD_TYPE_GET_VOLUME_CMD,
    mac_os_resource_snd_t::CMD_TYPE_WAVE_TABLE_CMD,
    mac_os_resource_snd_t::CMD_TYPE_PHASE_CMD,
    mac_os_resource_snd_t::CMD_TYPE_SOUND_CMD,
    mac_os_resource_snd_t::CMD_TYPE_BUFFER_CMD,
    mac_os_resource_snd_t::CMD_TYPE_RATE_CMD,
    mac_os_resource_snd_t::CMD_TYPE_GET_RATE_CMD,
};
bool mac_os_resource_snd_t::_is_defined_cmd_type_t(mac_os_resource_snd_t::cmd_type_t v) {
    return mac_os_resource_snd_t::_values_cmd_type_t.find(v) != mac_os_resource_snd_t::_values_cmd_type_t.end();
}
const std::set<mac_os_resource_snd_t::compression_type_enum_t> mac_os_resource_snd_t::_values_compression_type_enum_t{
    mac_os_resource_snd_t::COMPRESSION_TYPE_ENUM_VARIABLE_COMPRESSION,
    mac_os_resource_snd_t::COMPRESSION_TYPE_ENUM_FIXED_COMPRESSION,
    mac_os_resource_snd_t::COMPRESSION_TYPE_ENUM_NOT_COMPRESSED,
    mac_os_resource_snd_t::COMPRESSION_TYPE_ENUM_TWO_TO_ONE,
    mac_os_resource_snd_t::COMPRESSION_TYPE_ENUM_EIGHT_TO_THREE,
    mac_os_resource_snd_t::COMPRESSION_TYPE_ENUM_THREE_TO_ONE,
    mac_os_resource_snd_t::COMPRESSION_TYPE_ENUM_SIX_TO_ONE,
};
bool mac_os_resource_snd_t::_is_defined_compression_type_enum_t(mac_os_resource_snd_t::compression_type_enum_t v) {
    return mac_os_resource_snd_t::_values_compression_type_enum_t.find(v) != mac_os_resource_snd_t::_values_compression_type_enum_t.end();
}
const std::set<mac_os_resource_snd_t::data_type_t> mac_os_resource_snd_t::_values_data_type_t{
    mac_os_resource_snd_t::DATA_TYPE_SQUARE_WAVE_SYNTH,
    mac_os_resource_snd_t::DATA_TYPE_WAVE_TABLE_SYNTH,
    mac_os_resource_snd_t::DATA_TYPE_SAMPLED_SYNTH,
};
bool mac_os_resource_snd_t::_is_defined_data_type_t(mac_os_resource_snd_t::data_type_t v) {
    return mac_os_resource_snd_t::_values_data_type_t.find(v) != mac_os_resource_snd_t::_values_data_type_t.end();
}
const std::set<mac_os_resource_snd_t::init_option_t> mac_os_resource_snd_t::_values_init_option_t{
    mac_os_resource_snd_t::INIT_OPTION_CHAN_LEFT,
    mac_os_resource_snd_t::INIT_OPTION_CHAN_RIGHT,
    mac_os_resource_snd_t::INIT_OPTION_NO_INTERP,
    mac_os_resource_snd_t::INIT_OPTION_NO_DROP,
    mac_os_resource_snd_t::INIT_OPTION_MONO,
    mac_os_resource_snd_t::INIT_OPTION_STEREO,
    mac_os_resource_snd_t::INIT_OPTION_MACE3,
    mac_os_resource_snd_t::INIT_OPTION_MACE6,
};
bool mac_os_resource_snd_t::_is_defined_init_option_t(mac_os_resource_snd_t::init_option_t v) {
    return mac_os_resource_snd_t::_values_init_option_t.find(v) != mac_os_resource_snd_t::_values_init_option_t.end();
}
const std::set<mac_os_resource_snd_t::sound_header_type_t> mac_os_resource_snd_t::_values_sound_header_type_t{
    mac_os_resource_snd_t::SOUND_HEADER_TYPE_STANDARD,
    mac_os_resource_snd_t::SOUND_HEADER_TYPE_COMPRESSED,
    mac_os_resource_snd_t::SOUND_HEADER_TYPE_EXTENDED,
};
bool mac_os_resource_snd_t::_is_defined_sound_header_type_t(mac_os_resource_snd_t::sound_header_type_t v) {
    return mac_os_resource_snd_t::_values_sound_header_type_t.find(v) != mac_os_resource_snd_t::_values_sound_header_type_t.end();
}
const std::set<mac_os_resource_snd_t::wave_init_option_t> mac_os_resource_snd_t::_values_wave_init_option_t{
    mac_os_resource_snd_t::WAVE_INIT_OPTION_CHANNEL0,
    mac_os_resource_snd_t::WAVE_INIT_OPTION_CHANNEL1,
    mac_os_resource_snd_t::WAVE_INIT_OPTION_CHANNEL2,
    mac_os_resource_snd_t::WAVE_INIT_OPTION_CHANNEL3,
};
bool mac_os_resource_snd_t::_is_defined_wave_init_option_t(mac_os_resource_snd_t::wave_init_option_t v) {
    return mac_os_resource_snd_t::_values_wave_init_option_t.find(v) != mac_os_resource_snd_t::_values_wave_init_option_t.end();
}
...
void mac_os_resource_snd_t::compressed_t::_read() {
    m_format = kaitai::kstream::bytes_to_str(m__io->read_bytes(4), "ASCII");
