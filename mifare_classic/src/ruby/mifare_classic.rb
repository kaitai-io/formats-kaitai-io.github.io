...
class MifareClassic < Kaitai::Struct::Struct
  ...
  def _read
    ...
    i = 0
    while not @_io.eof?
      _io_sectors = @_io.substream(((i >= 32 ? 4 : 1) * 4) * 16)
      @sectors << Sector.new(_io_sectors, self, @_root, i == 0)
      i += 1
    end
    self
  end
  ...
  class Sector < Kaitai::Struct::Struct
    def initialize(_io, _parent = nil, _root = nil, has_manufacturer)
      super(_io, _parent, _root)
    ...
    def _read
      ...
      _io_data_filler = @_io.substream((_io.size - _io.pos) - 16)
      @data_filler = Filler.new(_io_data_filler, self, @_root)
  ...
  class Trailer < Kaitai::Struct::Struct
    ...
    def _read
      ...
      _io_access_bits = @_io.substream(3)
      @access_bits = AccessConditions.new(_io_access_bits, self, @_root)
    ...
    class AccessConditions < Kaitai::Struct::Struct
      ...
      class Ac < Kaitai::Struct::Struct
        ...
        class AcBit < Kaitai::Struct::Struct
          def initialize(_io, _parent = nil, _root = nil, i, chunk)
            super(_io, _parent, _root)
            @i = i
            @chunk = chunk
            _read
      ...
      class ChunkBitRemap < Kaitai::Struct::Struct
        def initialize(_io, _parent = nil, _root = nil, bit_no)
          super(_io, _parent, _root)
          @bit_no = bit_no
          _read
        end
      ...
      class DataAc < Kaitai::Struct::Struct
        def initialize(_io, _parent = nil, _root = nil, ac)
          super(_io, _parent, _root)
          @ac = ac
          _read
        end
      ...
      class ValidChunk < Kaitai::Struct::Struct
        def initialize(_io, _parent = nil, _root = nil, inv_chunk, chunk)
          super(_io, _parent, _root)
          @inv_chunk = inv_chunk
          @chunk = chunk
          _read
