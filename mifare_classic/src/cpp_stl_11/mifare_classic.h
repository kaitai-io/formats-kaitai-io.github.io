...
public:
    ...
    public:
        ...
        key_t(kaitai::kstream* p__io, mifare_classic_t::trailer_t* p__parent = nullptr, mifare_classic_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            values_t(kaitai::kstream* p__io, mifare_classic_t::sector_t* p__parent = nullptr, mifare_classic_t* p__root = nullptr);
        ...
        public:
            ...
            public:
                ...
                value_block_t(kaitai::kstream* p__io, mifare_classic_t::sector_t::values_t* p__parent = nullptr, mifare_classic_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<std::vector<uint8_t>> m_addrz;
                mifare_classic_t* m__root;
                mifare_classic_t::sector_t::values_t* m__parent;

            public:
                std::vector<uint32_t>* valuez() const { return m_valuez.get(); }
                std::vector<uint8_t>* addrz() const { return m_addrz.get(); }
                mifare_classic_t* _root() const { return m__root; }
                mifare_classic_t::sector_t::values_t* _parent() const { return m__parent; }
            };

        private:
            std::unique_ptr<std::vector<std::unique_ptr<value_block_t>>> m_values;
            mifare_classic_t* m__root;
            mifare_classic_t::sector_t* m__parent;

        public:
            std::vector<std::unique_ptr<value_block_t>>* values() const { return m_values.get(); }
            mifare_classic_t* _root() const { return m__root; }
            mifare_classic_t::sector_t* _parent() const { return m__parent; }
        };
    ...
    private:
        std::unique_ptr<manufacturer_t> m_manufacturer;
        bool n_manufacturer;
    ...
    private:
        std::unique_ptr<filler_t> m_data_filler;
        std::unique_ptr<trailer_t> m_trailer;
        bool m_has_manufacturer;
        mifare_classic_t* m__root;
        mifare_classic_t* m__parent;
        std::string m__raw_data_filler;
        std::unique_ptr<kaitai::kstream> m__io__raw_data_filler;

    public:
        manufacturer_t* manufacturer() const { return m_manufacturer.get(); }
        filler_t* data_filler() const { return m_data_filler.get(); }
        trailer_t* trailer() const { return m_trailer.get(); }
    ...
    public:
        ...
        trailer_t(kaitai::kstream* p__io, mifare_classic_t::sector_t* p__parent = nullptr, mifare_classic_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            public:
                ...
                ac_t(uint8_t p_index, kaitai::kstream* p__io, mifare_classic_t::trailer_t::access_conditions_t* p__parent = nullptr, mifare_classic_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    ac_bit_t(uint8_t p_i, uint8_t p_chunk, kaitai::kstream* p__io, mifare_classic_t::trailer_t::access_conditions_t::ac_t* p__parent = nullptr, mifare_classic_t* p__root = nullptr);
            ...
            private:
                bool f_bits;
                std::unique_ptr<std::vector<std::unique_ptr<ac_bit_t>>> m_bits;
            ...
            public:
                ...
                valid_chunk_t(uint8_t p_inv_chunk, uint8_t p_chunk, kaitai::kstream* p__io, mifare_classic_t::trailer_t::access_conditions_t* p__parent = nullptr, mifare_classic_t* p__root = nullptr);
        ...
        public:
            std::vector<std::unique_ptr<data_ac_t>>* data_acs();

        private:
            bool f_remaps;
            std::unique_ptr<std::vector<std::unique_ptr<chunk_bit_remap_t>>> m_remaps;
        ...
        public:
            std::vector<uint64_t>* raw_chunks() const { return m_raw_chunks.get(); }
            mifare_classic_t* _root() const { return m__root; }
            mifare_classic_t::trailer_t* _parent() const { return m__parent; }
        };
    ...
    private:
        ...
        std::unique_ptr<access_conditions_t> m_access_bits;
        uint8_t m_user_byte;
        std::unique_ptr<key_t> m_key_b;
        mifare_classic_t* m__root;
        mifare_classic_t::sector_t* m__parent;
        std::string m__raw_access_bits;
        std::unique_ptr<kaitai::kstream> m__io__raw_access_bits;

    public:
        key_t* key_a() const { return m_key_a.get(); }
        access_conditions_t* access_bits() const { return m_access_bits.get(); }
        uint8_t user_byte() const { return m_user_byte; }
        key_t* key_b() const { return m_key_b.get(); }
        mifare_classic_t* _root() const { return m__root; }
        mifare_classic_t::sector_t* _parent() const { return m__parent; }
        std::string _raw_access_bits() const { return m__raw_access_bits; }
        kaitai::kstream* _io__raw_access_bits() const { return m__io__raw_access_bits.get(); }
    };

private:
    std::unique_ptr<std::vector<std::unique_ptr<sector_t>>> m_sectors;
    mifare_classic_t* m__root;
    kaitai::kstruct* m__parent;
    std::unique_ptr<std::vector<std::string>> m__raw_sectors;
    std::unique_ptr<std::vector<std::unique_ptr<kaitai::kstream>>> m__io__raw_sectors;

public:
    std::vector<std::unique_ptr<sector_t>>* sectors() const { return m_sectors.get(); }
    mifare_classic_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
    std::vector<std::string>* _raw_sectors() const { return m__raw_sectors.get(); }
    std::vector<std::unique_ptr<kaitai::kstream>>* _io__raw_sectors() const { return m__io__raw_sectors.get(); }
};
