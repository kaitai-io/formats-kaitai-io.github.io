...
public:
    ...
    public:
        ...
        header_tags_step_t(int32_t p_idx, int32_t p_prev_payload_size_tag_idx, kaitai::kstream* p__io, rpm_t* p__parent = 0, rpm_t* p__root = 0);
    ...
    public:
        ...
        lead_t(kaitai::kstream* p__io, rpm_t* p__parent = 0, rpm_t* p__root = 0);
    ...
    public:
        std::string magic() const { return m_magic; }
        rpm_version_t* version() const { return m_version; }
    ...
    public:
        ...
        record_type_string_t(kaitai::kstream* p__io, rpm_t::header_index_record_t* p__parent = 0, rpm_t* p__root = 0);
    ...
    public:
        ...
        signature_tags_step_t(int32_t p_idx, int32_t p_prev_size_tag_idx, int32_t p_prev_long_size_tag_idx, kaitai::kstream* p__io, rpm_t* p__parent = 0, rpm_t* p__root = 0);
...
private:
    std::vector<signature_tags_step_t*>* m_signature_tags_steps;
    std::vector<header_tags_step_t*>* m_header_tags_steps;
    rpm_t* m__root;
    kaitai::kstruct* m__parent;

public:
    lead_t* lead() const { return m_lead; }
    header_t* signature() const { return m_signature; }
    ...
    std::vector<signature_tags_step_t*>* signature_tags_steps() const { return m_signature_tags_steps; }
    std::vector<header_tags_step_t*>* header_tags_steps() const { return m_header_tags_steps; }
    rpm_t* _root() const { return m__root; }
