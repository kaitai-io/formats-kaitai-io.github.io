...
void heaps_pak_t::header_t::_read() {
    ...
    if (!(m_magic1 == std::string("\x50\x41\x4B", 3))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x50\x41\x4B", 3), m_magic1, m__io, std::string("/types/header/seq/0"));
    }
    ...
    if (!(m_magic2 == std::string("\x44\x41\x54\x41", 4))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x44\x41\x54\x41", 4), m_magic2, m__io, std::string("/types/header/seq/5"));
    }
}
