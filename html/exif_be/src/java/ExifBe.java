...
public class ExifBe extends KaitaiStruct {
    public static ExifBe fromFile(String fileName) throws IOException {
        return new ExifBe(new ByteBufferKaitaiStream(fileName));
    }

    public ExifBe(KaitaiStream _io) {
        this(_io, null, null);
    }

    public ExifBe(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public ExifBe(KaitaiStream _io, KaitaiStruct _parent, ExifBe _root) {
        super(_io);
    ...
    public static class Ifd extends KaitaiStruct {
        ...
        public Ifd(KaitaiStream _io, KaitaiStruct _parent) {
            this(_io, _parent, null);
        }

        public Ifd(KaitaiStream _io, KaitaiStruct _parent, ExifBe _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        public Ifd nextIfd() {
            ...
            if (nextIfdOfs() != 0) {
                ...
                this.nextIfd = new Ifd(this._io, this, _root);
                this._io.seek(_pos);
            }
            return this.nextIfd;
        }
    ...
    public static class IfdField extends KaitaiStruct {
        ...
        public IfdField(KaitaiStream _io) {
            this(_io, null, null);
        }

        public IfdField(KaitaiStream _io, ExifBe.Ifd _parent) {
            this(_io, _parent, null);
        }

        public IfdField(KaitaiStream _io, ExifBe.Ifd _parent, ExifBe _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public Ifd ifd0() {
        ...
        this.ifd0 = new Ifd(this._io, this, _root);
        this._io.seek(_pos);
        return this.ifd0;
    }
    private int version;
