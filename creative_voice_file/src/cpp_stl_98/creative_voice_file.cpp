...
std::set<creative_voice_file_t::block_types_t> creative_voice_file_t::_build_values_block_types_t() {
    std::set<creative_voice_file_t::block_types_t> _t;
    _t.insert(creative_voice_file_t::BLOCK_TYPES_TERMINATOR);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_SOUND_DATA);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_SOUND_DATA_CONT);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_SILENCE);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_MARKER);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_TEXT);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_REPEAT_START);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_REPEAT_END);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_EXTRA_INFO);
    _t.insert(creative_voice_file_t::BLOCK_TYPES_SOUND_DATA_NEW);
    return _t;
}
const std::set<creative_voice_file_t::block_types_t> creative_voice_file_t::_values_block_types_t = creative_voice_file_t::_build_values_block_types_t();
...
std::set<creative_voice_file_t::codecs_t> creative_voice_file_t::_build_values_codecs_t() {
    std::set<creative_voice_file_t::codecs_t> _t;
    _t.insert(creative_voice_file_t::CODECS_PCM_8BIT_UNSIGNED);
    _t.insert(creative_voice_file_t::CODECS_ADPCM_4BIT);
    _t.insert(creative_voice_file_t::CODECS_ADPCM_2_6BIT);
    _t.insert(creative_voice_file_t::CODECS_ADPCM_2_BIT);
    _t.insert(creative_voice_file_t::CODECS_PCM_16BIT_SIGNED);
    _t.insert(creative_voice_file_t::CODECS_ALAW);
    _t.insert(creative_voice_file_t::CODECS_ULAW);
    _t.insert(creative_voice_file_t::CODECS_ADPCM_4_TO_16BIT);
    return _t;
}
const std::set<creative_voice_file_t::codecs_t> creative_voice_file_t::_values_codecs_t = creative_voice_file_t::_build_values_codecs_t();
