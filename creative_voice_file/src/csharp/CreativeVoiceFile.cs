...
namespace Kaitai
{
    ...
    public partial class CreativeVoiceFile : KaitaiStruct
    {
        ...
        private void _read()
        {
            ...
            if (!((KaitaiStream.ByteArrayCompare(_magic, new byte[] { 67, 114, 101, 97, 116, 105, 118, 101, 32, 86, 111, 105, 99, 101, 32, 70, 105, 108, 101, 26 }) == 0)))
            {
                throw new ValidationNotEqualError(new byte[] { 67, 114, 101, 97, 116, 105, 118, 101, 32, 86, 111, 105, 99, 101, 32, 70, 105, 108, 101, 26 }, _magic, m_io, "/seq/0");
            }
