...
public:
    ...
    nt_mdt_pal_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, nt_mdt_pal_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        col_table_t(uint16_t p_index, kaitai::kstream* p__io, nt_mdt_pal_t* p__parent = nullptr, nt_mdt_pal_t* p__root = nullptr);
    ...
    public:
        ...
        color_t(kaitai::kstream* p__io, nt_mdt_pal_t::col_table_t* p__parent = nullptr, nt_mdt_pal_t* p__root = nullptr);
    ...
    public:
        ...
        meta_t(kaitai::kstream* p__io, nt_mdt_pal_t* p__parent = nullptr, nt_mdt_pal_t* p__root = nullptr);
...
private:
    ...
    uint32_t m_count;
    std::unique_ptr<std::vector<std::unique_ptr<meta_t>>> m_meta;
    std::string m_something2;
    std::unique_ptr<std::vector<std::unique_ptr<col_table_t>>> m_tables;
    nt_mdt_pal_t* m__root;
...
public:
    ...
    std::vector<std::unique_ptr<meta_t>>* meta() const { return m_meta.get(); }
    std::string something2() const { return m_something2; }
    std::vector<std::unique_ptr<col_table_t>>* tables() const { return m_tables.get(); }
    nt_mdt_pal_t* _root() const { return m__root; }
