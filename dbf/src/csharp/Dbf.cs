...
namespace Kaitai
{
    ...
    public partial class Dbf : KaitaiStruct
    {
        ...
        private void _read()
        {
            ...
            if (!((KaitaiStream.ByteArrayCompare(_headerTerminator, new byte[] { 13 }) == 0)))
            {
                throw new ValidationNotEqualError(new byte[] { 13 }, _headerTerminator, m_io, "/seq/2");
            }
        ...
        public partial class HeaderDbase7 : KaitaiStruct
        {
            ...
            {
                _reserved1 = m_io.ReadBytes(2);
                if (!((KaitaiStream.ByteArrayCompare(_reserved1, new byte[] { 0, 0 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 0, 0 }, _reserved1, m_io, "/types/header_dbase_7/seq/0");
                }
                ...
                if (!((KaitaiStream.ByteArrayCompare(_reserved3, new byte[] { 0, 0 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 0, 0 }, _reserved3, m_io, "/types/header_dbase_7/seq/6");
                }
