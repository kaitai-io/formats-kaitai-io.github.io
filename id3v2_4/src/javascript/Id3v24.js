...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Id3v24 || (root.Id3v24 = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Id3v24_, KaitaiStream) {
/**
...
var Id3v24 = (function() {
  ...
  var Footer = Id3v24.Footer = (function() {
    ...
    Footer.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.magic, new Uint8Array([51, 68, 73])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([51, 68, 73]), this.magic, this._io, "/types/footer/seq/0");
      }
