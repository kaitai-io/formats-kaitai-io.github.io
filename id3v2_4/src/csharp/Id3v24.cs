...
namespace Kaitai
{
    public partial class Id3v24 : KaitaiStruct
    {
        ...
        public Id3v24(KaitaiStream io, KaitaiStruct parent = null, Id3v24 root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class U1beSynchsafe : KaitaiStruct
        {
            ...
            public U1beSynchsafe(KaitaiStream io, Id3v24.U2beSynchsafe parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class U2beSynchsafe : KaitaiStruct
        {
            ...
            public U2beSynchsafe(KaitaiStream io, Id3v24.U4beSynchsafe parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_value = false;
        ...
        public partial class Tag : KaitaiStruct
        {
            ...
            public Tag(KaitaiStream io, Id3v24 parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class U4beSynchsafe : KaitaiStruct
        {
            ...
            public U4beSynchsafe(KaitaiStream io, KaitaiStruct parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_value = false;
        ...
        public partial class Frame : KaitaiStruct
        {
            ...
            public Frame(KaitaiStream io, Id3v24.Tag parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_isInvalid = false;
            ...
            public partial class FlagsStatus : KaitaiStruct
            {
                ...
                public FlagsStatus(KaitaiStream io, Id3v24.Frame parent = null, Id3v24 root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _read();
            ...
            public partial class FlagsFormat : KaitaiStruct
            {
                ...
                public FlagsFormat(KaitaiStream io, Id3v24.Frame parent = null, Id3v24 root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _read();
        ...
        public partial class HeaderEx : KaitaiStruct
        {
            ...
            public HeaderEx(KaitaiStream io, Id3v24.Tag parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
            ...
            public partial class FlagsEx : KaitaiStruct
            {
                ...
                public FlagsEx(KaitaiStream io, Id3v24.HeaderEx parent = null, Id3v24 root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream io, Id3v24.Tag parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
            ...
            public partial class Flags : KaitaiStruct
            {
                ...
                public Flags(KaitaiStream io, Id3v24.Header parent = null, Id3v24 root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream io, Id3v24.Tag parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Footer : KaitaiStruct
        {
            ...
            public Footer(KaitaiStream io, Id3v24.Tag parent = null, Id3v24 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
            ...
            public partial class Flags : KaitaiStruct
            {
                ...
                public Flags(KaitaiStream io, Id3v24.Footer parent = null, Id3v24 root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _read();
