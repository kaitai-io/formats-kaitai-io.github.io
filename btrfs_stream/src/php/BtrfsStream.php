...
class SendStreamHeader extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_magic = $this->_io->ensureFixedContents("\x62\x74\x72\x66\x73\x2D\x73\x74\x72\x65\x61\x6D\x00");
...
class SendCommand extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_data = new \BtrfsStream\SendCommand\Tlvs($io, $this, $this->_root);
    }
    ...
    private function _read() {
        ...
        switch ($this->type()) {
            ...
            case \BtrfsStream\Attribute::OTIME:
                ...
                $this->_m_value = new \BtrfsStream\SendCommand\Timespec($io, $this, $this->_root);
                break;
            ...
            case \BtrfsStream\Attribute::UUID:
                $this->_m__raw_value = $this->_io->readBytes($this->length());
                $io = new \Kaitai\Struct\Stream($this->_m__raw_value);
                $this->_m_value = new \BtrfsStream\SendCommand\Uuid($io, $this, $this->_root);
                break;
            ...
            case \BtrfsStream\Attribute::PATH_TO:
                $this->_m__raw_value = $this->_io->readBytes($this->length());
                $io = new \Kaitai\Struct\Stream($this->_m__raw_value);
                $this->_m_value = new \BtrfsStream\SendCommand\String($io, $this, $this->_root);
                break;
