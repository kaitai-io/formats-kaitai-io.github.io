...
class BtrfsStream < Kaitai::Struct::Struct
  ...
  class SendCommand < Kaitai::Struct::Struct
    ...
    def _read
      ...
      @data = Tlvs.new(_io_data, self, @_root)
      self
    end
    ...
    class Tlv < Kaitai::Struct::Struct
      ...
      def _read
        ...
        when :attribute_atime
          _io_value = @_io.substream(length)
          @value = Timespec.new(_io_value, self, @_root)
        ...
        when :attribute_clone_path
          _io_value = @_io.substream(length)
          @value = String.new(_io_value, self, @_root)
        when :attribute_clone_uuid
          _io_value = @_io.substream(length)
          @value = Uuid.new(_io_value, self, @_root)
