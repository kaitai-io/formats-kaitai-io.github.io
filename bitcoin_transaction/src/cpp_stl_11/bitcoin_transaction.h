...
public:
    ...
    bitcoin_transaction_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, bitcoin_transaction_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        vin_t(kaitai::kstream* p__io, bitcoin_transaction_t* p__parent = nullptr, bitcoin_transaction_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            public:
                ...
                der_signature_t(kaitai::kstream* p__io, bitcoin_transaction_t::vin_t::script_signature_t* p__parent = nullptr, bitcoin_transaction_t* p__root = nullptr);
            ...
            public:
                ...
                public_key_t(kaitai::kstream* p__io, bitcoin_transaction_t::vin_t::script_signature_t* p__parent = nullptr, bitcoin_transaction_t* p__root = nullptr);
        ...
        private:
            ...
            std::unique_ptr<der_signature_t> m_der_sig;
            sighash_type_t m_sig_type;
            uint8_t m_len_pubkey_stack;
            std::unique_ptr<public_key_t> m_pubkey;
            bitcoin_transaction_t* m__root;
        ...
        public:
             ...
             *  Source
             */
            der_signature_t* der_sig() const { return m_der_sig.get(); }
             ...
             */
            public_key_t* pubkey() const { return m_pubkey.get(); }
            bitcoin_transaction_t* _root() const { return m__root; }
    ...
    private:
        ...
        std::unique_ptr<script_signature_t> m_script_sig;
        std::string m_end_of_vin;
        bitcoin_transaction_t* m__root;
        bitcoin_transaction_t* m__parent;
        std::string m__raw_script_sig;
        std::unique_ptr<kaitai::kstream> m__io__raw_script_sig;
    ...
    public:
         ...
         *  Source
         */
        script_signature_t* script_sig() const { return m_script_sig.get(); }
        ...
        kaitai::kstream* _io__raw_script_sig() const { return m__io__raw_script_sig.get(); }
    };
    ...
    public:
        ...
        vout_t(kaitai::kstream* p__io, bitcoin_transaction_t* p__parent = nullptr, bitcoin_transaction_t* p__root = nullptr);
...
private:
    uint32_t m_version;
    uint8_t m_num_vins;
    std::unique_ptr<std::vector<std::unique_ptr<vin_t>>> m_vins;
    uint8_t m_num_vouts;
    std::unique_ptr<std::vector<std::unique_ptr<vout_t>>> m_vouts;
    uint32_t m_locktime;
    bitcoin_transaction_t* m__root;
...
public:
     ...
     */
    std::vector<std::unique_ptr<vin_t>>* vins() const { return m_vins.get(); }
     ...
     * Output transactions.
     */
    std::vector<std::unique_ptr<vout_t>>* vouts() const { return m_vouts.get(); }
