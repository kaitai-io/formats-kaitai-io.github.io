...
std::set<bitcoin_transaction_t::vin_t::script_signature_t::sighash_type_t> bitcoin_transaction_t::vin_t::script_signature_t::_build_values_sighash_type_t() {
    std::set<bitcoin_transaction_t::vin_t::script_signature_t::sighash_type_t> _t;
    _t.insert(bitcoin_transaction_t::vin_t::script_signature_t::SIGHASH_TYPE_SIGHASH_ALL);
    _t.insert(bitcoin_transaction_t::vin_t::script_signature_t::SIGHASH_TYPE_SIGHASH_NONE);
    _t.insert(bitcoin_transaction_t::vin_t::script_signature_t::SIGHASH_TYPE_SIGHASH_SINGLE);
    _t.insert(bitcoin_transaction_t::vin_t::script_signature_t::SIGHASH_TYPE_SIGHASH_ANYONECANPAY);
    return _t;
}
const std::set<bitcoin_transaction_t::vin_t::script_signature_t::sighash_type_t> bitcoin_transaction_t::vin_t::script_signature_t::_values_sighash_type_t = bitcoin_transaction_t::vin_t::script_signature_t::_build_values_sighash_type_t();
