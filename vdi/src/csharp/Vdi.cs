    ...
    public partial class Vdi : KaitaiStruct
    {
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_signature, new byte[] { 127, 16, 218, 190 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 127, 16, 218, 190 }, _signature, m_io, "/types/header/seq/1");
                }
