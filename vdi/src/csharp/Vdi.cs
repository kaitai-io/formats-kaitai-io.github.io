    ...
    public partial class Vdi : KaitaiStruct
    {
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public partial class HeaderMain : KaitaiStruct
            {
                ...
                public uint? OffsetBmap { get { return _offsetBmap; } }
            ...
            private bool f_bmapSize;
            private int _bmapSize;
            public int BmapSize
            {
                get
                {
                    if (f_bmapSize)
                        return _bmapSize;
                    _bmapSize = (int) ((((((HeaderMain.BlocksInImage * 4) + HeaderMain.Geometry.SectorSize) - 1) / HeaderMain.Geometry.SectorSize) * HeaderMain.Geometry.SectorSize));
                    f_bmapSize = true;
                    return _bmapSize;
                }
            }
            ...
            private bool f_bmapOffset;
            private uint _bmapOffset;
            public uint BmapOffset
            {
                get
                {
                    if (f_bmapOffset)
                        return _bmapOffset;
                    _bmapOffset = (uint) (HeaderMain.OffsetBmap);
                    f_bmapOffset = true;
                    return _bmapOffset;
                }
            }
        ...
        public BlocksMap BlocksMap
        {
            get
            {
                if (f_blocksMap)
                    return _blocksMap;
                long _pos = m_io.Pos;
                m_io.Seek(Header.BmapOffset);
                __raw_blocksMap = m_io.ReadBytes(Header.BmapSize);
