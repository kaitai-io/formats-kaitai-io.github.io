...
public class Vdi extends KaitaiStruct {
    ...
    public static class Header extends KaitaiStruct {
        ...
        public static class HeaderMain extends KaitaiStruct {
            ...
            public Long offsetBmap() { return offsetBmap; }
        ...
        private Integer bmapSize;
        public Integer bmapSize() {
            if (this.bmapSize != null)
                return this.bmapSize;
        ...
        private Long bmapOffset;
        public Long bmapOffset() {
            if (this.bmapOffset != null)
                return this.bmapOffset;
            long _tmp = (long) (headerMain().offsetBmap());
            this.bmapOffset = _tmp;
            return this.bmapOffset;
        }
    ...
    public BlocksMap blocksMap() {
        ...
        this._io.seek(header().bmapOffset());
        this._raw_blocksMap = this._io.readBytes(header().bmapSize());
