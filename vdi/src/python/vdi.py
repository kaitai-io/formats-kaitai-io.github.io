...
class Vdi(KaitaiStruct):
    ...
    class Header(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.signature = self._io.ensure_fixed_contents(struct.pack('4b', 127, 16, -38, -66))
        ...
        class HeaderMain(KaitaiStruct):
            ...
            def _read(self):
                ...
                if self._parent.version.major >= 1:
                    self.offset_bmap = self._io.read_u4le()
        ...
        @property
        def bmap_size(self):
            if hasattr(self, '_m_bmap_size'):
                return self._m_bmap_size if hasattr(self, '_m_bmap_size') else None

            self._m_bmap_size = ((((self.header_main.blocks_in_image * 4) + self.header_main.geometry.sector_size) - 1) // self.header_main.geometry.sector_size * self.header_main.geometry.sector_size)
            return self._m_bmap_size if hasattr(self, '_m_bmap_size') else None
        ...
        @property
        def bmap_offset(self):
            if hasattr(self, '_m_bmap_offset'):
                return self._m_bmap_offset if hasattr(self, '_m_bmap_offset') else None

            self._m_bmap_offset = self.header_main.offset_bmap
            return self._m_bmap_offset if hasattr(self, '_m_bmap_offset') else None
    ...
    def blocks_map(self):
        ...
        _pos = self._io.pos()
        self._io.seek(self.header.bmap_offset)
        self._raw__m_blocks_map = self._io.read_bytes(self.header.bmap_size)
