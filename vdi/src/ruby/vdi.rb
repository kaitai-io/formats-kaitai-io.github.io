...
class Vdi < Kaitai::Struct::Struct
  ...
  class Header < Kaitai::Struct::Struct
    ...
    def bmap_size
      return @bmap_size unless @bmap_size.nil?
      @bmap_size = (((((header_main.blocks_in_image * 4) + header_main.geometry.sector_size) - 1) / header_main.geometry.sector_size) * header_main.geometry.sector_size)
      @bmap_size
    end
    def header_size
    ...
    def bmap_offset
      return @bmap_offset unless @bmap_offset.nil?
      @bmap_offset = header_main.offset_bmap
      @bmap_offset
    end
  ...
  def blocks_map
    ...
    _pos = @_io.pos
    @_io.seek(header.bmap_offset)
    @_raw_blocks_map = @_io.read_bytes(header.bmap_size)
