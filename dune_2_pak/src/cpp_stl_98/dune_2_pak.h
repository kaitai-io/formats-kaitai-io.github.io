#ifndef DUNE_2_PAK_H_
#define DUNE_2_PAK_H_
...
public:
    ...
    dune_2_pak_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, dune_2_pak_t* p__root = 0);
...
public:
    ...
    public:
        ...
        files_t(kaitai::kstream* p__io, dune_2_pak_t* p__parent = 0, dune_2_pak_t* p__root = 0);
    ...
    public:
        ...
        file_t(uint32_t p_idx, kaitai::kstream* p__io, dune_2_pak_t::files_t* p__parent = 0, dune_2_pak_t* p__root = 0);
...
public:
    files_t* dir() const { return m_dir; }
    dune_2_pak_t* _root() const { return m__root; }
