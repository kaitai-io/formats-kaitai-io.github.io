...
namespace Kaitai
{
    public partial class MbrPartitionTable : KaitaiStruct
    {
        ...
        public MbrPartitionTable(KaitaiStream io, KaitaiStruct parent = null, MbrPartitionTable root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class PartitionEntry : KaitaiStruct
        {
            ...
            public PartitionEntry(KaitaiStream io, MbrPartitionTable parent = null, MbrPartitionTable root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Chs : KaitaiStruct
        {
            ...
            public Chs(KaitaiStream io, MbrPartitionTable.PartitionEntry parent = null, MbrPartitionTable root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_sector = false;
