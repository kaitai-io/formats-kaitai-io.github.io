...
class Header extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_magic = $this->_io->ensureFixedContents("\x4C\x66\x4C\x65");
...
class Flags extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_archive = $this->_io->readBitsInt(1) != 0;
        $this->_m_logFull = $this->_io->readBitsInt(1) != 0;
        $this->_m_wrap = $this->_io->readBitsInt(1) != 0;
        $this->_m_dirty = $this->_io->readBitsInt(1) != 0;
    }
...
class CursorRecordBody extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_magic = $this->_io->ensureFixedContents("\x22\x22\x22\x22\x33\x33\x33\x33\x44\x44\x44\x44");
