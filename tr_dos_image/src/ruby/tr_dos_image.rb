...
class TrDosImage < Kaitai::Struct::Struct
  ...
  class File < Kaitai::Struct::Struct
    ...
    def _read
      _io_name = @_io.substream(8)
      @name = Filename.new(_io_name, self, @_root)
  ...
  class VolumeInfo < Kaitai::Struct::Struct
    ...
    def num_sides
      ...
      @num_sides = ((TrDosImage::I__DISK_TYPE[disk_type] || disk_type) & 8 != 0 ? 1 : 2)
      @num_sides
    end
    def num_tracks
      return @num_tracks unless @num_tracks.nil?
      @num_tracks = ((TrDosImage::I__DISK_TYPE[disk_type] || disk_type) & 1 != 0 ? 40 : 80)
      @num_tracks
    end
