...
const std::set<tr_dos_image_t::disk_type_t> tr_dos_image_t::_values_disk_type_t{
    tr_dos_image_t::DISK_TYPE_TYPE_80_TRACKS_DOUBLE_SIDE,
    tr_dos_image_t::DISK_TYPE_TYPE_40_TRACKS_DOUBLE_SIDE,
    tr_dos_image_t::DISK_TYPE_TYPE_80_TRACKS_SINGLE_SIDE,
    tr_dos_image_t::DISK_TYPE_TYPE_40_TRACKS_SINGLE_SIDE,
};
