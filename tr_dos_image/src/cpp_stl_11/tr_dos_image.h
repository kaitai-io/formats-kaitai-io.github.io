...
public:
    ...
    tr_dos_image_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        volume_info_t(kaitai::kstream* p__io, tr_dos_image_t* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
    ...
    public:
        ...
        position_and_length_code_t(kaitai::kstream* p__io, tr_dos_image_t::file_t* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
    ...
    public:
        ...
        filename_t(kaitai::kstream* p__io, tr_dos_image_t::file_t* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
    ...
    public:
        ...
        position_and_length_print_t(kaitai::kstream* p__io, tr_dos_image_t::file_t* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
    ...
    public:
        ...
        position_and_length_generic_t(kaitai::kstream* p__io, tr_dos_image_t::file_t* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
    ...
    public:
        ...
        position_and_length_basic_t(kaitai::kstream* p__io, tr_dos_image_t::file_t* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
    ...
    public:
        ...
        file_t(kaitai::kstream* p__io, tr_dos_image_t* p__parent = nullptr, tr_dos_image_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<filename_t> m_name;
        uint8_t m_extension;
        std::unique_ptr<kaitai::kstruct> m_position_and_length;
        ...
        std::unique_ptr<kaitai::kstream> m__io__raw_name;

    public:
        filename_t* name() const { return m_name.get(); }
        uint8_t extension() const { return m_extension; }
        kaitai::kstruct* position_and_length() const { return m_position_and_length.get(); }
        ...
        kaitai::kstream* _io__raw_name() const { return m__io__raw_name.get(); }
    };

private:
    bool f_volume_info;
    std::unique_ptr<volume_info_t> m_volume_info;
