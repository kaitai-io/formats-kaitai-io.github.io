...
namespace TrDosImage {
    class VolumeInfo extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_catalogEnd = $this->_io->readBytes(1);
            if (!($this->_m_catalogEnd == "\x00")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x00", $this->_m_catalogEnd, $this->_io, "/types/volume_info/seq/0");
            }
            ...
            $this->_m_trDosId = $this->_io->readBytes(1);
            if (!($this->_m_trDosId == "\x10")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x10", $this->_m_trDosId, $this->_io, "/types/volume_info/seq/7");
            }
...
namespace TrDosImage {
    class DiskType {
        ...
        private const _VALUES = [22 => true, 23 => true, 24 => true, 25 => true];
