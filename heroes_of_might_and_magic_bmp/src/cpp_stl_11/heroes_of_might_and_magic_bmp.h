...
class heroes_of_might_and_magic_bmp_t;
...
public:
    ...
    heroes_of_might_and_magic_bmp_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, heroes_of_might_and_magic_bmp_t* p__root = nullptr);
