    ...
    class Mo(KaitaiStruct):
        ...
        def originals(self):
            ...
            if self._is_le:
                ...
                for i in range(self.num_translations):
                    self._m_originals[i] = self._root.Mo.Descriptor(io, self, self._root, self._is_le)
        ...
        def translations(self):
            ...
            if self._is_le:
                ...
                for i in range(self.num_translations):
                    self._m_translations[i] = self._root.Mo.Descriptor(io, self, self._root, self._is_le)
            ...
            if self.ofs_hashtable_items != 0:
                ...
                if self._is_le:
                    ...
                    for i in range(self.num_hashtable_items):
                        self._m_hashtable_items[i] = self._root.Mo.HashtableItem(io, self, self._root, self._is_le)
