...
func (this *GettextMo_Mo) Originals() (v []*GettextMo_Mo_Descriptor, err error) {
	...
	case 0:
		for i := 0; i < int(this.NumTranslations); i++ {
			...
			this.originals = append(this.originals, tmp37)
		}
	case 1:
		for i := 0; i < int(this.NumTranslations); i++ {
			_ = i
			...
			this.originals = append(this.originals, tmp38)
		}
	default:
		err = kaitai.UndecidedEndiannessError{}
	}
...
func (this *GettextMo_Mo) Translations() (v []*GettextMo_Mo_Descriptor, err error) {
	...
	case 0:
		for i := 0; i < int(this.NumTranslations); i++ {
			...
			this.translations = append(this.translations, tmp39)
		}
	case 1:
		for i := 0; i < int(this.NumTranslations); i++ {
			_ = i
			...
			this.translations = append(this.translations, tmp40)
		}
	default:
		err = kaitai.UndecidedEndiannessError{}
	}
	...
	if (this.OfsHashtableItems != 0) {
		...
		case 0:
			for i := 0; i < int(this.NumHashtableItems); i++ {
				...
				this.hashtableItems = append(this.hashtableItems, tmp41)
			}
		case 1:
			for i := 0; i < int(this.NumHashtableItems); i++ {
				_ = i
				...
				this.hashtableItems = append(this.hashtableItems, tmp42)
			}
		default:
			err = kaitai.UndecidedEndiannessError{}
		}
