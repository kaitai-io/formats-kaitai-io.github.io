...
public:
    ...
    public:
        ...
        tag_control_info_t(kaitai::kstream* p__io, ethernet_frame_t* p__parent = nullptr, ethernet_frame_t* p__root = nullptr);
...
private:
    ...
    std::unique_ptr<tag_control_info_t> m_tci;
    bool n_tci;
...
public:
    ...
    tag_control_info_t* tci() const { return m_tci.get(); }
