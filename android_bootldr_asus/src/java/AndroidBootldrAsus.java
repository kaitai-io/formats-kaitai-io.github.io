 ...
 */
public class AndroidBootldrAsus extends KaitaiStruct {
    ...
    public AndroidBootldrAsus(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public AndroidBootldrAsus(KaitaiStream _io, KaitaiStruct _parent, AndroidBootldrAsus _root) {
        super(_io);
