...
private:
    ...
    static std::set<component_id_t> _build_values_component_id_t();
...
public:
    ...
    private:
        ...
        static std::set<marker_enum_t> _build_values_marker_enum_t();
    ...
    private:
        ...
        static std::set<density_unit_t> _build_values_density_unit_t();
