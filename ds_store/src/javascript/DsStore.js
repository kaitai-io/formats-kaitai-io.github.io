...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.DsStore || (root.DsStore = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (DsStore_, KaitaiStream) {
/**
...
var DsStore = (function() {
  ...
  DsStore.prototype._read = function() {
    ...
    if (!((KaitaiStream.byteArrayCompare(this.alignmentHeader, new Uint8Array([0, 0, 0, 1])) == 0))) {
      throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([0, 0, 0, 1]), this.alignmentHeader, this._io, "/seq/0");
    }
  ...
  var BuddyAllocatorHeader = DsStore.BuddyAllocatorHeader = (function() {
    ...
    BuddyAllocatorHeader.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.magic, new Uint8Array([66, 117, 100, 49])) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError(new Uint8Array([66, 117, 100, 49]), this.magic, this._io, "/types/buddy_allocator_header/seq/0");
      }
