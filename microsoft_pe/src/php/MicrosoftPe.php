...
namespace MicrosoftPe\CertificateEntry {
    class CertificateRevision {
        ...
        private const _VALUES = [256 => true, 512 => true];
...
namespace MicrosoftPe {
    class MzPlaceholder extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic == "\x4D\x5A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x4D\x5A", $this->_m_magic, $this->_io, "/types/mz_placeholder/seq/0");
            }
...
namespace MicrosoftPe {
    class PeHeader extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_peSignature == "\x50\x45\x00\x00")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x50\x45\x00\x00", $this->_m_peSignature, $this->_io, "/types/pe_header/seq/0");
            }
...
namespace MicrosoftPe {
    class PeFormat {
        ...
        private const _VALUES = [263 => true, 267 => true, 523 => true];
