...
private:
    ...
    static std::set<pe_format_t> _build_values_pe_format_t();
...
public:
    ...
    private:
        ...
        static std::set<certificate_revision_t> _build_values_certificate_revision_t();
    ...
    private:
        ...
        static std::set<certificate_type_enum_t> _build_values_certificate_type_enum_t();
    ...
    private:
        ...
        static std::set<machine_type_t> _build_values_machine_type_t();
    ...
    private:
        ...
        static std::set<subsystem_enum_t> _build_values_subsystem_enum_t();
