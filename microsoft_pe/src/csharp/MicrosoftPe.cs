    ...
    public partial class MicrosoftPe : KaitaiStruct
    {
        ...
        public partial class MzPlaceholder : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_magic, new byte[] { 77, 90 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 77, 90 }, _magic, m_io, "/types/mz_placeholder/seq/0");
                }
        ...
        public partial class PeHeader : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_peSignature, new byte[] { 80, 69, 0, 0 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 80, 69, 0, 0 }, _peSignature, m_io, "/types/pe_header/seq/0");
                }
