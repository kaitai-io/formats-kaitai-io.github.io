...
void efivar_signature_list_t::efi_var_attr_t::_read() {
    m_enhanced_authenticated_access = m__io->read_bits_int(1);
    m_append_write = m__io->read_bits_int(1);
    m_time_based_authenticated_write_access = m__io->read_bits_int(1);
    m_authenticated_write_access = m__io->read_bits_int(1);
    m_hardware_error_record = m__io->read_bits_int(1);
    m_runtime_access = m__io->read_bits_int(1);
    m_bootservice_access = m__io->read_bits_int(1);
    m_non_volatile = m__io->read_bits_int(1);
