...
class EfiVarAttr extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_enhancedAuthenticatedAccess = $this->_io->readBitsInt(1) != 0;
        $this->_m_appendWrite = $this->_io->readBitsInt(1) != 0;
        $this->_m_timeBasedAuthenticatedWriteAccess = $this->_io->readBitsInt(1) != 0;
        $this->_m_authenticatedWriteAccess = $this->_io->readBitsInt(1) != 0;
        $this->_m_hardwareErrorRecord = $this->_io->readBitsInt(1) != 0;
        $this->_m_runtimeAccess = $this->_io->readBitsInt(1) != 0;
        $this->_m_bootserviceAccess = $this->_io->readBitsInt(1) != 0;
        $this->_m_nonVolatile = $this->_io->readBitsInt(1) != 0;
