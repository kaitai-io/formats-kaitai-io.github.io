...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.EfivarSignatureList || (root.EfivarSignatureList = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (EfivarSignatureList_, KaitaiStream) {
/**
  ...
  var SignatureList = EfivarSignatureList.SignatureList = (function() {
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertDerPkcs7', {
      get: function() {
        ...
        this._m_isCertDerPkcs7 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([157, 210, 175, 74, 223, 104, 238, 73, 138, 169, 52, 125, 55, 86, 101, 167])) == 0);
        return this._m_isCertDerPkcs7;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertRsa2048Key', {
      get: function() {
        ...
        this._m_isCertRsa2048Key = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([232, 102, 87, 60, 156, 38, 52, 78, 170, 20, 237, 119, 110, 133, 179, 182])) == 0);
        return this._m_isCertRsa2048Key;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertRsa2048Sha1', {
      get: function() {
        ...
        this._m_isCertRsa2048Sha1 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([79, 68, 248, 103, 67, 135, 241, 72, 163, 40, 30, 170, 184, 115, 96, 128])) == 0);
        return this._m_isCertRsa2048Sha1;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertRsa2048Sha256', {
      get: function() {
        ...
        this._m_isCertRsa2048Sha256 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([144, 97, 179, 226, 155, 135, 61, 74, 173, 141, 242, 231, 187, 163, 39, 132])) == 0);
        return this._m_isCertRsa2048Sha256;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha1', {
      get: function() {
        ...
        this._m_isCertSha1 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([18, 165, 108, 130, 16, 207, 201, 74, 177, 135, 190, 1, 73, 102, 49, 189])) == 0);
        return this._m_isCertSha1;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha224', {
      get: function() {
        ...
        this._m_isCertSha224 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([51, 82, 110, 11, 92, 166, 201, 68, 148, 7, 217, 171, 131, 191, 200, 189])) == 0);
        return this._m_isCertSha224;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha256', {
      get: function() {
        ...
        this._m_isCertSha256 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([38, 22, 196, 193, 76, 80, 146, 64, 172, 169, 65, 249, 54, 147, 67, 40])) == 0);
        return this._m_isCertSha256;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha256X509', {
      get: function() {
        ...
        this._m_isCertSha256X509 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([146, 164, 210, 59, 192, 150, 121, 64, 180, 32, 252, 249, 142, 241, 3, 237])) == 0);
        return this._m_isCertSha256X509;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha384', {
      get: function() {
        ...
        this._m_isCertSha384 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([7, 83, 62, 255, 208, 159, 201, 72, 133, 241, 138, 213, 108, 112, 30, 1])) == 0);
        return this._m_isCertSha384;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha384X509', {
      get: function() {
        ...
        this._m_isCertSha384X509 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([110, 135, 118, 112, 194, 128, 230, 78, 170, 210, 40, 179, 73, 166, 134, 91])) == 0);
        return this._m_isCertSha384X509;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha512', {
      get: function() {
        ...
        this._m_isCertSha512 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([174, 15, 62, 9, 196, 166, 80, 79, 159, 27, 212, 30, 43, 137, 193, 154])) == 0);
        return this._m_isCertSha512;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertSha512X509', {
      get: function() {
        ...
        this._m_isCertSha512X509 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([99, 191, 109, 68, 2, 37, 218, 76, 188, 250, 36, 101, 210, 176, 254, 157])) == 0);
        return this._m_isCertSha512X509;
      }
    });
    ...
    Object.defineProperty(SignatureList.prototype, 'isCertX509', {
      get: function() {
        ...
        this._m_isCertX509 = (KaitaiStream.byteArrayCompare(this.signatureType, new Uint8Array([161, 89, 192, 165, 228, 148, 167, 74, 135, 181, 171, 21, 92, 43, 240, 114])) == 0);
        return this._m_isCertX509;
      }
    });
...
EfivarSignatureList_.EfivarSignatureList = EfivarSignatureList;
});
