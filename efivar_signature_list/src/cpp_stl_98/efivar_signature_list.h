#ifndef EFIVAR_SIGNATURE_LIST_H_
#define EFIVAR_SIGNATURE_LIST_H_
...
public:
    ...
    efivar_signature_list_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, efivar_signature_list_t* p__root = 0);
...
public:
    ...
    public:
        ...
        efi_var_attr_t(kaitai::kstream* p__io, efivar_signature_list_t* p__parent = 0, efivar_signature_list_t* p__root = 0);
    ...
    public:
        ...
        signature_data_t(kaitai::kstream* p__io, efivar_signature_list_t::signature_list_t* p__parent = 0, efivar_signature_list_t* p__root = 0);
    ...
    public:
        ...
        signature_list_t(kaitai::kstream* p__io, efivar_signature_list_t* p__parent = 0, efivar_signature_list_t* p__root = 0);
    ...
    private:
        ...
        std::string m_header;
        std::vector<signature_data_t*>* m_signatures;
        bool n_signatures;
    ...
    private:
        efivar_signature_list_t* m__root;
        efivar_signature_list_t* m__parent;
        std::vector<std::string>* m__raw_signatures;
    ...
    private:
        std::vector<kaitai::kstream*>* m__io__raw_signatures;
    ...
    public:
         ...
         */
        std::vector<signature_data_t*>* signatures() const { return m_signatures; }
        efivar_signature_list_t* _root() const { return m__root; }
        efivar_signature_list_t* _parent() const { return m__parent; }
        std::vector<std::string>* _raw_signatures() const { return m__raw_signatures; }
        std::vector<kaitai::kstream*>* _io__raw_signatures() const { return m__io__raw_signatures; }
    };

private:
    efi_var_attr_t* m_var_attributes;
    std::vector<signature_list_t*>* m_signatures;
    efivar_signature_list_t* m__root;
...
public:
     ...
     */
    efi_var_attr_t* var_attributes() const { return m_var_attributes; }
    std::vector<signature_list_t*>* signatures() const { return m_signatures; }
    efivar_signature_list_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};

#endif  // EFIVAR_SIGNATURE_LIST_H_
