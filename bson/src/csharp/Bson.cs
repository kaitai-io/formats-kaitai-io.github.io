...
namespace Kaitai
{
    ...
    public partial class Bson : KaitaiStruct
    {
        ...
        public Bson(KaitaiStream io, KaitaiStruct parent = null, Bson root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class Timestamp : KaitaiStruct
        {
            ...
            public Timestamp(KaitaiStream io, Bson.Element parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class BinData : KaitaiStruct
        {
            ...
            public BinData(KaitaiStream io, Bson.Element parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
            ...
            public partial class ByteArrayDeprecated : KaitaiStruct
            {
                ...
                public ByteArrayDeprecated(KaitaiStream io, Bson.BinData parent = null, Bson root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _read();
        ...
        public partial class ElementsList : KaitaiStruct
        {
            ...
            public ElementsList(KaitaiStream io, Bson parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Cstring : KaitaiStruct
        {
            ...
            public Cstring(KaitaiStream io, KaitaiStruct parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class String : KaitaiStruct
        {
            ...
            public String(KaitaiStream io, KaitaiStruct parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Element : KaitaiStruct
        {
            ...
            public Element(KaitaiStream io, Bson.ElementsList parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class DbPointer : KaitaiStruct
        {
            ...
            public DbPointer(KaitaiStream io, Bson.Element parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class U3 : KaitaiStruct
        {
            ...
            public U3(KaitaiStream io, Bson.ObjectId parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_value = false;
        ...
        public partial class CodeWithScope : KaitaiStruct
        {
            ...
            public CodeWithScope(KaitaiStream io, Bson.Element parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class F16 : KaitaiStruct
        {
            ...
            public F16(KaitaiStream io, Bson.Element parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class ObjectId : KaitaiStruct
        {
            ...
            public ObjectId(KaitaiStream io, KaitaiStruct parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class RegEx : KaitaiStruct
        {
            ...
            public RegEx(KaitaiStream io, Bson.Element parent = null, Bson root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
