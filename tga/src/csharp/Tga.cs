...
namespace Kaitai
{
    ...
    public partial class Tga : KaitaiStruct
    {
        ...
        public Tga(KaitaiStream io, KaitaiStruct parent = null, Tga root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            f_footer = false;
        ...
        public partial class TgaFooter : KaitaiStruct
        {
            ...
            public TgaFooter(KaitaiStream io, Tga parent = null, Tga root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_isValid = false;
        ...
        public partial class TgaExtArea : KaitaiStruct
        {
            ...
            public TgaExtArea(KaitaiStream io, Tga.TgaFooter parent = null, Tga root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
