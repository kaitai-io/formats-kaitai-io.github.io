...
public class MicrosoftCfb extends KaitaiStruct {
    ...
    public FatEntries fat() {
        ...
        KaitaiStream _io__raw_fat = new KaitaiStream(_raw_fat);
    ...
    public DirEntry dir() {
        ...
        this._raw_dir = this._io.readBytes(128);
        KaitaiStream _io__raw_dir = new KaitaiStream(_raw_dir);
        this.dir = new DirEntry(_io__raw_dir, this, _root);
        this._io.seek(_pos);
        return this.dir;
    }
