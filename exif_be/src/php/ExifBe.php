...
class ExifBe extends \Kaitai\Struct\Struct {
    public function __construct(\Kaitai\Struct\Stream $_io, \Kaitai\Struct\Struct $_parent = null, \ExifBe $_root = null) {
    ...
    public function ifd0() {
        ...
        $this->_m_ifd0 = new \ExifBe\Ifd($this->_io, $this, $this->_root);
        $this->_io->seek($_pos);
        return $this->_m_ifd0;
    }
...
class Ifd extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $n = $this->numFields();
        for ($i = 0; $i < $n; $i++) {
            $this->_m_fields[] = new \ExifBe\IfdField($this->_io, $this, $this->_root);
        }
    ...
    public function nextIfd() {
        ...
        if ($this->nextIfdOfs() != 0) {
            ...
            $this->_m_nextIfd = new \ExifBe\Ifd($this->_io, $this, $this->_root);
            $this->_io->seek($_pos);
        }
        return $this->_m_nextIfd;
    }
...
class IfdField extends \Kaitai\Struct\Struct {
    public function __construct(\Kaitai\Struct\Stream $_io, \ExifBe\Ifd $_parent = null, \ExifBe $_root = null) {
        parent::__construct($_io, $_parent, $_root);
        $this->_read();
    }
