...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Msgpack || (root.Msgpack = {}), root.KaitaiStream);
  }
})(typeof self !== 'undefined' ? self : this, function (Msgpack_, KaitaiStream) {
/**
...
var Msgpack = (function() {
  ...
  Msgpack.prototype._read = function() {
    ...
    if (this.isArray) {
      ...
      for (var i = 0; i < this.numArrayElements; i++) {
        this.arrayElements.push(new Msgpack(this._io, this, this._root));
      }
    }
    if (this.isMap16) {
  ...
  var MapTuple = Msgpack.MapTuple = (function() {
    ...
    MapTuple.prototype._read = function() {
      this.key = new Msgpack(this._io, this, this._root);
      this.value = new Msgpack(this._io, this, this._root);
    }
