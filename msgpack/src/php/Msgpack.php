    ...
    class Msgpack extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if ($this->isArray()) {
                ...
                for ($i = 0; $i < $n; $i++) {
                    $this->_m_arrayElements[] = new \Msgpack($this->_io, $this, $this->_root);
                }
            }
            if ($this->isMap16()) {
...
namespace Msgpack {
    class MapTuple extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_key = new \Msgpack($this->_io, $this, $this->_root);
            $this->_m_value = new \Msgpack($this->_io, $this, $this->_root);
        }
        protected $_m_key;
        protected $_m_value;
