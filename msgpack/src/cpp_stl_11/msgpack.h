...
public:
    ...
    msgpack_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, msgpack_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        map_tuple_t(kaitai::kstream* p__io, msgpack_t* p__parent = nullptr, msgpack_t* p__root = nullptr);
    ...
    private:
        std::unique_ptr<msgpack_t> m_key;
        std::unique_ptr<msgpack_t> m_value;
        msgpack_t* m__root;
        msgpack_t* m__parent;

    public:
        msgpack_t* key() const { return m_key.get(); }
        msgpack_t* value() const { return m_value.get(); }
...
private:
    std::unique_ptr<std::vector<std::unique_ptr<msgpack_t>>> m_array_elements;
...
private:
    std::unique_ptr<std::vector<std::unique_ptr<map_tuple_t>>> m_map_elements;
    bool n_map_elements;
...
public:
    ...
    std::vector<std::unique_ptr<msgpack_t>>* array_elements() const { return m_array_elements.get(); }
    ...
    std::vector<std::unique_ptr<map_tuple_t>>* map_elements() const { return m_map_elements.get(); }
    msgpack_t* _root() const { return m__root; }
