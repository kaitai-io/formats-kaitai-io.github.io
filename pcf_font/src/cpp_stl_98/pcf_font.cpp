...
std::set<pcf_font_t::types_t> pcf_font_t::_build_values_types_t() {
    std::set<pcf_font_t::types_t> _t;
    _t.insert(pcf_font_t::TYPES_PROPERTIES);
    _t.insert(pcf_font_t::TYPES_ACCELERATORS);
    _t.insert(pcf_font_t::TYPES_METRICS);
    _t.insert(pcf_font_t::TYPES_BITMAPS);
    _t.insert(pcf_font_t::TYPES_INK_METRICS);
    _t.insert(pcf_font_t::TYPES_BDF_ENCODINGS);
    _t.insert(pcf_font_t::TYPES_SWIDTHS);
    _t.insert(pcf_font_t::TYPES_GLYPH_NAMES);
    _t.insert(pcf_font_t::TYPES_BDF_ACCELERATORS);
    return _t;
}
const std::set<pcf_font_t::types_t> pcf_font_t::_values_types_t = pcf_font_t::_build_values_types_t();
