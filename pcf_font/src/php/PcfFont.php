...
namespace {
    class PcfFont extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_magic == "\x01\x66\x63\x70")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x01\x66\x63\x70", $this->_m_magic, $this->_io, "/seq/0");
            }
...
namespace PcfFont {
    class Types {
        ...
        private const _VALUES = [1 => true, 2 => true, 4 => true, 8 => true, 16 => true, 32 => true, 64 => true, 128 => true, 256 => true];
