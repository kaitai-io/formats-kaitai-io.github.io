...
java_class_t::constant_pool_entry_t* java_class_t::attribute_info_t::attr_body_code_t::exception_entry_t::catch_exception() {
    ...
    if (catch_type() != 0) {
        ...
        m_catch_exception = _root()->constant_pool()->at(catch_type() - 1).get();
    }
    return m_catch_exception;
}
...
const std::set<java_class_t::constant_pool_entry_t::tag_enum_t> java_class_t::constant_pool_entry_t::_values_tag_enum_t{
    java_class_t::constant_pool_entry_t::TAG_ENUM_UTF8,
    java_class_t::constant_pool_entry_t::TAG_ENUM_INTEGER,
    java_class_t::constant_pool_entry_t::TAG_ENUM_FLOAT,
    java_class_t::constant_pool_entry_t::TAG_ENUM_LONG,
    java_class_t::constant_pool_entry_t::TAG_ENUM_DOUBLE,
    java_class_t::constant_pool_entry_t::TAG_ENUM_CLASS_TYPE,
    java_class_t::constant_pool_entry_t::TAG_ENUM_STRING,
    java_class_t::constant_pool_entry_t::TAG_ENUM_FIELD_REF,
    java_class_t::constant_pool_entry_t::TAG_ENUM_METHOD_REF,
    java_class_t::constant_pool_entry_t::TAG_ENUM_INTERFACE_METHOD_REF,
    java_class_t::constant_pool_entry_t::TAG_ENUM_NAME_AND_TYPE,
    java_class_t::constant_pool_entry_t::TAG_ENUM_METHOD_HANDLE,
    java_class_t::constant_pool_entry_t::TAG_ENUM_METHOD_TYPE,
    java_class_t::constant_pool_entry_t::TAG_ENUM_DYNAMIC,
    java_class_t::constant_pool_entry_t::TAG_ENUM_INVOKE_DYNAMIC,
    java_class_t::constant_pool_entry_t::TAG_ENUM_MODULE,
    java_class_t::constant_pool_entry_t::TAG_ENUM_PACKAGE,
};
...
void java_class_t::constant_pool_entry_t::_read() {
    ...
    if (!(is_prev_two_entries())) {
        ...
        case java_class_t::constant_pool_entry_t::TAG_ENUM_DYNAMIC: {
            n_cp_info = false;
            m_cp_info = std::unique_ptr<dynamic_cp_info_t>(new dynamic_cp_info_t(m__io, this, m__root));
            break;
        }
        ...
        case java_class_t::constant_pool_entry_t::TAG_ENUM_MODULE: {
            n_cp_info = false;
            m_cp_info = std::unique_ptr<module_package_cp_info_t>(new module_package_cp_info_t(m__io, this, m__root));
            break;
        }
...
void java_class_t::dynamic_cp_info_t::_read() {
    m__unnamed0 = std::unique_ptr<version_guard_t>(new version_guard_t(55, m__io, this, m__root));
...
void java_class_t::invoke_dynamic_cp_info_t::_read() {
    m__unnamed0 = std::unique_ptr<version_guard_t>(new version_guard_t(51, m__io, this, m__root));
    m_bootstrap_method_attr_index = m__io->read_u2be();
    m_name_and_type_index = m__io->read_u2be();
}
...
const std::set<java_class_t::method_handle_cp_info_t::reference_kind_enum_t> java_class_t::method_handle_cp_info_t::_values_reference_kind_enum_t{
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_GET_FIELD,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_GET_STATIC,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_PUT_FIELD,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_PUT_STATIC,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_INVOKE_VIRTUAL,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_INVOKE_STATIC,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_INVOKE_SPECIAL,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_NEW_INVOKE_SPECIAL,
    java_class_t::method_handle_cp_info_t::REFERENCE_KIND_ENUM_INVOKE_INTERFACE,
};
...
void java_class_t::module_package_cp_info_t::_read() {
    m__unnamed0 = std::unique_ptr<version_guard_t>(new version_guard_t(53, m__io, this, m__root));
    m_name_index = m__io->read_u2be();
}
