...
our $TAG_ENUM_DYNAMIC = 17;
our $TAG_ENUM_INVOKE_DYNAMIC = 18;
our $TAG_ENUM_MODULE = 19;
our $TAG_ENUM_PACKAGE = 20;
...
sub _read {
    ...
    if (!($self->is_prev_two_entries())) {
        my $_on = $self->tag();
        if ($_on == $JavaClass::ConstantPoolEntry::TAG_ENUM_CLASS_TYPE) {
        ...
        elsif ($_on == $JavaClass::ConstantPoolEntry::TAG_ENUM_DYNAMIC) {
            $self->{cp_info} = JavaClass::DynamicCpInfo->new($self->{_io}, $self, $self->{_root});
        }
        ...
        elsif ($_on == $JavaClass::ConstantPoolEntry::TAG_ENUM_INTERFACE_METHOD_REF) {
        ...
        elsif ($_on == $JavaClass::ConstantPoolEntry::TAG_ENUM_MODULE) {
            $self->{cp_info} = JavaClass::ModulePackageCpInfo->new($self->{_io}, $self, $self->{_root});
        }
        ...
        elsif ($_on == $JavaClass::ConstantPoolEntry::TAG_ENUM_PACKAGE) {
            $self->{cp_info} = JavaClass::ModulePackageCpInfo->new($self->{_io}, $self, $self->{_root});
        }
...
########################################################################
package JavaClass::DynamicCpInfo;
...
sub _read {
    ...
    $self->{_unnamed0} = JavaClass::VersionGuard->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package JavaClass::ModulePackageCpInfo;
...
########################################################################
package JavaClass::VersionGuard;
