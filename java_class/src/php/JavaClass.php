...
namespace {
    class JavaClass extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_m_versionMajor >= 43)) {
                throw new \Kaitai\Struct\Error\ValidationLessThanError(43, $this->_m_versionMajor, $this->_io, "/seq/2");
            }
...
namespace JavaClass\ConstantPoolEntry {
    class TagEnum {
        ...
        private const _VALUES = [1 => true, 3 => true, 4 => true, 5 => true, 6 => true, 7 => true, 8 => true, 9 => true, 10 => true, 11 => true, 12 => true, 15 => true, 16 => true, 17 => true, 18 => true, 19 => true, 20 => true];
    ...
    class VersionGuard extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->_root()->versionMajor() >= $this->major())) {
                throw new \Kaitai\Struct\Error\ValidationExprError($this->_m__unnamed0, $this->_io, "/types/version_guard/seq/0");
            }
        }
        protected $_m__unnamed0;
        protected $_m_major;
