...
public:
    ...
    public:
        ...
        mac_flags_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, packet_ppi_t* p__root = nullptr);
    ...
    public:
        ...
        packet_ppi_header_t(kaitai::kstream* p__io, packet_ppi_t* p__parent = nullptr, packet_ppi_t* p__root = nullptr);
    ...
    public:
        ...
        radio_802_11_common_body_t(kaitai::kstream* p__io, packet_ppi_t::packet_ppi_field_t* p__parent = nullptr, packet_ppi_t* p__root = nullptr);
    ...
    public:
        ...
        radio_802_11n_mac_phy_ext_body_t(kaitai::kstream* p__io, packet_ppi_t::packet_ppi_field_t* p__parent = nullptr, packet_ppi_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            channel_flags_t(kaitai::kstream* p__io, packet_ppi_t::radio_802_11n_mac_phy_ext_body_t* p__parent = nullptr, packet_ppi_t* p__root = nullptr);
        ...
        public:
            ...
            signal_noise_t(kaitai::kstream* p__io, packet_ppi_t::radio_802_11n_mac_phy_ext_body_t* p__parent = nullptr, packet_ppi_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<std::vector<uint8_t>> m_rssi_ant_ctl;
        std::unique_ptr<std::vector<uint8_t>> m_rssi_ant_ext;
        uint16_t m_ext_channel_freq;
        std::unique_ptr<channel_flags_t> m_ext_channel_flags;
        std::unique_ptr<std::vector<std::unique_ptr<signal_noise_t>>> m_rf_signal_noise;
        std::unique_ptr<std::vector<uint32_t>> m_evm;
        packet_ppi_t* m__root;
        packet_ppi_t::packet_ppi_field_t* m__parent;
    ...
    public:
         ...
         */
        std::vector<uint8_t>* rssi_ant_ctl() const { return m_rssi_ant_ctl.get(); }

        /**
         * RSSI (Received Signal Strength Indication) for antennas 0-3, extension channel
         */
        std::vector<uint8_t>* rssi_ant_ext() const { return m_rssi_ant_ext.get(); }
         ...
         */
        channel_flags_t* ext_channel_flags() const { return m_ext_channel_flags.get(); }

        /**
         * Signal + noise values for antennas 0-3
         */
        std::vector<std::unique_ptr<signal_noise_t>>* rf_signal_noise() const { return m_rf_signal_noise.get(); }

        /**
         * EVM (Error Vector Magnitude) for chains 0-3
         */
        std::vector<uint32_t>* evm() const { return m_evm.get(); }
        packet_ppi_t* _root() const { return m__root; }
        packet_ppi_t::packet_ppi_field_t* _parent() const { return m__parent; }
    };

private:
    std::unique_ptr<packet_ppi_header_t> m_header;
    std::unique_ptr<packet_ppi_fields_t> m_fields;
    std::unique_ptr<kaitai::kstruct> m_body;
    bool n_body;
...
private:
    ...
    std::unique_ptr<kaitai::kstream> m__io__raw_fields;
    std::string m__raw_body;
    std::unique_ptr<kaitai::kstream> m__io__raw_body;

public:
    packet_ppi_header_t* header() const { return m_header.get(); }
    packet_ppi_fields_t* fields() const { return m_fields.get(); }
    kaitai::kstruct* body() const { return m_body.get(); }
    packet_ppi_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
    std::string _raw_fields() const { return m__raw_fields; }
    kaitai::kstream* _io__raw_fields() const { return m__io__raw_fields.get(); }
    std::string _raw_body() const { return m__raw_body; }
    kaitai::kstream* _io__raw_body() const { return m__io__raw_body.get(); }
};
