...
std::set<phar_without_stub_t::signature_type_t> phar_without_stub_t::_build_values_signature_type_t() {
    std::set<phar_without_stub_t::signature_type_t> _t;
    _t.insert(phar_without_stub_t::SIGNATURE_TYPE_MD5);
    _t.insert(phar_without_stub_t::SIGNATURE_TYPE_SHA1);
    _t.insert(phar_without_stub_t::SIGNATURE_TYPE_SHA256);
    _t.insert(phar_without_stub_t::SIGNATURE_TYPE_SHA512);
    _t.insert(phar_without_stub_t::SIGNATURE_TYPE_OPENSSL);
    return _t;
}
const std::set<phar_without_stub_t::signature_type_t> phar_without_stub_t::_values_signature_type_t = phar_without_stub_t::_build_values_signature_type_t();
