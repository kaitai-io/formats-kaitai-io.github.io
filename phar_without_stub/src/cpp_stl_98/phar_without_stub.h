#ifndef PHAR_WITHOUT_STUB_H_
#define PHAR_WITHOUT_STUB_H_
...
public:
    ...
    public:
        ...
        api_version_t(kaitai::kstream* p__io, phar_without_stub_t::manifest_t* p__parent = 0, phar_without_stub_t* p__root = 0);
    ...
    public:
        ...
        global_flags_t(kaitai::kstream* p__io, phar_without_stub_t::manifest_t* p__parent = 0, phar_without_stub_t* p__root = 0);
    ...
    public:
        ...
        manifest_t(kaitai::kstream* p__io, phar_without_stub_t* p__parent = 0, phar_without_stub_t* p__root = 0);
    ...
    private:
        ...
        api_version_t* m_api_version;
        global_flags_t* m_flags;
    ...
    private:
        std::vector<file_entry_t*>* m_file_entries;
        phar_without_stub_t* m__root;
    ...
    public:
         ...
         */
        api_version_t* api_version() const { return m_api_version; }

        /**
         * Global flags for this phar.
         */
        global_flags_t* flags() const { return m_flags; }
         ...
         */
        std::vector<file_entry_t*>* file_entries() const { return m_file_entries; }
        phar_without_stub_t* _root() const { return m__root; }
...
private:
    kaitai::kstream* m__io__raw_signature;
...
public:
     ...
     * and its files.
     */
    manifest_t* manifest() const { return m_manifest; }
    ...
    kaitai::kstream* _io__raw_signature() const { return m__io__raw_signature; }
};

#endif  // PHAR_WITHOUT_STUB_H_
