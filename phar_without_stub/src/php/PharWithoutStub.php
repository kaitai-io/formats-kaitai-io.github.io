...
class Signature extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $this->_m_magic = $this->_io->ensureFixedContents("\x47\x42\x4D\x42");
    }
    protected $_m_data;
    protected $_m_type;
    protected $_m_magic;
...
class ApiVersion extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_release = $this->_io->readBitsInt(4);
        $this->_m_major = $this->_io->readBitsInt(4);
        $this->_m_minor = $this->_io->readBitsInt(4);
        $this->_m_unused = $this->_io->readBitsInt(4);
    }
