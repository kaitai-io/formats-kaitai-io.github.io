...
std::set<ruby_marshal_t::codes_t> ruby_marshal_t::_build_values_codes_t() {
    std::set<ruby_marshal_t::codes_t> _t;
    _t.insert(ruby_marshal_t::CODES_RUBY_STRING);
    _t.insert(ruby_marshal_t::CODES_CONST_NIL);
    _t.insert(ruby_marshal_t::CODES_RUBY_SYMBOL);
    _t.insert(ruby_marshal_t::CODES_RUBY_SYMBOL_LINK);
    _t.insert(ruby_marshal_t::CODES_RUBY_OBJECT_LINK);
    _t.insert(ruby_marshal_t::CODES_CONST_FALSE);
    _t.insert(ruby_marshal_t::CODES_INSTANCE_VAR);
    _t.insert(ruby_marshal_t::CODES_RUBY_STRUCT);
    _t.insert(ruby_marshal_t::CODES_CONST_TRUE);
    _t.insert(ruby_marshal_t::CODES_RUBY_ARRAY);
    _t.insert(ruby_marshal_t::CODES_PACKED_INT);
    _t.insert(ruby_marshal_t::CODES_BIGNUM);
    _t.insert(ruby_marshal_t::CODES_RUBY_HASH);
    return _t;
}
const std::set<ruby_marshal_t::codes_t> ruby_marshal_t::_values_codes_t = ruby_marshal_t::_build_values_codes_t();
