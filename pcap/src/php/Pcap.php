...
namespace {
    class Pcap extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_magicNumber = $this->_io->readU4be();
    ...
    class Header extends \Kaitai\Struct\Struct {
        ...
        private function _readLE() {
            ...
            if (!($this->_m_versionMajor == 2)) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError(2, $this->_m_versionMajor, $this->_io, "/types/header/seq/0");
            }
        ...
        private function _readBE() {
            ...
            $this->_m_thiszone = $this->_io->readS4be();
            $this->_m_sigfigs = $this->_io->readU4be();
            $this->_m_snaplen = $this->_io->readU4be();
            $this->_m_network = $this->_io->readU4be();
        }
...
namespace Pcap {
    class Packet extends \Kaitai\Struct\Struct {
        ...
        private function _readBE() {
            $this->_m_tsSec = $this->_io->readU4be();
            $this->_m_tsUsec = $this->_io->readU4be();
            $this->_m_inclLen = $this->_io->readU4be();
            $this->_m_origLen = $this->_io->readU4be();
            switch ($this->_root()->hdr()->network()) {
                case \Pcap\Linktype::ETHERNET:
                    $this->_m__raw_body = $this->_io->readBytes(($this->inclLen() < $this->_root()->hdr()->snaplen() ? $this->inclLen() : $this->_root()->hdr()->snaplen()));
                    $_io__raw_body = new \Kaitai\Struct\Stream($this->_m__raw_body);
...
namespace Pcap {
    class Magic {
        const LE_NANOSECONDS = 1295823521;
        const BE_NANOSECONDS = 2712812621;
        const BE_MICROSECONDS = 2712847316;
        const LE_MICROSECONDS = 3569595041;

        private const _VALUES = [1295823521 => true, 2712812621 => true, 2712847316 => true, 3569595041 => true];
