...
namespace Kaitai
{
    ...
    public partial class GenmidiOp2 : KaitaiStruct
    {
        ...
        public GenmidiOp2(KaitaiStream io, KaitaiStruct parent = null, GenmidiOp2 root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _read();
        ...
        public partial class InstrumentEntry : KaitaiStruct
        {
            ...
            public InstrumentEntry(KaitaiStream io, GenmidiOp2 parent = null, GenmidiOp2 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Instrument : KaitaiStruct
        {
            ...
            public Instrument(KaitaiStream io, GenmidiOp2.InstrumentEntry parent = null, GenmidiOp2 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class OpSettings : KaitaiStruct
        {
            ...
            public OpSettings(KaitaiStream io, GenmidiOp2.Instrument parent = null, GenmidiOp2 root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
