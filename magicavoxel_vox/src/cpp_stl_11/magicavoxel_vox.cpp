...
const std::set<magicavoxel_vox_t::chunk_type_t> magicavoxel_vox_t::_values_chunk_type_t{
    magicavoxel_vox_t::CHUNK_TYPE_MAIN,
    magicavoxel_vox_t::CHUNK_TYPE_MATT,
    magicavoxel_vox_t::CHUNK_TYPE_PACK,
    magicavoxel_vox_t::CHUNK_TYPE_RGBA,
    magicavoxel_vox_t::CHUNK_TYPE_SIZE,
    magicavoxel_vox_t::CHUNK_TYPE_XYZI,
};
...
const std::set<magicavoxel_vox_t::material_type_t> magicavoxel_vox_t::_values_material_type_t{
    magicavoxel_vox_t::MATERIAL_TYPE_DIFFUSE,
    magicavoxel_vox_t::MATERIAL_TYPE_METAL,
    magicavoxel_vox_t::MATERIAL_TYPE_GLASS,
    magicavoxel_vox_t::MATERIAL_TYPE_EMISSIVE,
};
...
const std::set<magicavoxel_vox_t::property_bits_type_t> magicavoxel_vox_t::_values_property_bits_type_t{
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_PLASTIC,
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_ROUGHNESS,
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_SPECULAR,
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_IOR,
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_ATTENUATION,
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_POWER,
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_GLOW,
    magicavoxel_vox_t::PROPERTY_BITS_TYPE_IS_TOTAL_POWER,
};
