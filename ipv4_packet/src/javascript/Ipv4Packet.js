...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.Ipv4Packet || (root.Ipv4Packet = {}), root.KaitaiStream, root.ProtocolBody || (root.ProtocolBody = {}));
  }
})(typeof self !== 'undefined' ? self : this, function (Ipv4Packet_, KaitaiStream, ProtocolBody_) {
var Ipv4Packet = (function() {
  ...
  Ipv4Packet.prototype._read = function() {
    ...
    this.body = new ProtocolBody_.ProtocolBody(_io__raw_body, null, null, this.protocol);
  }
...
Ipv4Packet_.Ipv4Packet = Ipv4Packet;
});
