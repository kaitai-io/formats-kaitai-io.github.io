...
public:
    ...
    static bool _is_defined_psfb_subtype_t(psfb_subtype_t v);

private:
    static const std::set<psfb_subtype_t> _values_psfb_subtype_t;
    static std::set<psfb_subtype_t> _build_values_psfb_subtype_t();
...
public:
    ...
    static bool _is_defined_rtpfb_subtype_t(rtpfb_subtype_t v);

private:
    static const std::set<rtpfb_subtype_t> _values_rtpfb_subtype_t;
    static std::set<rtpfb_subtype_t> _build_values_rtpfb_subtype_t();
...
public:
    ...
    static bool _is_defined_sdes_subtype_t(sdes_subtype_t v);

private:
    static const std::set<sdes_subtype_t> _values_sdes_subtype_t;
    static std::set<sdes_subtype_t> _build_values_sdes_subtype_t();
