...
std::set<rtcp_payload_t::payload_type_t> rtcp_payload_t::_build_values_payload_type_t() {
    std::set<rtcp_payload_t::payload_type_t> _t;
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_FIR);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_NACK);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_IJ);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_SR);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_RR);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_SDES);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_BYE);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_APP);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_RTPFB);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_PSFB);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_XR);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_AVB);
    _t.insert(rtcp_payload_t::PAYLOAD_TYPE_RSI);
    return _t;
}
const std::set<rtcp_payload_t::payload_type_t> rtcp_payload_t::_values_payload_type_t = rtcp_payload_t::_build_values_payload_type_t();
...
std::set<rtcp_payload_t::psfb_subtype_t> rtcp_payload_t::_build_values_psfb_subtype_t() {
    std::set<rtcp_payload_t::psfb_subtype_t> _t;
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_PLI);
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_SLI);
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_RPSI);
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_FIR);
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_TSTR);
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_TSTN);
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_VBCM);
    _t.insert(rtcp_payload_t::PSFB_SUBTYPE_AFB);
    return _t;
}
const std::set<rtcp_payload_t::psfb_subtype_t> rtcp_payload_t::_values_psfb_subtype_t = rtcp_payload_t::_build_values_psfb_subtype_t();
...
std::set<rtcp_payload_t::rtpfb_subtype_t> rtcp_payload_t::_build_values_rtpfb_subtype_t() {
    std::set<rtcp_payload_t::rtpfb_subtype_t> _t;
    _t.insert(rtcp_payload_t::RTPFB_SUBTYPE_NACK);
    _t.insert(rtcp_payload_t::RTPFB_SUBTYPE_TMMBR);
    _t.insert(rtcp_payload_t::RTPFB_SUBTYPE_TMMBN);
    _t.insert(rtcp_payload_t::RTPFB_SUBTYPE_RRR);
    _t.insert(rtcp_payload_t::RTPFB_SUBTYPE_TRANSPORT_FEEDBACK);
    return _t;
}
const std::set<rtcp_payload_t::rtpfb_subtype_t> rtcp_payload_t::_values_rtpfb_subtype_t = rtcp_payload_t::_build_values_rtpfb_subtype_t();
...
std::set<rtcp_payload_t::sdes_subtype_t> rtcp_payload_t::_build_values_sdes_subtype_t() {
    std::set<rtcp_payload_t::sdes_subtype_t> _t;
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_PAD);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_CNAME);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_NAME);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_EMAIL);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_PHONE);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_LOC);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_TOOL);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_NOTE);
    _t.insert(rtcp_payload_t::SDES_SUBTYPE_PRIV);
    return _t;
}
const std::set<rtcp_payload_t::sdes_subtype_t> rtcp_payload_t::_values_sdes_subtype_t = rtcp_payload_t::_build_values_sdes_subtype_t();
