...
namespace MachO\CsBlob\BlobIndex {
    class CsslotType {
        ...
        private const _VALUES = [0 => true, 1 => true, 2 => true, 3 => true, 4 => true, 5 => true, 7 => true, 4096 => true, 65536 => true];
...
namespace MachO\CsBlob\Expr {
    class OpEnum {
        ...
        private const _VALUES = [0 => true, 1 => true, 2 => true, 3 => true, 4 => true, 5 => true, 6 => true, 7 => true, 8 => true, 9 => true, 10 => true, 11 => true, 12 => true, 13 => true, 14 => true, 15 => true, 16 => true];
...
namespace MachO\CsBlob {
    class CsMagic {
        ...
        private const _VALUES = [4208855809 => true, 4208856064 => true, 4208856065 => true, 4208856066 => true, 4208856256 => true, 4208856257 => true, 4208882033 => true, 4208882034 => true];
...
namespace MachO\DyldInfoCommand\RebaseData {
    class Opcode {
        ...
        private const _VALUES = [0 => true, 16 => true, 32 => true, 48 => true, 64 => true, 80 => true, 96 => true, 112 => true, 128 => true];
...
namespace MachO\DyldInfoCommand {
    class BindOpcode {
        ...
        private const _VALUES = [0 => true, 16 => true, 32 => true, 48 => true, 64 => true, 80 => true, 96 => true, 112 => true, 128 => true, 144 => true, 160 => true, 176 => true, 192 => true];
        ...
        private function _read() {
            ...
            switch ($this->type()) {
                case \MachO\LoadCommandType::BUILD_VERSION:
                    ...
                    $_io__raw_body = new \Kaitai\Struct\Stream($this->_m__raw_body);
                    $this->_m_body = new \MachO\BuildVersionCommand($_io__raw_body, $this, $this->_root);
                    break;
                ...
                case \MachO\LoadCommandType::SEGMENT:
                    $this->_m__raw_body = $this->_io->readBytes($this->size() - 8);
                    $_io__raw_body = new \Kaitai\Struct\Stream($this->_m__raw_body);
                    $this->_m_body = new \MachO\SegmentCommand($_io__raw_body, $this, $this->_root);
                    break;
...
namespace MachO {
    class VmProt extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            $this->_m_stripRead = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_isMask = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_reserved0 = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_copy = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_noChange = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_execute = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_write = $this->_io->readBitsIntBe(1) != 0;
            $this->_m_read = $this->_io->readBitsIntBe(1) != 0;
...
namespace MachO {
    class CpuType {
        ...
        private const _VALUES = [1 => true, 2 => true, 4 => true, 5 => true, 7 => true, 8 => true, 9 => true, 11 => true, 12 => true, 13 => true, 14 => true, 15 => true, 16 => true, 17 => true, 18 => true, 16777216 => true, 16777223 => true, 16777228 => true, 16777234 => true, 4294967295 => true];
...
namespace MachO {
    class FileType {
        ...
        private const _VALUES = [1 => true, 2 => true, 3 => true, 4 => true, 5 => true, 6 => true, 7 => true, 8 => true, 9 => true, 10 => true, 11 => true];
...
namespace MachO {
    class LoadCommandType {
        ...
        private const _VALUES = [1 => true, 2 => true, 3 => true, 4 => true, 5 => true, 6 => true, 7 => true, 8 => true, 9 => true, 10 => true, 11 => true, 12 => true, 13 => true, 14 => true, 15 => true, 16 => true, 17 => true, 18 => true, 19 => true, 20 => true, 21 => true, 22 => true, 23 => true, 25 => true, 26 => true, 27 => true, 29 => true, 30 => true, 32 => true, 33 => true, 34 => true, 36 => true, 37 => true, 38 => true, 39 => true, 41 => true, 42 => true, 43 => true, 44 => true, 45 => true, 46 => true, 47 => true, 48 => true, 50 => true, 2147483648 => true, 2147483672 => true, 2147483676 => true, 2147483679 => true, 2147483682 => true, 2147483683 => true, 2147483688 => true];
...
namespace MachO {
    class MagicType {
        ...
        private const _VALUES = [3472551422 => true, 3489328638 => true, 4277009102 => true, 4277009103 => true];
