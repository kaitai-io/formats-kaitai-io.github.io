...
private:
    ...
    static std::set<cpu_type_t> _build_values_cpu_type_t();
...
private:
    ...
    static std::set<load_command_type_t> _build_values_load_command_type_t();
...
private:
    ...
    static std::set<magic_type_t> _build_values_magic_type_t();
...
public:
    ...
    private:
        ...
        static std::set<cs_magic_t> _build_values_cs_magic_t();
    ...
    public:
        ...
        private:
            ...
            static std::set<csslot_type_t> _build_values_csslot_type_t();
        ...
        private:
            ...
            static std::set<cert_slot_t> _build_values_cert_slot_t();
        ...
        private:
            ...
            static std::set<op_enum_t> _build_values_op_enum_t();
        ...
        private:
            ...
            static std::set<op_t> _build_values_op_t();
        ...
        private:
            ...
            static std::set<requirement_type_t> _build_values_requirement_type_t();
    ...
    private:
        ...
        static std::set<bind_opcode_t> _build_values_bind_opcode_t();
