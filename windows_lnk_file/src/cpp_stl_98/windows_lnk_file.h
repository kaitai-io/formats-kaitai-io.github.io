...
public:
    ...
    static bool _is_defined_drive_types_t(drive_types_t v);

private:
    static const std::set<drive_types_t> _values_drive_types_t;
    static std::set<drive_types_t> _build_values_drive_types_t();
...
public:
    ...
    static bool _is_defined_window_state_t(window_state_t v);

private:
    static const std::set<window_state_t> _values_window_state_t;
    static std::set<window_state_t> _build_values_window_state_t();
