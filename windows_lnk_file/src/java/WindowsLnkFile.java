...
public class WindowsLnkFile extends KaitaiStruct {
    ...
    public static class FileHeader extends KaitaiStruct {
        ...
        private void _read() {
            ...
            this.flags = new LinkFlags(_io_flags, this, _root);
    ...
    public static class LinkInfo extends KaitaiStruct {
        ...
        private void _read() {
            ...
            KaitaiStream _io_all = this._io.substream(lenAll() - 4);
            this.all = new All(_io_all, this, _root);
        }
        ...
        public static class All extends KaitaiStruct {
            ...
            private void _read() {
                ...
                KaitaiStream _io_header = this._io.substream(lenHeader() - 8);
        ...
        public static class VolumeIdSpec extends KaitaiStruct {
            ...
            private void _read() {
                this.lenAll = this._io.readU4le();
                KaitaiStream _io_body = this._io.substream(lenAll() - 4);
                this.body = new VolumeIdBody(_io_body, this, _root);
            }
    ...
    public static class LinkTargetIdList extends KaitaiStruct {
        ...
        private void _read() {
            ...
            KaitaiStream _io_idList = this._io.substream(lenIdList());
            this.idList = new WindowsShellItems(_io_idList);
        }
