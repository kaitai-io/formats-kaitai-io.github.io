...
const std::set<windows_lnk_file_t::drive_types_t> windows_lnk_file_t::_values_drive_types_t{
    windows_lnk_file_t::DRIVE_TYPES_UNKNOWN,
    windows_lnk_file_t::DRIVE_TYPES_NO_ROOT_DIR,
    windows_lnk_file_t::DRIVE_TYPES_REMOVABLE,
    windows_lnk_file_t::DRIVE_TYPES_FIXED,
    windows_lnk_file_t::DRIVE_TYPES_REMOTE,
    windows_lnk_file_t::DRIVE_TYPES_CDROM,
    windows_lnk_file_t::DRIVE_TYPES_RAMDISK,
};
...
const std::set<windows_lnk_file_t::window_state_t> windows_lnk_file_t::_values_window_state_t{
    windows_lnk_file_t::WINDOW_STATE_NORMAL,
    windows_lnk_file_t::WINDOW_STATE_MAXIMIZED,
    windows_lnk_file_t::WINDOW_STATE_MIN_NO_ACTIVE,
};
