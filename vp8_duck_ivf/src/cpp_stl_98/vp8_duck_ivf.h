#ifndef VP8_DUCK_IVF_H_
#define VP8_DUCK_IVF_H_
...
public:
    ...
    public:
        ...
        block_t(kaitai::kstream* p__io, vp8_duck_ivf_t::blocks_t* p__parent = 0, vp8_duck_ivf_t* p__root = 0);
