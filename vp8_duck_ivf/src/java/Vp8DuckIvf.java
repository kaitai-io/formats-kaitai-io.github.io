 ...
 */
public class Vp8DuckIvf extends KaitaiStruct {
    ...
    public Vp8DuckIvf(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public Vp8DuckIvf(KaitaiStream _io, KaitaiStruct _parent, Vp8DuckIvf _root) {
        super(_io);
