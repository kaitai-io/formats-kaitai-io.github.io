 ...
 * \sa http://acritum.com/winrar/rar-format 
 */
...
public:
    ...
    private:
        ...
        std::unique_ptr<dos_time_t> m_file_time;
    ...
    public:
         ...
         */
        dos_time_t* file_time() const { return m_file_time.get(); }
    ...
    public:
        ...
        dos_time_t(kaitai::kstream* p__io, rar_t::block_file_header_t* p__parent = nullptr, rar_t* p__root = nullptr);
