...
public:
    ...
    public:
        ...
        exe_header_t(kaitai::kstream* p__io, dos_mz_t* p__parent = 0, dos_mz_t* p__root = 0);
    ...
    public:
        mz_header_t* mz() const { return m_mz; }
    ...
    public:
        ...
        mz_header_t(kaitai::kstream* p__io, dos_mz_t::exe_header_t* p__parent = 0, dos_mz_t* p__root = 0);
...
private:
    exe_header_t* m_header;
    std::string m_body;
    dos_mz_t* m__root;
    kaitai::kstruct* m__parent;

public:
    exe_header_t* header() const { return m_header; }
