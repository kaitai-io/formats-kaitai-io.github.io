...
private:
    ...
    static std::set<field_type_t> _build_values_field_type_t();
...
private:
    ...
    static std::set<gps_tag_t> _build_values_gps_tag_t();
...
private:
    ...
    static std::set<tag_t> _build_values_tag_t();
...
public:
    ...
    public:
        ...
        exif_body_t(kaitai::kstream* p__io, exif_t* p__parent = 0, exif_t* p__root = 0);
    ...
    public:
        ...
        public:
            ...
            ascii_string_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            doubles_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            floats_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            std::vector<float>* values() const { return m_values; }
            exif_t* _root() const { return m__root; }
            exif_t::exif_body_t::ifd_field_t* _parent() const { return m__parent; }
        };
        ...
        public:
            ...
            ifd_t(bool p_is_gps_ifd, kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        private:
            ...
            std::vector<std::string>* m__raw_fields;
            std::vector<kaitai::kstream*>* m__io__raw_fields;
        ...
        public:
            ...
            std::vector<std::string>* _raw_fields() const { return m__raw_fields; }
            std::vector<kaitai::kstream*>* _io__raw_fields() const { return m__io__raw_fields; }
        };
        ...
        public:
            ...
            ifd_field_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            longs_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            rational_t(kaitai::kstream* p__io, exif_t::exif_body_t::rationals_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            rationals_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        private:
            std::vector<rational_t*>* m_values;
            exif_t* m__root;
            exif_t::exif_body_t::ifd_field_t* m__parent;

        public:
            std::vector<rational_t*>* values() const { return m_values; }
            exif_t* _root() const { return m__root; }
            exif_t::exif_body_t::ifd_field_t* _parent() const { return m__parent; }
        };
        ...
        public:
            ...
            sbytes_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            std::vector<int8_t>* values() const { return m_values; }
            exif_t* _root() const { return m__root; }
            exif_t::exif_body_t::ifd_field_t* _parent() const { return m__parent; }
        };
        ...
        public:
            ...
            shorts_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            slongs_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            std::vector<int32_t>* values() const { return m_values; }
            exif_t* _root() const { return m__root; }
            exif_t::exif_body_t::ifd_field_t* _parent() const { return m__parent; }
        };
        ...
        public:
            ...
            srational_t(kaitai::kstream* p__io, exif_t::exif_body_t::srationals_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            srationals_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        private:
            std::vector<srational_t*>* m_values;
            exif_t* m__root;
            exif_t::exif_body_t::ifd_field_t* m__parent;

        public:
            std::vector<srational_t*>* values() const { return m_values; }
            exif_t* _root() const { return m__root; }
            exif_t::exif_body_t::ifd_field_t* _parent() const { return m__parent; }
        };
        ...
        public:
            ...
            sshorts_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
        ...
        public:
            ...
            utf8_string_t(kaitai::kstream* p__io, exif_t::exif_body_t::ifd_field_t* p__parent = 0, exif_t* p__root = 0, int p_is_le = -1);
...
public:
    ...
    exif_body_t* body() const { return m_body; }
    exif_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};
