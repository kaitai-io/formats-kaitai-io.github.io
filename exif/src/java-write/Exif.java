...
public class Exif extends KaitaiStruct.ReadWrite {
    ...
    public static class ExifBody extends KaitaiStruct.ReadWrite {
        ...
        private void _write_SeqLE() {
            ...
            this._io.writeU4le(this.ifd0Ofs);
        }

        private void _write_SeqBE() {
            _shouldWriteIfd0 = _enabledIfd0;
            this._io.writeU2be(this.version);
            this._io.writeU4be(this.ifd0Ofs);
        }
        ...
        public static class Ifd extends KaitaiStruct.ReadWrite {
            ...
            public Ifd(KaitaiStream _io, KaitaiStruct.ReadWrite _parent, Exif _root, boolean _is_le) {
                super(_io);
                this._parent = _parent;
                this._root = _root;
                this._is_le = _is_le;
            ...
            private void _readLE() {
                ...
                for (int i = 0; i < numFields(); i++) {
                    IfdField _t_fields = new IfdField(this._io, this, _root, _is_le);
                    try {
                        _t_fields._read();
                    } finally {
            ...
            private void _write_SeqLE() {
                ...
                this._io.writeU4le(this.nextIfdOfs);
            }
            ...
            private void _write_SeqBE() {
                ...
                this._io.writeU4be(this.nextIfdOfs);
            }
            ...
            public void setNextIfdOfs(long _v) { _dirty = true; nextIfdOfs = _v; }
        ...
        public static class IfdField extends KaitaiStruct.ReadWrite {
                ...
                if (_enabledData) {
                    if (!(isImmediateData())) {
                        if (this.data.length != byteLength())
                            throw new ConsistencyError("data", byteLength(), this.data.length);
                    }
                }
                _dirty = false;
            }
            ...
            public void _invalidateByteLength() { this.byteLength = null; }
            private byte[] data;
            ...
            public void _invalidateIsImmediateData() { this.isImmediateData = null; }
            ...
            public void _invalidateTypeByteLength() { this.typeByteLength = null; }
            private TagEnum tag;
            ...
            public void setFieldType(FieldTypeEnum _v) { _dirty = true; fieldType = _v; }
            public long length() { return length; }
            public void setLength(long _v) { _dirty = true; length = _v; }
            public long ofsOrData() { return ofsOrData; }
            public void setOfsOrData(long _v) { _dirty = true; ofsOrData = _v; }
            public Exif _root() { return _root; }
            public void set_root(Exif _v) { _dirty = true; _root = _v; }
        ...
        public void setIfd0Ofs(long _v) { _dirty = true; ifd0Ofs = _v; }
        public Exif _root() { return _root; }
        public void set_root(Exif _v) { _dirty = true; _root = _v; }
