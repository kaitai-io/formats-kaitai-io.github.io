...
class Exif(ReadWriteKaitaiStruct):
    ...
    * <https://github.com/libexif/libexif-testsuite/tree/8c1f5bbc18d2cbc80b01b3f9b3eb29546310acf2> (15/18 .jpg)
    ...
    def _write__seq(self, io=None):
        super(Exif, self)._write__seq(io)
        self._io.write_u2le(self.endianness)
    ...
    class ExifBody(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Exif.ExifBody, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._should_write_ifd0 = False
            self.ifd0__enabled = True
        ...
        def _write__seq(self, io=None):
            super(Exif.ExifBody, self)._write__seq(io)
            if not hasattr(self, '_is_le'):
                raise kaitaistruct.UndecidedEndiannessError("/types/exif_body")
            elif self._is_le == True:
                self._write__seq_le()
        ...
        def _write__seq_le(self):
            self._should_write_ifd0 = self.ifd0__enabled
            self._io.write_u2le(self.magic)
            self._io.write_u4le(self.ofs_ifd0)


        def _write__seq_be(self):
            self._should_write_ifd0 = self.ifd0__enabled
            self._io.write_u2be(self.magic)
            self._io.write_u4be(self.ofs_ifd0)


        def _check(self):
            if not self.magic == 42:
                raise kaitaistruct.ValidationNotEqualError(42, self.magic, None, u"/types/exif_body/seq/0")
            if self.ifd0__enabled:
                pass
                if self._m_ifd0._root != self._root:
                    raise kaitaistruct.ConsistencyError(u"ifd0", self._root, self._m_ifd0._root)
                if self._m_ifd0._parent != self:
                    raise kaitaistruct.ConsistencyError(u"ifd0", self, self._m_ifd0._parent)
                if self._m_ifd0.is_gps_ifd != False:
                    raise kaitaistruct.ConsistencyError(u"ifd0", False, self._m_ifd0.is_gps_ifd)

            self._dirty = False

        class AsciiString(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.AsciiString, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/ascii_string")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _check(self):
                if KaitaiStream.byte_array_index_of(self.value, 0) != -1:
                    raise kaitaistruct.ConsistencyError(u"value", -1, KaitaiStream.byte_array_index_of(self.value, 0))
                self._dirty = False


        class Doubles(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Doubles, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/doubles")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_f8le(self.values[i])
            ...
            def _write__seq_be(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_f8be(self.values[i])



            def _check(self):
                if len(self.values) != self._parent.num_values:
                    raise kaitaistruct.ConsistencyError(u"values", self._parent.num_values, len(self.values))
                for i in range(len(self.values)):
                    pass
        ...
        class Floats(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Floats, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/floats")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_f4le(self.values[i])
            ...
            def _write__seq_be(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_f4be(self.values[i])
        ...
        class Ifd(ReadWriteKaitaiStruct):
            def __init__(self, is_gps_ifd, _io=None, _parent=None, _root=None, _is_le=None):
                super(Exif.ExifBody.Ifd, self).__init__(_io)
                self._parent = _parent
                self._root = _root
                self._is_le = _is_le
                self.is_gps_ifd = is_gps_ifd
                self._should_write_next_ifd = False
                self.next_ifd__enabled = True
            ...
            def _read_le(self):
                ...
                for i in range(self.num_fields):
                    ...
                    _t_fields = Exif.ExifBody.IfdField(_io__raw_fields, self, self._root, self._is_le)
                    try:
                        _t_fields._read()
                    finally:
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Ifd, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/ifd")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                self._should_write_next_ifd = self.next_ifd__enabled
                self._io.write_u2le(self.num_fields)
                self._raw_fields = []
                for i in range(len(self.fields)):
                    pass
                    _io__raw_fields = KaitaiStream(BytesIO(bytearray(12)))
                    self._io.add_child_stream(_io__raw_fields)
                    _pos2 = self._io.pos()
                    self._io.seek(self._io.pos() + (12))
                    def handler(parent, _io__raw_fields=_io__raw_fields, i=i):
                        self._raw_fields.append(_io__raw_fields.to_byte_array())
                        if len(self._raw_fields[i]) != 12:
                            raise kaitaistruct.ConsistencyError(u"raw(fields)", 12, len(self._raw_fields[i]))
                        parent.write_bytes(self._raw_fields[i])
                    _io__raw_fields.write_back_handler = KaitaiStream.WriteBackHandler(_pos2, handler)
                    self.fields[i]._write__seq(_io__raw_fields)

                self._io.write_u4le(self.ofs_next_ifd)


            def _write__seq_be(self):
                self._should_write_next_ifd = self.next_ifd__enabled
                self._io.write_u2be(self.num_fields)
                self._raw_fields = []
                for i in range(len(self.fields)):
                    pass
                    _io__raw_fields = KaitaiStream(BytesIO(bytearray(12)))
                ...
                self._io.write_u4be(self.ofs_next_ifd)
            ...
            def _check(self):
                ...
                if self.next_ifd__enabled:
                    pass
                    if self.ofs_next_ifd != 0:
                        pass
                        if self._m_next_ifd._root != self._root:
                            raise kaitaistruct.ConsistencyError(u"next_ifd", self._root, self._m_next_ifd._root)
                        if self._m_next_ifd._parent != self:
                            raise kaitaistruct.ConsistencyError(u"next_ifd", self, self._m_next_ifd._parent)
                        if self._m_next_ifd.is_gps_ifd != self.is_gps_ifd:
                            raise kaitaistruct.ConsistencyError(u"next_ifd", self.is_gps_ifd, self._m_next_ifd.is_gps_ifd)
            ...
            @property
            def next_ifd(self):
                if self._should_write_next_ifd:
                    self._write_next_ifd()
                if hasattr(self, '_m_next_ifd'):
                    return self._m_next_ifd

                if not self.next_ifd__enabled:
                    return None
            ...
            def _write_next_ifd(self):
                ...
                if self.ofs_next_ifd != 0:
                    ...
                    self._io.seek(self.ofs_next_ifd)
                    if self._is_le:
                        self._m_next_ifd._write__seq(self._io)
                    else:
                        self._m_next_ifd._write__seq(self._io)
                    self._io.seek(_pos)
        ...
        class IfdField(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
                ...
                self._should_write_sub_ifd = False
                self.sub_ifd__enabled = True
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.IfdField, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/ifd_field")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                ...
                self._should_write_sub_ifd = self.sub_ifd__enabled
                self._io.write_u2le(self.tag_raw)
                self._io.write_u2le(int(self.field_type))
            ...
            def _write__seq_be(self):
                self._should_write_data = self.data__enabled
                self._should_write_sub_ifd = self.sub_ifd__enabled
                self._io.write_u2be(self.tag_raw)
                self._io.write_u2be(int(self.field_type))
                self._io.write_u4be(self.num_values)
                if (not (self.has_immediate_data)):
                    pass
            ...
            def _invalidate_bytes_per_value(self):
                del self._m_bytes_per_value
            @property
            def data(self):
            ...
            def _invalidate_has_immediate_data(self):
                del self._m_has_immediate_data
            @property
            def len_data(self):
            ...
            def sub_ifd(self):
                ...
                """
                if self._should_write_sub_ifd:
                    self._write_sub_ifd()
                if hasattr(self, '_m_sub_ifd'):
                    return self._m_sub_ifd

                if not self.sub_ifd__enabled:
                    return None
            ...
            def _write_sub_ifd(self):
                ...
                if  ((self.num_values == 1) and ( ((self.field_type == Exif.FieldType.long) or (self.field_type == Exif.FieldType.ifd) or ( ((self.field_type == Exif.FieldType.slong) and (self.data.values[0] >= 0)) )) ) and ( ((self.tag == Exif.Tag.exif_offset) or (self.tag == Exif.Tag.interop_offset) or (self.tag == Exif.Tag.gps_info)) )) :
                    ...
                    io.seek((self.data.values[0] if self.field_type == Exif.FieldType.slong else self.data.values[0]))
                    if self._is_le:
                        if self._m_sub_ifd._root != self._root:
                            raise kaitaistruct.ConsistencyError(u"sub_ifd", self._root, self._m_sub_ifd._root)
                        if self._m_sub_ifd._parent != self:
                            raise kaitaistruct.ConsistencyError(u"sub_ifd", self, self._m_sub_ifd._parent)
                        if self._m_sub_ifd.is_gps_ifd != (self.tag == Exif.Tag.gps_info):
                            raise kaitaistruct.ConsistencyError(u"sub_ifd", self.tag == Exif.Tag.gps_info, self._m_sub_ifd.is_gps_ifd)
                        self._m_sub_ifd._write__seq(io)
                    else:
                        if self._m_sub_ifd._root != self._root:
                            raise kaitaistruct.ConsistencyError(u"sub_ifd", self._root, self._m_sub_ifd._root)
                        if self._m_sub_ifd._parent != self:
        ...
        class Longs(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Longs, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/longs")
                elif self._is_le == True:
                    self._write__seq_le()
        ...
        class Rational(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Rational, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/rational")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                self._io.write_u4le(self.value_num)
                self._io.write_u4le(self.value_den)


            def _write__seq_be(self):
                self._io.write_u4be(self.value_num)
                self._io.write_u4be(self.value_den)
        ...
        class Rationals(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _read_le(self):
                self.values = []
                for i in range(self._parent.num_values):
                    _t_values = Exif.ExifBody.Rational(self._io, self, self._root, self._is_le)
                    try:
                        _t_values._read()
                    finally:
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Rationals, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/rationals")
                elif self._is_le == True:
                    self._write__seq_le()
        ...
        class Sbytes(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Sbytes, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/sbytes")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_s1(self.values[i])
        ...
        class Shorts(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Shorts, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/shorts")
                elif self._is_le == True:
                    self._write__seq_le()
        ...
        class Slongs(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Slongs, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/slongs")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_s4le(self.values[i])
            ...
            def _write__seq_be(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_s4be(self.values[i])
        ...
        class Srational(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Srational, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/srational")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                self._io.write_s4le(self.value_num)
                self._io.write_s4le(self.value_den)


            def _write__seq_be(self):
                self._io.write_s4be(self.value_num)
                self._io.write_s4be(self.value_den)
        ...
        class Srationals(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _read_le(self):
                self.values = []
                for i in range(self._parent.num_values):
                    _t_values = Exif.ExifBody.Srational(self._io, self, self._root, self._is_le)
                    try:
                        _t_values._read()
                    finally:
                        self.values.append(_t_values)
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Srationals, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/srationals")
                elif self._is_le == True:
                    self._write__seq_le()
        ...
        class Sshorts(ReadWriteKaitaiStruct):
            def __init__(self, _io=None, _parent=None, _root=None, _is_le=None):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Sshorts, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/sshorts")
                elif self._is_le == True:
                    self._write__seq_le()
            ...
            def _write__seq_le(self):
                for i in range(len(self.values)):
                    pass
                    self._io.write_s2le(self.values[i])
        ...
        class Utf8String(ReadWriteKaitaiStruct):
            ...
            def _write__seq(self, io=None):
                super(Exif.ExifBody.Utf8String, self)._write__seq(io)
                if not hasattr(self, '_is_le'):
                    raise kaitaistruct.UndecidedEndiannessError("/types/exif_body/types/utf8_string")
                elif self._is_le == True:
                    self._write__seq_le()
        ...
        @property
        def ifd0(self):
            if self._should_write_ifd0:
                self._write_ifd0()
            if hasattr(self, '_m_ifd0'):
                return self._m_ifd0

            if not self.ifd0__enabled:
                return None
        ...
        def _write_ifd0(self):
            self._should_write_ifd0 = False
            _pos = self._io.pos()
            self._io.seek(self.ofs_ifd0)
            if self._is_le:
                self._m_ifd0._write__seq(self._io)
            else:
                self._m_ifd0._write__seq(self._io)
            self._io.seek(_pos)
