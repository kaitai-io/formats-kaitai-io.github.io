...
class Exif(ReadWriteKaitaiStruct):
    ...
    class ExifBody(ReadWriteKaitaiStruct):
        ...
        def _write__seq_le(self):
            ...
            self._io.write_u4le(self.ifd0_ofs)


        def _write__seq_be(self):
            self._should_write_ifd0 = self.ifd0__enabled
            self._io.write_u2be(self.version)
            self._io.write_u4be(self.ifd0_ofs)
        ...
        class Ifd(ReadWriteKaitaiStruct):
            ...
            def _write__seq_le(self):
                ...
                self._io.write_u4le(self.next_ifd_ofs)
            ...
            def _write__seq_be(self):
                ...
                self._io.write_u4be(self.next_ifd_ofs)
        ...
        class IfdField(ReadWriteKaitaiStruct):
            ...
            def _write__seq_be(self):
                ...
                self._io.write_u4be(self.ofs_or_data)
            ...
            def _check(self):
                if self.data__enabled:
                    ...
                    if (not (self.is_immediate_data)):
                        pass
                        if len(self._m_data) != self.byte_length:
                            raise kaitaistruct.ConsistencyError(u"data", self.byte_length, len(self._m_data))
            ...
            def _invalidate_byte_length(self):
                del self._m_byte_length
            @property
            def data(self):
            ...
            def _invalidate_is_immediate_data(self):
                del self._m_is_immediate_data
            @property
            ...
            def _invalidate_type_byte_length(self):
                del self._m_type_byte_length
