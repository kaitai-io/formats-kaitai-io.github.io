...
public:
    ...
    icmp_packet_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icmp_packet_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        enum destination_unreachable_code_t {
            ...
            DESTINATION_UNREACHABLE_CODE_DST_NET_UNKNOWN = 6,
            DESTINATION_UNREACHABLE_CODE_SDT_HOST_UNKNOWN = 7,
    ...
    public:
        ...
        destination_unreachable_msg_t(kaitai::kstream* p__io, icmp_packet_t* p__parent = nullptr, icmp_packet_t* p__root = nullptr);
    ...
    public:
        ...
        echo_msg_t(kaitai::kstream* p__io, icmp_packet_t* p__parent = nullptr, icmp_packet_t* p__root = nullptr);
    ...
    public:
        ...
        time_exceeded_msg_t(kaitai::kstream* p__io, icmp_packet_t* p__parent = nullptr, icmp_packet_t* p__root = nullptr);
...
private:
    ...
    std::unique_ptr<destination_unreachable_msg_t> m_destination_unreachable;
...
private:
    std::unique_ptr<time_exceeded_msg_t> m_time_exceeded;
...
private:
    std::unique_ptr<echo_msg_t> m_echo;
    bool n_echo;
...
public:
    ...
    destination_unreachable_msg_t* destination_unreachable() const { return m_destination_unreachable.get(); }
    time_exceeded_msg_t* time_exceeded() const { return m_time_exceeded.get(); }
    echo_msg_t* echo() const { return m_echo.get(); }
    icmp_packet_t* _root() const { return m__root; }
