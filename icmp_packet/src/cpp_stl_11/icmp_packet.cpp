...
const std::set<icmp_packet_t::destination_unreachable_msg_t::destination_unreachable_code_t> icmp_packet_t::destination_unreachable_msg_t::_values_destination_unreachable_code_t{
    ...
    icmp_packet_t::destination_unreachable_msg_t::DESTINATION_UNREACHABLE_CODE_DST_NET_UNKNOWN,
    icmp_packet_t::destination_unreachable_msg_t::DESTINATION_UNREACHABLE_CODE_SDT_HOST_UNKNOWN,
