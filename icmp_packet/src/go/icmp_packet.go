...
const (
	...
	IcmpPacket_DestinationUnreachableMsg_DestinationUnreachableCode__DstNetUnknown IcmpPacket_DestinationUnreachableMsg_DestinationUnreachableCode = 6
	IcmpPacket_DestinationUnreachableMsg_DestinationUnreachableCode__SdtHostUnknown IcmpPacket_DestinationUnreachableMsg_DestinationUnreachableCode = 7
