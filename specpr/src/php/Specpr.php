...
class Icflag extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        $this->_m_reserved = $this->_io->readBitsInt(26);
        $this->_m_isctbType = $this->_io->readBitsInt(1) != 0;
        $this->_m_isctaType = $this->_io->readBitsInt(1) != 0;
        $this->_m_coordinateMode = $this->_io->readBitsInt(1) != 0;
        $this->_m_errors = $this->_io->readBitsInt(1) != 0;
        $this->_m_text = $this->_io->readBitsInt(1) != 0;
        $this->_m_continuation = $this->_io->readBitsInt(1) != 0;
    }
    protected $_m_type;
