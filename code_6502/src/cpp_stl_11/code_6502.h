...
public:
    ...
    public:
        ...
        operation_t(kaitai::kstream* p__io, code_6502_t* p__parent = nullptr, code_6502_t* p__root = nullptr);
...
private:
    std::unique_ptr<std::vector<std::unique_ptr<operation_t>>> m_operations;
    code_6502_t* m__root;
    kaitai::kstruct* m__parent;

public:
    std::vector<std::unique_ptr<operation_t>>* operations() const { return m_operations.get(); }
    code_6502_t* _root() const { return m__root; }
