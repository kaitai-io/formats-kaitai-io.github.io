...
namespace Kaitai
{
    ...
    public partial class Code6502 : KaitaiStruct
    {
        ...
        public Code6502(KaitaiStream p__io, KaitaiStruct p__parent = null, Code6502 p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Operation : KaitaiStruct
        {
            ...
            public Operation(KaitaiStream p__io, Code6502 p__parent = null, Code6502 p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
