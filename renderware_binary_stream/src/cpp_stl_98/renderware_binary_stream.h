...
public:
    ...
    private:
        std::vector<uv_layer_t*>* m_uv_layers;
    ...
    public:
        ...
        std::vector<uv_layer_t*>* uv_layers() const { return m_uv_layers; }
    ...
    public:
        ...
        uv_layer_t(uint32_t p_num_vertices, kaitai::kstream* p__io, renderware_binary_stream_t::geometry_non_native_t* p__parent = 0, renderware_binary_stream_t* p__root = 0);
