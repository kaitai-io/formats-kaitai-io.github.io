...
namespace Kaitai
{
    public partial class Icc4 : KaitaiStruct
    {
        ...
        public partial class DeviceAttributes : KaitaiStruct
        {
            ...
            private void _read()
            {
                _reflectiveOrTransparency = ((DeviceAttributesReflectiveOrTransparency) m_io.ReadBitsIntBe(1));
                _glossyOrMatte = ((DeviceAttributesGlossyOrMatte) m_io.ReadBitsIntBe(1));
                _positiveOrNegativeMediaPolarity = ((DeviceAttributesPositiveOrNegativeMediaPolarity) m_io.ReadBitsIntBe(1));
                _colourOrBlackAndWhiteMedia = ((DeviceAttributesColourOrBlackAndWhiteMedia) m_io.ReadBitsIntBe(1));
                _reserved = m_io.ReadBitsIntBe(28);
                _vendorSpecific = m_io.ReadBitsIntBe(32);
            }
        ...
        public partial class ProfileHeader : KaitaiStruct
        {
            ...
            public enum CmmSignatures
            {
                ...
                OnyxGraphicsCmm = 1330534744,
                DeviceLinkCmm = 1380404563,
                ReficcmaxCmm = 1380535640,
            ...
            private void _read()
            {
                ...
                _fileSignature = m_io.ReadBytes(4);
                if (!((KaitaiStream.ByteArrayCompare(_fileSignature, new byte[] { 97, 99, 115, 112 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 97, 99, 115, 112 }, _fileSignature, m_io, "/types/profile_header/seq/7");
                }
            ...
            public partial class ProfileFlags : KaitaiStruct
            {
                ...
                private void _read()
                {
                    _embeddedProfile = m_io.ReadBitsIntBe(1) != 0;
                    _profileCanBeUsedIndependentlyOfEmbeddedColourData = m_io.ReadBitsIntBe(1) != 0;
                    _otherFlags = m_io.ReadBitsIntBe(30);
                }
            ...
            public partial class VersionField : KaitaiStruct
            {
                ...
                private void _read()
                {
                    _major = m_io.ReadBytes(1);
                    if (!((KaitaiStream.ByteArrayCompare(_major, new byte[] { 4 }) == 0)))
                    {
                        throw new ValidationNotEqualError(new byte[] { 4 }, _major, m_io, "/types/profile_header/types/version_field/seq/0");
                    }
                    _minor = m_io.ReadBitsIntBe(4);
                    _bugFixLevel = m_io.ReadBitsIntBe(4);
                    m_io.AlignToByte();
                    _reserved = m_io.ReadBytes(2);
                    if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0 }) == 0)))
                    {
                        throw new ValidationNotEqualError(new byte[] { 0, 0 }, _reserved, m_io, "/types/profile_header/types/version_field/seq/3");
                    }
                }
                private byte[] _major;
        ...
        public partial class Response16Number : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0 }) == 0)))
                {
                    throw new ValidationNotEqualError(new byte[] { 0, 0 }, _reserved, m_io, "/types/response_16_number/seq/1");
                }
        ...
        public partial class S15Fixed16Number : KaitaiStruct
        {
            ...
            public S15Fixed16Number(KaitaiStream p__io, KaitaiStruct p__parent = null, Icc4 p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class TagTable : KaitaiStruct
        {
            ...
            public partial class TagDefinition : KaitaiStruct
            {
                ...
                {
                    XyzType = 1482250784,
                    ChromaticityType = 1667789421,
                    ColorantOrderType = 1668051567,
                ...
                public partial class ChromaticityType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/chromaticity_type/seq/0");
                        }
                        _numberOfDeviceChannels = m_io.ReadU2be();
                        _colorantAndPhosphorEncoding = ((ColorantAndPhosphorEncodings) m_io.ReadU2be());
                        _ciexyCoordinatesPerChannel = new List<CiexyCoordinateValues>();
                ...
                public partial class ColorantOrderType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/colorant_order_type/seq/0");
                        }
                        _countOfColorants = m_io.ReadU4be();
                        _numbersOfColorantsInOrderOfPrinting = new List<byte>();
                ...
                public partial class ColorantTableType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/colorant_table_type/seq/0");
                        }
                        _countOfColorants = m_io.ReadU4be();
                        _colorants = new List<Colorant>();
                        for (var i = 0; i < CountOfColorants; i++)
                        {
                    ...
                    public partial class Colorant : KaitaiStruct
                    {
                        ...
                        private void _read()
                        {
                            ...
                            {
                                _padding.Add(m_io.ReadBytes(1));
                                if (!((KaitaiStream.ByteArrayCompare(_padding[i], new byte[] { 0 }) == 0)))
                                {
                                    throw new ValidationNotEqualError(new byte[] { 0 }, _padding[i], m_io, "/types/tag_table/types/tag_definition/types/colorant_table_type/types/colorant/seq/1");
                                }
                            }
                ...
                public partial class CurveType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/curve_type/seq/0");
                        }
                        _numberOfEntries = m_io.ReadU4be();
                        if (NumberOfEntries > 1) {
                            _curveValues = new List<ushort>();
                            for (var i = 0; i < NumberOfEntries; i++)
                            {
                                _curveValues.Add(m_io.ReadU2be());
                            }
                        }
                        if (NumberOfEntries == 1) {
                    ...
                    private List<ushort> _curveValues;
                    private byte? _curveValue;
                    private Icc4 m_root;
                    private KaitaiStruct m_parent;
                    public byte[] Reserved { get { return _reserved; } }
                    public uint NumberOfEntries { get { return _numberOfEntries; } }
                    public List<ushort> CurveValues { get { return _curveValues; } }
                ...
                public partial class DateTimeType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/date_time_type/seq/0");
                        }
                ...
                public partial class Lut16Type : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/lut_16_type/seq/0");
                        }
                        ...
                        {
                            throw new ValidationNotEqualError(new byte[] { 0 }, _padding, m_io, "/types/tag_table/types/tag_definition/types/lut_16_type/seq/4");
                        }
                        _encodedEParameters = new List<int>();
                        for (var i = 0; i < 9; i++)
                        {
                            _encodedEParameters.Add(m_io.ReadS4be());
                        }
                        _numberOfInputTableEntries = m_io.ReadU2be();
                        _numberOfOutputTableEntries = m_io.ReadU2be();
                    ...
                    private ushort _numberOfInputTableEntries;
                    private ushort _numberOfOutputTableEntries;
                    ...
                    public ushort NumberOfInputTableEntries { get { return _numberOfInputTableEntries; } }
                    public ushort NumberOfOutputTableEntries { get { return _numberOfOutputTableEntries; } }
                ...
                public partial class Lut8Type : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/lut_8_type/seq/0");
                        }
                        _numberOfInputChannels = m_io.ReadU1();
                        _numberOfOutputChannels = m_io.ReadU1();
                        _numberOfClutGridPoints = m_io.ReadU1();
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_padding, new byte[] { 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0 }, _padding, m_io, "/types/tag_table/types/tag_definition/types/lut_8_type/seq/4");
                        }
                        _encodedEParameters = new List<int>();
                        for (var i = 0; i < 9; i++)
                        {
                ...
                public partial class LutAToBType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/lut_a_to_b_type/seq/0");
                        }
                        _numberOfInputChannels = m_io.ReadU1();
                        _numberOfOutputChannels = m_io.ReadU1();
                        _padding = m_io.ReadBytes(2);
                        if (!((KaitaiStream.ByteArrayCompare(_padding, new byte[] { 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0 }, _padding, m_io, "/types/tag_table/types/tag_definition/types/lut_a_to_b_type/seq/3");
                        }
                ...
                public partial class LutBToAType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/lut_b_to_a_type/seq/0");
                        }
                        _numberOfInputChannels = m_io.ReadU1();
                        _numberOfOutputChannels = m_io.ReadU1();
                        _padding = m_io.ReadBytes(2);
                        if (!((KaitaiStream.ByteArrayCompare(_padding, new byte[] { 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0 }, _padding, m_io, "/types/tag_table/types/tag_definition/types/lut_b_to_a_type/seq/3");
                        }
                        _offsetToFirstBCurve = m_io.ReadU4be();
                        _offsetToMatrix = m_io.ReadU4be();
                        _offsetToFirstMCurve = m_io.ReadU4be();
                ...
                public partial class MeasurementType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/measurement_type/seq/0");
                        }
                ...
                public partial class MultiLocalizedUnicodeType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/multi_localized_unicode_type/seq/0");
                        }
                ...
                public partial class MultiProcessElementsType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/multi_process_elements_type/seq/0");
                        }
                        _numberOfInputChannels = m_io.ReadU2be();
                        _numberOfOutputChannels = m_io.ReadU2be();
                        _numberOfProcessingElements = m_io.ReadU4be();
                        _processElementPositionsTable = new List<PositionNumber>();
                ...
                public partial class NamedColor2Type : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/named_color_2_type/seq/0");
                        }
                        ...
                        _prefixForEachColourNamePadding = new List<byte[]>();
                        for (var i = 0; i < 32 - PrefixForEachColourName.Length; i++)
                        {
                            _prefixForEachColourNamePadding.Add(m_io.ReadBytes(1));
                            if (!((KaitaiStream.ByteArrayCompare(_prefixForEachColourNamePadding[i], new byte[] { 0 }) == 0)))
                            {
                                throw new ValidationNotEqualError(new byte[] { 0 }, _prefixForEachColourNamePadding[i], m_io, "/types/tag_table/types/tag_definition/types/named_color_2_type/seq/5");
                            }
                        }
                        _suffixForEachColourName = System.Text.Encoding.GetEncoding("ASCII").GetString(m_io.ReadBytesTerm(0, false, true, true));
                        _suffixForEachColourNamePadding = new List<byte[]>();
                        for (var i = 0; i < 32 - SuffixForEachColourName.Length; i++)
                        {
                            _suffixForEachColourNamePadding.Add(m_io.ReadBytes(1));
                            if (!((KaitaiStream.ByteArrayCompare(_suffixForEachColourNamePadding[i], new byte[] { 0 }) == 0)))
                            {
                                throw new ValidationNotEqualError(new byte[] { 0 }, _suffixForEachColourNamePadding[i], m_io, "/types/tag_table/types/tag_definition/types/named_color_2_type/seq/7");
                            }
                        }
                        _namedColourDefinitions = new List<NamedColourDefinition>();
                    ...
                    public partial class NamedColourDefinition : KaitaiStruct
                    {
                        ...
                        private void _read()
                        {
                            ...
                            _rootNamePadding = new List<byte[]>();
                            for (var i = 0; i < 32 - RootName.Length; i++)
                            {
                                _rootNamePadding.Add(m_io.ReadBytes(1));
                                if (!((KaitaiStream.ByteArrayCompare(_rootNamePadding[i], new byte[] { 0 }) == 0)))
                                {
                                    throw new ValidationNotEqualError(new byte[] { 0 }, _rootNamePadding[i], m_io, "/types/tag_table/types/tag_definition/types/named_color_2_type/types/named_colour_definition/seq/1");
                                }
                            }
                            _pcsCoordinates = m_io.ReadBytes(6);
                            if (M_Parent.NumberOfDeviceCoordinatesForEachNamedColour > 0) {
                                _deviceCoordinates = new List<ushort>();
                                for (var i = 0; i < M_Parent.NumberOfDeviceCoordinatesForEachNamedColour; i++)
                                {
                ...
                public partial class ParametricCurveType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/parametric_curve_type/seq/0");
                        }
                        _functionType = ((ParametricCurveTypeFunctions) m_io.ReadU2be());
                        _reserved2 = m_io.ReadBytes(2);
                        if (!((KaitaiStream.ByteArrayCompare(_reserved2, new byte[] { 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0 }, _reserved2, m_io, "/types/tag_table/types/tag_definition/types/parametric_curve_type/seq/2");
                        }
                        switch (FunctionType) {
                ...
                public partial class ProfileSequenceDescType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/profile_sequence_desc_type/seq/0");
                        }
                        _numberOfDescriptionStructures = m_io.ReadU4be();
                        _profileDescriptions = new List<ProfileDescription>();
                ...
                public partial class ProfileSequenceIdentifierType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/profile_sequence_identifier_type/seq/0");
                        }
                        _numberOfStructures = m_io.ReadU4be();
                        _positionsTable = new List<PositionNumber>();
                        for (var i = 0; i < NumberOfStructures; i++)
                        {
                            _positionsTable.Add(new PositionNumber(m_io, this, m_root));
                        }
                        _profileIdentifiers = new List<ProfileIdentifier>();
                        for (var i = 0; i < NumberOfStructures; i++)
                        {
                ...
                public partial class ResponseCurveSet16Type : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/response_curve_set_16_type/seq/0");
                        }
                        _numberOfChannels = m_io.ReadU2be();
                        _countOfMeasurementTypes = m_io.ReadU2be();
                        _responseCurveStructureOffsets = new List<uint>();
                ...
                public partial class S15Fixed16ArrayType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/s_15_fixed_16_array_type/seq/0");
                        }
                ...
                public partial class SignatureType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/signature_type/seq/0");
                        }
                ...
                public partial class TextType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/text_type/seq/0");
                        }
                ...
                public partial class U16Fixed16ArrayType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/u_16_fixed_16_array_type/seq/0");
                        }
                ...
                public partial class UInt16ArrayType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/u_int_16_array_type/seq/0");
                        }
                ...
                public partial class UInt32ArrayType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/u_int_32_array_type/seq/0");
                        }
                ...
                public partial class UInt64ArrayType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/u_int_64_array_type/seq/0");
                        }
                ...
                public partial class UInt8ArrayType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/u_int_8_array_type/seq/0");
                        }
                ...
                public partial class ViewingConditionsType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/viewing_conditions_type/seq/0");
                        }
                ...
                public partial class XyzType : KaitaiStruct
                {
                    ...
                    private void _read()
                    {
                        ...
                        if (!((KaitaiStream.ByteArrayCompare(_reserved, new byte[] { 0, 0, 0, 0 }) == 0)))
                        {
                            throw new ValidationNotEqualError(new byte[] { 0, 0, 0, 0 }, _reserved, m_io, "/types/tag_table/types/tag_definition/types/xyz_type/seq/0");
                        }
        ...
        public partial class U16Fixed16Number : KaitaiStruct
        {
            ...
            public U16Fixed16Number(KaitaiStream p__io, Icc4.TagTable.TagDefinition.U16Fixed16ArrayType p__parent = null, Icc4 p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private byte[] _number;
            private Icc4 m_root;
            private Icc4.TagTable.TagDefinition.U16Fixed16ArrayType m_parent;
            public byte[] Number { get { return _number; } }
            public Icc4 M_Root { get { return m_root; } }
            public Icc4.TagTable.TagDefinition.U16Fixed16ArrayType M_Parent { get { return m_parent; } }
        }
