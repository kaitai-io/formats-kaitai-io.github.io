...
public:
    ...
    icc_4_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        date_time_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        static bool _is_defined_device_attributes_colour_or_black_and_white_media_t(device_attributes_colour_or_black_and_white_media_t v);

    private:
        static const std::set<device_attributes_colour_or_black_and_white_media_t> _values_device_attributes_colour_or_black_and_white_media_t;
    ...
    public:
        ...
        static bool _is_defined_device_attributes_glossy_or_matte_t(device_attributes_glossy_or_matte_t v);

    private:
        static const std::set<device_attributes_glossy_or_matte_t> _values_device_attributes_glossy_or_matte_t;
    ...
    public:
        ...
        static bool _is_defined_device_attributes_positive_or_negative_media_polarity_t(device_attributes_positive_or_negative_media_polarity_t v);

    private:
        static const std::set<device_attributes_positive_or_negative_media_polarity_t> _values_device_attributes_positive_or_negative_media_polarity_t;
    ...
    public:
        ...
        static bool _is_defined_device_attributes_reflective_or_transparency_t(device_attributes_reflective_or_transparency_t v);

    private:
        static const std::set<device_attributes_reflective_or_transparency_t> _values_device_attributes_reflective_or_transparency_t;

    public:

        device_attributes_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        static bool _is_defined_device_manufacturers_t(device_manufacturers_t v);

    private:
        static const std::set<device_manufacturers_t> _values_device_manufacturers_t;

    public:

        device_manufacturer_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        position_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        enum cmm_signatures_t {
            ...
            CMM_SIGNATURES_DEMOICCMAX_CMM = 1145654616,
            ...
            CMM_SIGNATURES_ONYX_GRAPHICS_CMM = 1330534744,
            CMM_SIGNATURES_DEVICE_LINK_CMM = 1380404563,
            CMM_SIGNATURES_REFICCMAX_CMM = 1380535640,
            ...
            CMM_SIGNATURES_VIVO_CMM = 1986623087,
            CMM_SIGNATURES_ZORAN_CMM = 2053320752
        };
        static bool _is_defined_cmm_signatures_t(cmm_signatures_t v);

    private:
        static const std::set<cmm_signatures_t> _values_cmm_signatures_t;
    ...
    public:
        ...
        static bool _is_defined_data_colour_spaces_t(data_colour_spaces_t v);

    private:
        static const std::set<data_colour_spaces_t> _values_data_colour_spaces_t;
    ...
    public:
        ...
        static bool _is_defined_primary_platforms_t(primary_platforms_t v);

    private:
        static const std::set<primary_platforms_t> _values_primary_platforms_t;
    ...
    public:
        ...
        static bool _is_defined_profile_classes_t(profile_classes_t v);

    private:
        static const std::set<profile_classes_t> _values_profile_classes_t;
    ...
    public:
        ...
        static bool _is_defined_rendering_intents_t(rendering_intents_t v);

    private:
        static const std::set<rendering_intents_t> _values_rendering_intents_t;

    public:

        profile_header_t(kaitai::kstream* p__io, icc_4_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            profile_flags_t(kaitai::kstream* p__io, icc_4_t::profile_header_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
        ...
        public:
            ...
            version_field_t(kaitai::kstream* p__io, icc_4_t::profile_header_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<version_field_t> m_version;
        profile_classes_t m_device_class;
        data_colour_spaces_t m_color_space;
        std::string m_pcs;
        std::unique_ptr<date_time_number_t> m_creation_date_time;
        std::string m_file_signature;
        primary_platforms_t m_primary_platform;
        std::unique_ptr<profile_flags_t> m_profile_flags;
        std::unique_ptr<device_manufacturer_t> m_device_manufacturer;
        std::string m_device_model;
        std::unique_ptr<device_attributes_t> m_device_attributes;
        rendering_intents_t m_rendering_intent;
        std::unique_ptr<xyz_number_t> m_nciexyz_values_of_illuminant_of_pcs;
        std::unique_ptr<device_manufacturer_t> m_creator;
    ...
    public:
        ...
        version_field_t* version() const { return m_version.get(); }
        ...
        date_time_number_t* creation_date_time() const { return m_creation_date_time.get(); }
        ...
        profile_flags_t* profile_flags() const { return m_profile_flags.get(); }
        device_manufacturer_t* device_manufacturer() const { return m_device_manufacturer.get(); }
        std::string device_model() const { return m_device_model; }
        device_attributes_t* device_attributes() const { return m_device_attributes.get(); }
        rendering_intents_t rendering_intent() const { return m_rendering_intent; }
        xyz_number_t* nciexyz_values_of_illuminant_of_pcs() const { return m_nciexyz_values_of_illuminant_of_pcs.get(); }
        device_manufacturer_t* creator() const { return m_creator.get(); }
    ...
    public:
        ...
        response_16_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    private:
        uint32_t m_number;
        std::string m_reserved;
        std::unique_ptr<s_15_fixed_16_number_t> m_measurement_value;
        icc_4_t* m__root;
        kaitai::kstruct* m__parent;
    ...
    public:
        ...
        std::string reserved() const { return m_reserved; }
        s_15_fixed_16_number_t* measurement_value() const { return m_measurement_value.get(); }
        icc_4_t* _root() const { return m__root; }
        kaitai::kstruct* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        s_15_fixed_16_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        static bool _is_defined_standard_illuminant_encodings_t(standard_illuminant_encodings_t v);

    private:
        static const std::set<standard_illuminant_encodings_t> _values_standard_illuminant_encodings_t;

    public:

        standard_illuminant_encoding_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        tag_table_t(kaitai::kstream* p__io, icc_4_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        public:
            ...
            static bool _is_defined_multi_process_elements_types_t(multi_process_elements_types_t v);

        private:
            static const std::set<multi_process_elements_types_t> _values_multi_process_elements_types_t;
        ...
        public:
            ...
            static bool _is_defined_tag_signatures_t(tag_signatures_t v);

        private:
            static const std::set<tag_signatures_t> _values_tag_signatures_t;

        public:

            enum tag_type_signatures_t {
                TAG_TYPE_SIGNATURES_XYZ_TYPE = 1482250784,
                TAG_TYPE_SIGNATURES_CHROMATICITY_TYPE = 1667789421,
                TAG_TYPE_SIGNATURES_COLORANT_ORDER_TYPE = 1668051567,
            ...
            static bool _is_defined_tag_type_signatures_t(tag_type_signatures_t v);

        private:
            static const std::set<tag_type_signatures_t> _values_tag_type_signatures_t;

        public:

            tag_definition_t(kaitai::kstream* p__io, icc_4_t::tag_table_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
        ...
        public:
            ...
            public:
                ...
                a_to_b_0_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<kaitai::kstruct> m_tag_data;
                bool n_tag_data;
            ...
            public:
                ...
                kaitai::kstruct* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                a_to_b_1_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                a_to_b_2_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                b_to_a_0_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                b_to_a_1_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                b_to_a_2_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                b_to_d_0_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<multi_process_elements_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                multi_process_elements_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                b_to_d_1_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                b_to_d_2_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                b_to_d_3_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                blue_matrix_column_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<xyz_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                xyz_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                blue_trc_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                calibration_date_time_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<date_time_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                date_time_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                char_target_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<text_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                text_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                chromatic_adaptation_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<s_15_fixed_16_array_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                s_15_fixed_16_array_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                chromaticity_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<chromaticity_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                chromaticity_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                static bool _is_defined_colorant_and_phosphor_encodings_t(colorant_and_phosphor_encodings_t v);

            private:
                static const std::set<colorant_and_phosphor_encodings_t> _values_colorant_and_phosphor_encodings_t;

            public:

                chromaticity_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::chromaticity_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    ciexy_coordinate_values_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::chromaticity_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<std::vector<std::unique_ptr<ciexy_coordinate_values_t>>> m_ciexy_coordinates_per_channel;
                icc_4_t* m__root;
            ...
            public:
                ...
                std::vector<std::unique_ptr<ciexy_coordinate_values_t>>* ciexy_coordinates_per_channel() const { return m_ciexy_coordinates_per_channel.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                colorant_order_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<colorant_order_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                colorant_order_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                colorant_order_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::colorant_order_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<std::vector<uint8_t>> m_numbers_of_colorants_in_order_of_printing;
                icc_4_t* m__root;
            ...
            public:
                ...
                std::vector<uint8_t>* numbers_of_colorants_in_order_of_printing() const { return m_numbers_of_colorants_in_order_of_printing.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                colorant_table_out_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<colorant_table_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                colorant_table_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                colorant_table_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                colorant_table_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    colorant_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::colorant_table_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                private:
                    std::string m_name;
                    std::unique_ptr<std::vector<std::string>> m_padding;
                ...
                public:
                    ...
                    std::vector<std::string>* padding() const { return m_padding.get(); }
            ...
            private:
                std::string m_reserved;
                uint32_t m_count_of_colorants;
                std::unique_ptr<std::vector<std::unique_ptr<colorant_t>>> m_colorants;
                icc_4_t* m__root;
                kaitai::kstruct* m__parent;
            ...
            public:
                std::string reserved() const { return m_reserved; }
                uint32_t count_of_colorants() const { return m_count_of_colorants; }
                std::vector<std::unique_ptr<colorant_t>>* colorants() const { return m_colorants.get(); }
                icc_4_t* _root() const { return m__root; }
                kaitai::kstruct* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                colorimetric_intent_image_state_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<signature_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                signature_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                copyright_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<multi_localized_unicode_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                multi_localized_unicode_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                curve_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<std::vector<uint16_t>> m_curve_values;
                bool n_curve_values;
            ...
            public:
                ...
                std::vector<uint16_t>* curve_values() const { return m_curve_values.get(); }
            ...
            public:
                ...
                d_to_b_0_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                d_to_b_1_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                d_to_b_2_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                d_to_b_3_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                static bool _is_defined_data_types_t(data_types_t v);

            private:
                static const std::set<data_types_t> _values_data_types_t;

            public:

                data_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                date_time_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::calibration_date_time_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                std::string m_reserved;
                std::unique_ptr<date_time_number_t> m_date_and_time;
                icc_4_t* m__root;
                icc_4_t::tag_table_t::tag_definition_t::calibration_date_time_tag_t* m__parent;

            public:
                std::string reserved() const { return m_reserved; }
                date_time_number_t* date_and_time() const { return m_date_and_time.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                device_mfg_desc_tag_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                device_model_desc_tag_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                gamut_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                gray_trc_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                green_matrix_column_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                green_trc_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                luminance_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                lut_16_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<std::vector<int32_t>> m_encoded_e_parameters;
                uint16_t m_number_of_input_table_entries;
                uint16_t m_number_of_output_table_entries;
            ...
            public:
                ...
                std::vector<int32_t>* encoded_e_parameters() const { return m_encoded_e_parameters.get(); }
                uint16_t number_of_input_table_entries() const { return m_number_of_input_table_entries; }
                uint16_t number_of_output_table_entries() const { return m_number_of_output_table_entries; }
            ...
            public:
                ...
                lut_8_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                lut_a_to_b_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                lut_b_to_a_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                measurement_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<measurement_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                measurement_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                static bool _is_defined_measurement_flare_encodings_t(measurement_flare_encodings_t v);

            private:
                static const std::set<measurement_flare_encodings_t> _values_measurement_flare_encodings_t;
            ...
            public:
                ...
                static bool _is_defined_measurement_geometry_encodings_t(measurement_geometry_encodings_t v);

            private:
                static const std::set<measurement_geometry_encodings_t> _values_measurement_geometry_encodings_t;
            ...
            public:
                ...
                static bool _is_defined_standard_observer_encodings_t(standard_observer_encodings_t v);

            private:
                static const std::set<standard_observer_encodings_t> _values_standard_observer_encodings_t;

            public:

                measurement_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::measurement_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<xyz_number_t> m_nciexyz_tristimulus_values_for_measurement_backing;
                ...
                std::unique_ptr<standard_illuminant_encoding_t> m_standard_illuminant_encoding;
                icc_4_t* m__root;
            ...
            public:
                ...
                xyz_number_t* nciexyz_tristimulus_values_for_measurement_backing() const { return m_nciexyz_tristimulus_values_for_measurement_backing.get(); }
                ...
                standard_illuminant_encoding_t* standard_illuminant_encoding() const { return m_standard_illuminant_encoding.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                media_white_point_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                multi_localized_unicode_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    record_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::multi_localized_unicode_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                multi_process_elements_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<std::vector<std::unique_ptr<position_number_t>>> m_process_element_positions_table;
                std::string m_data;
                icc_4_t* m__root;
                kaitai::kstruct* m__parent;
            ...
            public:
                ...
                std::vector<std::unique_ptr<position_number_t>>* process_element_positions_table() const { return m_process_element_positions_table.get(); }
                std::string data() const { return m_data; }
                icc_4_t* _root() const { return m__root; }
                kaitai::kstruct* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                named_color_2_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<named_color_2_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                named_color_2_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                named_color_2_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::named_color_2_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    named_colour_definition_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::named_color_2_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                private:
                    ...
                    std::unique_ptr<std::vector<std::string>> m_root_name_padding;
                    std::string m_pcs_coordinates;
                    std::unique_ptr<std::vector<uint16_t>> m_device_coordinates;
                ...
                public:
                    ...
                    std::vector<std::string>* root_name_padding() const { return m_root_name_padding.get(); }
                    std::string pcs_coordinates() const { return m_pcs_coordinates; }
                    std::vector<uint16_t>* device_coordinates() const { return m_device_coordinates.get(); }
                    icc_4_t* _root() const { return m__root; }
            ...
            private:
                ...
                std::unique_ptr<std::vector<std::string>> m_prefix_for_each_colour_name_padding;
                std::string m_suffix_for_each_colour_name;
                std::unique_ptr<std::vector<std::string>> m_suffix_for_each_colour_name_padding;
                std::unique_ptr<std::vector<std::unique_ptr<named_colour_definition_t>>> m_named_colour_definitions;
                icc_4_t* m__root;
            ...
            public:
                ...
                std::vector<std::string>* prefix_for_each_colour_name_padding() const { return m_prefix_for_each_colour_name_padding.get(); }
                std::string suffix_for_each_colour_name() const { return m_suffix_for_each_colour_name; }
                std::vector<std::string>* suffix_for_each_colour_name_padding() const { return m_suffix_for_each_colour_name_padding.get(); }
                std::vector<std::unique_ptr<named_colour_definition_t>>* named_colour_definitions() const { return m_named_colour_definitions.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                output_response_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<response_curve_set_16_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                response_curve_set_16_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                static bool _is_defined_parametric_curve_type_functions_t(parametric_curve_type_functions_t v);

            private:
                static const std::set<parametric_curve_type_functions_t> _values_parametric_curve_type_functions_t;

            public:

                parametric_curve_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    params_cie_122_1996_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::parametric_curve_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                public:
                    ...
                    params_iec_61966_2_1_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::parametric_curve_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                public:
                    ...
                    params_iec_61966_3_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::parametric_curve_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                public:
                    ...
                    params_y_equals_ob_ax_plus_b_cb_to_power_of_g_plus_c_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::parametric_curve_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                public:
                    ...
                    params_y_equals_x_to_power_of_g_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::parametric_curve_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<kaitai::kstruct> m_parameters;
                bool n_parameters;
            ...
            public:
                ...
                kaitai::kstruct* parameters() const { return m_parameters.get(); }
                icc_4_t* _root() const { return m__root; }
                kaitai::kstruct* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                perceptual_rendering_intent_gamut_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                preview_0_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                preview_1_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                preview_2_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                profile_description_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                profile_sequence_desc_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::profile_sequence_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    profile_description_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::profile_sequence_desc_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                private:
                    ...
                    std::string m_device_model;
                    std::unique_ptr<device_attributes_t> m_device_attributes;
                    std::unique_ptr<technology_tag_t> m_device_technology;
                    std::unique_ptr<device_mfg_desc_tag_t> m_description_of_device_manufacturer;
                    std::unique_ptr<device_model_desc_tag_t> m_description_of_device_model;
                    icc_4_t* m__root;
                ...
                public:
                    ...
                    std::string device_model() const { return m_device_model; }
                    device_attributes_t* device_attributes() const { return m_device_attributes.get(); }
                    technology_tag_t* device_technology() const { return m_device_technology.get(); }
                    device_mfg_desc_tag_t* description_of_device_manufacturer() const { return m_description_of_device_manufacturer.get(); }
                    device_model_desc_tag_t* description_of_device_model() const { return m_description_of_device_model.get(); }
                    icc_4_t* _root() const { return m__root; }
            ...
            private:
                ...
                std::unique_ptr<std::vector<std::unique_ptr<profile_description_t>>> m_profile_descriptions;
                icc_4_t* m__root;
            ...
            public:
                ...
                std::vector<std::unique_ptr<profile_description_t>>* profile_descriptions() const { return m_profile_descriptions.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                profile_sequence_identifier_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<profile_sequence_identifier_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                profile_sequence_identifier_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                profile_sequence_identifier_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::profile_sequence_identifier_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                public:
                    ...
                    profile_identifier_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::profile_sequence_identifier_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
                ...
                private:
                    ...
                    std::unique_ptr<multi_localized_unicode_type_t> m_profile_description;
                    icc_4_t* m__root;
                ...
                public:
                    ...
                    multi_localized_unicode_type_t* profile_description() const { return m_profile_description.get(); }
                    icc_4_t* _root() const { return m__root; }
            ...
            private:
                ...
                std::unique_ptr<std::vector<std::unique_ptr<position_number_t>>> m_positions_table;
                std::unique_ptr<std::vector<std::unique_ptr<profile_identifier_t>>> m_profile_identifiers;
                icc_4_t* m__root;
            ...
            public:
                ...
                std::vector<std::unique_ptr<position_number_t>>* positions_table() const { return m_positions_table.get(); }
                std::vector<std::unique_ptr<profile_identifier_t>>* profile_identifiers() const { return m_profile_identifiers.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                profile_sequence_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<profile_sequence_desc_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                profile_sequence_desc_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                red_matrix_column_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                red_trc_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                response_curve_set_16_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::output_response_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                ...
                std::unique_ptr<std::vector<uint32_t>> m_response_curve_structure_offsets;
            ...
            public:
                ...
                std::vector<uint32_t>* response_curve_structure_offsets() const { return m_response_curve_structure_offsets.get(); }
            ...
            public:
                ...
                s_15_fixed_16_array_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::chromatic_adaptation_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                std::string m_reserved;
                std::unique_ptr<std::vector<std::unique_ptr<s_15_fixed_16_number_t>>> m_values;
                icc_4_t* m__root;
                icc_4_t::tag_table_t::tag_definition_t::chromatic_adaptation_tag_t* m__parent;

            public:
                std::string reserved() const { return m_reserved; }
                std::vector<std::unique_ptr<s_15_fixed_16_number_t>>* values() const { return m_values.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                saturation_rendering_intent_gamut_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                signature_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                technology_tag_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                text_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::char_target_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                u_16_fixed_16_array_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                std::string m_reserved;
                std::unique_ptr<std::vector<std::unique_ptr<u_16_fixed_16_number_t>>> m_values;
                icc_4_t* m__root;
                kaitai::kstruct* m__parent;

            public:
                std::string reserved() const { return m_reserved; }
                std::vector<std::unique_ptr<u_16_fixed_16_number_t>>* values() const { return m_values.get(); }
                icc_4_t* _root() const { return m__root; }
                kaitai::kstruct* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                u_int_16_array_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                u_int_32_array_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                u_int_64_array_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                u_int_8_array_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                viewing_cond_desc_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            public:
                ...
                viewing_conditions_tag_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                tag_type_signatures_t m_tag_type;
                std::unique_ptr<viewing_conditions_type_t> m_tag_data;
                bool n_tag_data;
            ...
            public:
                tag_type_signatures_t tag_type() const { return m_tag_type; }
                viewing_conditions_type_t* tag_data() const { return m_tag_data.get(); }
                icc_4_t* _root() const { return m__root; }
                icc_4_t::tag_table_t::tag_definition_t* _parent() const { return m__parent; }
            };
            ...
            public:
                ...
                viewing_conditions_type_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::viewing_conditions_tag_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                std::string m_reserved;
                std::unique_ptr<xyz_number_t> m_un_normalized_ciexyz_values_for_illuminant;
                std::unique_ptr<xyz_number_t> m_un_normalized_ciexyz_values_for_surround;
                std::unique_ptr<standard_illuminant_encoding_t> m_illuminant_type;
                icc_4_t* m__root;
                icc_4_t::tag_table_t::tag_definition_t::viewing_conditions_tag_t* m__parent;

            public:
                std::string reserved() const { return m_reserved; }
                xyz_number_t* un_normalized_ciexyz_values_for_illuminant() const { return m_un_normalized_ciexyz_values_for_illuminant.get(); }
                xyz_number_t* un_normalized_ciexyz_values_for_surround() const { return m_un_normalized_ciexyz_values_for_surround.get(); }
                standard_illuminant_encoding_t* illuminant_type() const { return m_illuminant_type.get(); }
                icc_4_t* _root() const { return m__root; }
            ...
            public:
                ...
                xyz_type_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
            ...
            private:
                std::string m_reserved;
                std::unique_ptr<std::vector<std::unique_ptr<xyz_number_t>>> m_values;
                icc_4_t* m__root;
                kaitai::kstruct* m__parent;

            public:
                std::string reserved() const { return m_reserved; }
                std::vector<std::unique_ptr<xyz_number_t>>* values() const { return m_values.get(); }
                icc_4_t* _root() const { return m__root; }
                kaitai::kstruct* _parent() const { return m__parent; }
            };
        ...
        private:
            ...
            std::unique_ptr<kaitai::kstruct> m_tag_data_element;
            bool n_tag_data_element;

        public:
            bool _is_null_tag_data_element() { tag_data_element(); return n_tag_data_element; };
        ...
        private:
            ...
            std::unique_ptr<kaitai::kstream> m__io__raw_tag_data_element;
        ...
        public:
            ...
            kaitai::kstream* _io__raw_tag_data_element() const { return m__io__raw_tag_data_element.get(); }
        };

    private:
        uint32_t m_tag_count;
        std::unique_ptr<std::vector<std::unique_ptr<tag_definition_t>>> m_tags;
        icc_4_t* m__root;
        icc_4_t* m__parent;

    public:
        uint32_t tag_count() const { return m_tag_count; }
        std::vector<std::unique_ptr<tag_definition_t>>* tags() const { return m_tags.get(); }
        icc_4_t* _root() const { return m__root; }
        icc_4_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        u_16_fixed_16_number_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::u_16_fixed_16_array_type_t* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    private:
        std::string m_number;
        icc_4_t* m__root;
        icc_4_t::tag_table_t::tag_definition_t::u_16_fixed_16_array_type_t* m__parent;

    public:
        std::string number() const { return m_number; }
        icc_4_t* _root() const { return m__root; }
        icc_4_t::tag_table_t::tag_definition_t::u_16_fixed_16_array_type_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        u_1_fixed_15_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        u_8_fixed_8_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
    ...
    public:
        ...
        xyz_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, icc_4_t* p__root = nullptr);
...
private:
    std::unique_ptr<profile_header_t> m_header;
    std::unique_ptr<tag_table_t> m_tag_table;
    icc_4_t* m__root;
    kaitai::kstruct* m__parent;

public:
    profile_header_t* header() const { return m_header.get(); }
    tag_table_t* tag_table() const { return m_tag_table.get(); }
    icc_4_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};
