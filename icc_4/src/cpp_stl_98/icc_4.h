...
public:
    ...
    private:
        ...
        static std::set<device_attributes_colour_or_black_and_white_media_t> _build_values_device_attributes_colour_or_black_and_white_media_t();
    ...
    private:
        ...
        static std::set<device_attributes_glossy_or_matte_t> _build_values_device_attributes_glossy_or_matte_t();
    ...
    private:
        ...
        static std::set<device_attributes_positive_or_negative_media_polarity_t> _build_values_device_attributes_positive_or_negative_media_polarity_t();
    ...
    private:
        ...
        static std::set<device_attributes_reflective_or_transparency_t> _build_values_device_attributes_reflective_or_transparency_t();
    ...
    private:
        ...
        static std::set<device_manufacturers_t> _build_values_device_manufacturers_t();
    ...
    private:
        ...
        static std::set<cmm_signatures_t> _build_values_cmm_signatures_t();
    ...
    private:
        ...
        static std::set<data_colour_spaces_t> _build_values_data_colour_spaces_t();
    ...
    private:
        ...
        static std::set<primary_platforms_t> _build_values_primary_platforms_t();
    ...
    private:
        ...
        static std::set<profile_classes_t> _build_values_profile_classes_t();
    ...
    private:
        ...
        static std::set<rendering_intents_t> _build_values_rendering_intents_t();
    ...
    public:
        ...
        s_15_fixed_16_number_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, icc_4_t* p__root = 0);
    ...
    private:
        ...
        static std::set<standard_illuminant_encodings_t> _build_values_standard_illuminant_encodings_t();
    ...
    public:
        ...
        private:
            ...
            static std::set<multi_process_elements_types_t> _build_values_multi_process_elements_types_t();
        ...
        private:
            ...
            static std::set<tag_signatures_t> _build_values_tag_signatures_t();
        ...
        private:
            ...
            static std::set<tag_type_signatures_t> _build_values_tag_type_signatures_t();
        ...
        public:
            ...
            private:
                ...
                static std::set<colorant_and_phosphor_encodings_t> _build_values_colorant_and_phosphor_encodings_t();
            ...
            private:
                ...
                std::vector<uint16_t>* m_curve_values;
                bool n_curve_values;
            ...
            public:
                ...
                std::vector<uint16_t>* curve_values() const { return m_curve_values; }
            ...
            private:
                ...
                static std::set<data_types_t> _build_values_data_types_t();
            ...
            private:
                ...
                static std::set<measurement_flare_encodings_t> _build_values_measurement_flare_encodings_t();
            ...
            private:
                ...
                static std::set<measurement_geometry_encodings_t> _build_values_measurement_geometry_encodings_t();
            ...
            private:
                ...
                static std::set<standard_observer_encodings_t> _build_values_standard_observer_encodings_t();
            ...
            private:
                ...
                static std::set<parametric_curve_type_functions_t> _build_values_parametric_curve_type_functions_t();
    ...
    public:
        ...
        u_16_fixed_16_number_t(kaitai::kstream* p__io, icc_4_t::tag_table_t::tag_definition_t::u_16_fixed_16_array_type_t* p__parent = 0, icc_4_t* p__root = 0);
