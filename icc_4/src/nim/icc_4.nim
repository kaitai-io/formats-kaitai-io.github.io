...
type
  ...
  Icc4_U16Fixed16Number* = ref object of KaitaiStruct
    `number`*: seq[byte]
    `parent`*: Icc4_TagTable_TagDefinition_U16Fixed16ArrayType
...
proc read*(_: typedesc[Icc4_S15Fixed16Number], io: KaitaiStream, root: KaitaiStruct, parent: KaitaiStruct): Icc4_S15Fixed16Number
...
proc read*(_: typedesc[Icc4_U16Fixed16Number], io: KaitaiStream, root: KaitaiStruct, parent: Icc4_TagTable_TagDefinition_U16Fixed16ArrayType): Icc4_U16Fixed16Number
...
proc read*(_: typedesc[Icc4_TagTable_TagDefinition_AToB0Tag], io: KaitaiStream, root: KaitaiStruct, parent: Icc4_TagTable_TagDefinition): Icc4_TagTable_TagDefinition_AToB0Tag =
  ...
  block:
    let on = this.tagType
    if on == icc_4.multi_function_a_to_b_table_type:
      let tagDataExpr = Icc4_TagTable_TagDefinition_LutAToBType.read(this.io, this.root, this)
      this.tagData = tagDataExpr
    elif on == icc_4.multi_function_table_with_one_byte_precision_type:
...
proc read*(_: typedesc[Icc4_TagTable_TagDefinition_BToA0Tag], io: KaitaiStream, root: KaitaiStruct, parent: Icc4_TagTable_TagDefinition): Icc4_TagTable_TagDefinition_BToA0Tag =
  ...
  block:
    let on = this.tagType
    if on == icc_4.multi_function_b_to_a_table_type:
