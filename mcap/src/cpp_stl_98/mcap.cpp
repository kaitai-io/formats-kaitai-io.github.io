...
std::set<mcap_t::opcode_t> mcap_t::_build_values_opcode_t() {
    std::set<mcap_t::opcode_t> _t;
    _t.insert(mcap_t::OPCODE_HEADER);
    _t.insert(mcap_t::OPCODE_FOOTER);
    _t.insert(mcap_t::OPCODE_SCHEMA);
    _t.insert(mcap_t::OPCODE_CHANNEL);
    _t.insert(mcap_t::OPCODE_MESSAGE);
    _t.insert(mcap_t::OPCODE_CHUNK);
    _t.insert(mcap_t::OPCODE_MESSAGE_INDEX);
    _t.insert(mcap_t::OPCODE_CHUNK_INDEX);
    _t.insert(mcap_t::OPCODE_ATTACHMENT);
    _t.insert(mcap_t::OPCODE_ATTACHMENT_INDEX);
    _t.insert(mcap_t::OPCODE_STATISTICS);
    _t.insert(mcap_t::OPCODE_METADATA);
    _t.insert(mcap_t::OPCODE_METADATA_INDEX);
    _t.insert(mcap_t::OPCODE_SUMMARY_OFFSET);
    _t.insert(mcap_t::OPCODE_DATA_END);
    return _t;
}
const std::set<mcap_t::opcode_t> mcap_t::_values_opcode_t = mcap_t::_build_values_opcode_t();
