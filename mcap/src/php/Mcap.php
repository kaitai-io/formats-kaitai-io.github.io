...
namespace Mcap {
    class Magic extends \Kaitai\Struct\Struct {
        ...
        private function _read() {
            ...
            if (!($this->magic() == "\x89\x4D\x43\x41\x50\x30\x0D\x0A")) {
                throw new \Kaitai\Struct\Error\ValidationNotEqualError("\x89\x4D\x43\x41\x50\x30\x0D\x0A", $this->magic(), $this->_io(), "/types/magic/seq/0");
            }
        }
        protected $_m_magic;
