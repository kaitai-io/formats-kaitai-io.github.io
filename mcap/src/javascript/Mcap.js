...
var Mcap = (function() {
  ...
  var Magic = Mcap.Magic = (function() {
    ...
    Magic.prototype._read = function() {
      ...
      if (!((KaitaiStream.byteArrayCompare(this.magic, [137, 77, 67, 65, 80, 48, 13, 10]) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError([137, 77, 67, 65, 80, 48, 13, 10], this.magic, this._io, "/types/magic/seq/0");
      }
    }
