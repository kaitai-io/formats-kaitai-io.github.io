...
public:
    ...
    pif_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr, pif_t* p__root = nullptr);
...
public:
    ...
    public:
        ...
        pif_header_t(kaitai::kstream* p__io, pif_t* p__parent = nullptr, pif_t* p__root = nullptr);
    ...
    public:
        ...
        information_header_t(kaitai::kstream* p__io, pif_t* p__parent = nullptr, pif_t* p__root = nullptr);
...
public:
    pif_header_t* file_header() const { return m_file_header.get(); }
    information_header_t* info_header() const { return m_info_header.get(); }
    color_table_data_t* color_table() const { return m_color_table.get(); }
    pif_t* _root() const { return m__root; }
