...
const std::set<zip_t::compression_t> zip_t::_values_compression_t{
    zip_t::COMPRESSION_NONE,
    zip_t::COMPRESSION_SHRUNK,
    zip_t::COMPRESSION_REDUCED_1,
    zip_t::COMPRESSION_REDUCED_2,
    zip_t::COMPRESSION_REDUCED_3,
    zip_t::COMPRESSION_REDUCED_4,
    zip_t::COMPRESSION_IMPLODED,
    zip_t::COMPRESSION_DEFLATED,
    zip_t::COMPRESSION_ENHANCED_DEFLATED,
    zip_t::COMPRESSION_PKWARE_DCL_IMPLODED,
    zip_t::COMPRESSION_BZIP2,
    zip_t::COMPRESSION_LZMA,
    zip_t::COMPRESSION_IBM_TERSE,
    zip_t::COMPRESSION_IBM_LZ77_Z,
    zip_t::COMPRESSION_ZSTANDARD,
    zip_t::COMPRESSION_MP3,
    zip_t::COMPRESSION_XZ,
    zip_t::COMPRESSION_JPEG,
    zip_t::COMPRESSION_WAVPACK,
    zip_t::COMPRESSION_PPMD,
    zip_t::COMPRESSION_AEX_ENCRYPTION_MARKER,
};
...
const std::set<zip_t::extra_codes_t> zip_t::_values_extra_codes_t{
    zip_t::EXTRA_CODES_ZIP64,
    zip_t::EXTRA_CODES_AV_INFO,
    zip_t::EXTRA_CODES_OS2,
    zip_t::EXTRA_CODES_NTFS,
    zip_t::EXTRA_CODES_OPENVMS,
    zip_t::EXTRA_CODES_PKWARE_UNIX,
    zip_t::EXTRA_CODES_FILE_STREAM_AND_FORK_DESCRIPTORS,
    zip_t::EXTRA_CODES_PATCH_DESCRIPTOR,
    zip_t::EXTRA_CODES_PKCS7,
    zip_t::EXTRA_CODES_X509_CERT_ID_AND_SIGNATURE_FOR_FILE,
    zip_t::EXTRA_CODES_X509_CERT_ID_FOR_CENTRAL_DIR,
    zip_t::EXTRA_CODES_STRONG_ENCRYPTION_HEADER,
    zip_t::EXTRA_CODES_RECORD_MANAGEMENT_CONTROLS,
    zip_t::EXTRA_CODES_PKCS7_ENC_RECIP_CERT_LIST,
    zip_t::EXTRA_CODES_IBM_S390_UNCOMP,
    zip_t::EXTRA_CODES_IBM_S390_COMP,
    zip_t::EXTRA_CODES_POSZIP_4690,
    zip_t::EXTRA_CODES_EXTENDED_TIMESTAMP,
    zip_t::EXTRA_CODES_BEOS,
    zip_t::EXTRA_CODES_ASI_UNIX,
    zip_t::EXTRA_CODES_INFOZIP_UNIX,
    zip_t::EXTRA_CODES_INFOZIP_UNIX_VAR_SIZE,
    zip_t::EXTRA_CODES_AEX_ENCRYPTION,
    zip_t::EXTRA_CODES_APACHE_COMMONS_COMPRESS,
    zip_t::EXTRA_CODES_MICROSOFT_OPEN_PACKAGING_GROWTH_HINT,
    zip_t::EXTRA_CODES_SMS_QDOS,
};
...
const std::set<zip_t::local_file_header_t::gp_flags_t::deflate_mode_t> zip_t::local_file_header_t::gp_flags_t::_values_deflate_mode_t{
    zip_t::local_file_header_t::gp_flags_t::DEFLATE_MODE_NORMAL,
    zip_t::local_file_header_t::gp_flags_t::DEFLATE_MODE_MAXIMUM,
    zip_t::local_file_header_t::gp_flags_t::DEFLATE_MODE_FAST,
    zip_t::local_file_header_t::gp_flags_t::DEFLATE_MODE_SUPER_FAST,
};
