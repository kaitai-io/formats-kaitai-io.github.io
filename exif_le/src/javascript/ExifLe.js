...
var ExifLe = (function() {
  function ExifLe(_io, _parent, _root) {
    this._io = _io;
  ...
  ExifLe.prototype._read = function() {
    this.version = this._io.readU2le();
    this.ifd0Ofs = this._io.readU4le();
  }

  var Ifd = ExifLe.Ifd = (function() {
  ...
  var IfdField = ExifLe.IfdField = (function() {
  ...
  Object.defineProperty(ExifLe.prototype, 'ifd0', {
    get: function() {
