...
public:
    ...
    exif_le_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, exif_le_t* p_root = 0);
    void _read();
    ~exif_le_t();
    ...
    public:
        ...
        ifd_t(kaitai::kstream* p_io, kaitai::kstruct* p_parent = 0, exif_le_t* p_root = 0);
        void _read();
        ~ifd_t();
    ...
    public:
        ...
        ifd_field_t(kaitai::kstream* p_io, exif_le_t::ifd_t* p_parent = 0, exif_le_t* p_root = 0);
        void _read();
        ~ifd_field_t();
