...
exif_le_t::exif_le_t(kaitai::kstream *p_io, kaitai::kstruct* p_parent, exif_le_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = this;
    f_ifd0 = false;
    _read();
...
exif_le_t::ifd_t::ifd_t(kaitai::kstream *p_io, kaitai::kstruct* p_parent, exif_le_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = p_root;
    f_next_ifd = false;
    _read();
...
exif_le_t::ifd_field_t::ifd_field_t(kaitai::kstream *p_io, exif_le_t::ifd_t* p_parent, exif_le_t *p_root) : kaitai::kstruct(p_io) {
    m__parent = p_parent;
    m__root = p_root;
