...
class ExifLe extends \Kaitai\Struct\Struct {
    ...
    public function ifd0() {
        ...
        $this->_m_ifd0 = new \ExifLe\Ifd($this->_io, $this, $this->_root);
        $this->_io->seek($_pos);
        return $this->_m_ifd0;
    }
...
class Ifd extends \Kaitai\Struct\Struct {
    ...
    private function _read() {
        ...
        $n = $this->numFields();
        for ($i = 0; $i < $n; $i++) {
            $this->_m_fields[] = new \ExifLe\IfdField($this->_io, $this, $this->_root);
        }
    ...
    public function nextIfd() {
        ...
        if ($this->nextIfdOfs() != 0) {
            ...
            $this->_m_nextIfd = new \ExifLe\Ifd($this->_io, $this, $this->_root);
            $this->_io->seek($_pos);
        }
        return $this->_m_nextIfd;
    }
...
class IfdField extends \Kaitai\Struct\Struct {
    ...
    public function typeByteLength() {
        ...
        $this->_m_typeByteLength = ($this->fieldType() == \ExifLe\IfdField\FieldTypeEnum::WORD ? 2 : ($this->fieldType() == \ExifLe\IfdField\FieldTypeEnum::DWORD ? 4 : 1));
        return $this->_m_typeByteLength;
    }
