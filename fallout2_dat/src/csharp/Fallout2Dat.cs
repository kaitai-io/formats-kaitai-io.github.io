...
namespace Kaitai
{
    public partial class Fallout2Dat : KaitaiStruct
    {
        ...
        public Fallout2Dat(KaitaiStream io, KaitaiStruct parent = null, Fallout2Dat root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            f_footer = false;
        ...
        public partial class Pstr : KaitaiStruct
        {
            ...
            public Pstr(KaitaiStream io, Fallout2Dat.File parent = null, Fallout2Dat root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Footer : KaitaiStruct
        {
            ...
            public Footer(KaitaiStream io, Fallout2Dat parent = null, Fallout2Dat root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class Index : KaitaiStruct
        {
            ...
            public Index(KaitaiStream io, Fallout2Dat parent = null, Fallout2Dat root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _read();
        ...
        public partial class File : KaitaiStruct
        {
            ...
            public File(KaitaiStream io, Fallout2Dat.Index parent = null, Fallout2Dat root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                f_contents = false;
